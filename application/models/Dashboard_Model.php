...
class Dashboard_Model extends MY_Model {
    ...
    public function get_noticelist($school_id, $roleid) {
        ...
        if ($roleid) {
            ...
            $this->db->where('N.role_id', $roleid);
            $this->db->or_where('N.role_id', 0);
        }
//        
//         if ($roleid == 2) {
//
//            $this->db->where('N.role_id', 0);
//
//        }
    ...
    public function get_total_prstudent($provincial_id = null) {
        ...
        if ($this->session->userdata('role_id') == PROVINCIAL) {
            ...
            $this->db->join('schools AS D', 'D.id = E.school_id', 'left');

            if ($provincial_id) {

                $this->db->where('D.provincial', $provincial_id);
            }
        } else {
            ...
            $this->db->join('schools AS D', 'D.id = S.school_id', 'left');
    ...
    public function get_total_prguardian($provincial_id = null) {
        ...
        if ($this->session->userdata('role_id') == PROVINCIAL) {
            ...
            $this->db->join('schools AS D', 'D.id = G.school_id', 'left');
    ...
    public function get_total_premployee($provincial_id = null) {
    ...
    public function get_total_prteacher($provincial_id = null) {
        ...
        $this->db->join('schools AS D', 'D.id = T.school_id', 'left');
    ...
    public function get_provinceSchool($provincial_id) {



        $this->db->select('T.*');

        $this->db->from('schools AS T');

        $this->db->where('T.status', 1);

        if ($provincial_id) {

            $this->db->where('T.provincial', $provincial_id);
        }
    ...
    public function get_total_zonalstudent($zonal_id = null) {
        ...
        if ($this->session->userdata('role_id') == ZONAL) {
            ...
            if ($str_area) {
                ...
                $this->db->where_in('D.zonal_id', $str_area);
            }
        } else {
    ...
    public function get_total_zonalguardian($zonal_id = null) {
    ...
    public function get_total_zonalemployee($zonal_id = null) {
    ...
    public function get_total_zonalteacher($zonal_id = null) {
    ...
    public function get_zonalSchool($zonal_id) {
        ...
        if ($str_area) {
            ...
            $this->db->where_in('T.zonal_id', $str_area);
        }
