        ...
        <div id="sidebar-menu" class="main_menu_side hidden-print main_menu">
            ...
            <div class="menu_section">
                ...
                <ul class="nav side-menu">                    
                    ...
                    <?php if (has_permission(VIEW, 'academic', 'classes') || has_permission(VIEW, 'academic', 'section') || has_permission(VIEW, 'academic', 'subject') || has_permission(VIEW, 'academic', 'syllabus') || has_permission(VIEW, 'academic', 'routine') || has_permission(VIEW, 'academic', 'promotion') || has_permission(VIEW, 'academic', 'material') || has_permission(VIEW, 'academic', 'liveclass') || has_permission(VIEW, 'teacher', 'lecture')) { ?>
                    ...
                    <?php if ($this->session->userdata('role_id') == GUARDIAN) { ?>
                        ...
                        <li><a href="<?php echo site_url('guardian/feedback'); ?>"><i class="fa fa-street-view"></i><?php echo $this->lang->line('feedback'); ?></a></li>
                    ...
                    <?php if (has_permission(VIEW, 'exam', 'grade') || has_permission(VIEW, 'exam', 'exam') || has_permission(VIEW, 'exam', 'grade')  || has_permission(VIEW, 'exam', 'schedule') || has_permission(VIEW, 'exam', 'suggestion') || has_permission(VIEW, 'exam', 'attendance') ||  has_permission(VIEW, 'exam', 'mark') ||
...
<!--                        <li><a><i class="fa fa-certificate"></i> <?php echo $this->lang->line('newform'); ?> <span class="fa fa-chevron-down"></span></a>

                            <ul class="nav child_menu">

                                <?php if (has_permission(VIEW, 'certificate', 'certificate')) { ?>

                                    <li><a href="<?php echo site_url('extforms/type/index'); ?>"><?php echo $this->lang->line('form1'); ?></a></li>

                                <?php } ?>

                                <?php if (has_permission(VIEW, 'certificate', 'type')) { ?>

                                    <li><a href="<?php echo site_url('extforms/index'); ?>"><?php echo $this->lang->line('form2'); ?></a></li>
