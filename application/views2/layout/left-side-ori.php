        ...
        <div id="sidebar-menu" class="main_menu_side hidden-print main_menu">
            ...
            <div class="menu_section">
                ...
                <ul class="nav side-menu">
					...
					<!--////////////////////////////POST OFFICE//////////////////////////////////////////////////////////////-->
					 <?php if (has_permission(VIEW, 'postoffice', 'postoffice') || (has_permission(VIEW, 'postoffice', 'postofficedep')) { ?>
                        ...
                        <li><a><i class="fa fa-envelope-o"></i> <?php echo $this->lang->line('postofficeletter'); ?> <span class="fa fa-chevron-down"></span></a>
                            ...
                            <ul class="nav child_menu">
                                ...
                                <?php if (has_permission(VIEW, 'postoffice', 'postofficedep')) { ?>
                                    ...
                                    <li><a href="<?php echo site_url('postoffice/postofficedep/inbox'); ?>"><?php echo $this->lang->line('postofficeletter'); ?></a></li>
