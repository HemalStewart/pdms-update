                            ...
                            <div class="x_content"> 
                               <?php echo form_open(site_url('profile/password'), array('name' => 'add', 'id' => 'add', 'class'=>'form-horizontal form-label-left'), ''); ?>
                                ...
                                <div class="item form-group">
                                    <label class="control-label col-md-3 col-sm-3 col-xs-12" for="curpassword"><?php echo $this->lang->line('currpwd'); ?> <span class="required">*</span> </label>
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        <input  class="form-control col-md-7 col-xs-12"  name="curpassword"  id="curpassword" placeholder="<?php echo $this->lang->line('currpwd'); ?>"  type="password" autocomplete="off">
                                        <div class="help-block"><?php echo form_error('curpassword'); ?></div>
                                    </div>
                                </div>
                                <div class="item form-group">
