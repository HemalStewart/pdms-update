        ...
        <div id="sidebar-menu" class="main_menu_side hidden-print main_menu">
            ...
            <div class="menu_section">
                ...
                <ul class="nav side-menu">
                    ...
                    has_permission(VIEW, 'postoffice', 'postofficedep')) {
                        ?>
                        ...
                        <li><a><i class="fa fa-tty"></i> <?php echo $this->lang->line('front_office'); ?> <span class="fa fa-chevron-down"></span></a>
                            ...
                            <ul class="nav child_menu">
                                ...
                                <?php if (has_permission(VIEW, 'frontoffice', 'dispatchall')) { ?>
                                    ...
                                    <li><a href="<?php echo site_url('frontoffice/dispatchall/index'); ?>"><?php echo $this->lang->line('postal_dispatch_all'); ?></a></li>
