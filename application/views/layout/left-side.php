        ...
        <div class="navbar nav_title" style="border: 0;">
            ...
            <a href="<?php echo site_url('dashboard'); ?>">
                ...
                <?php if ($this->global_setting->brand_name) { ?>
                    ...
                    <span <?php
                    if (str_word_count($this->global_setting->brand_name) == 1) {
            ...
            <div class="menu_section">
                ...
                <ul class="nav side-menu">
                    ...
                    if (has_permission(VIEW, 'administrator', 'setting') ||
                            ...
                            has_permission(VIEW, 'administrator', 'provadmin') ||
                            has_permission(VIEW, 'administrator', 'provschool') ||
                            has_permission(VIEW, 'administrator', 'zonaladmin') ||
                            has_permission(VIEW, 'administrator', 'zonalschool') ||
                            has_permission(VIEW, 'administrator', 'subadmindefine') ||
                        ...
                        <li><a><i class="fa fa-user"></i> <?php echo $this->lang->line('administrator'); ?> <span class="fa fa-chevron-down"></span></a>
                            ...
                            <ul class="nav child_menu">
                                ...
                                <?php if (has_permission(EDIT, 'administrator', 'username')) { ?>
                                    ...
                                    <li><a href="<?php echo site_url('administrator/username/index'); ?>"><?php echo $this->lang->line('reset_username'); ?> (Principal)</a></li>

                                <?php } ?>

                                <?php if (has_permission(EDIT, 'administrator', 'password')) { ?>

                                    <li><a href="<?php echo site_url('administrator/password/index'); ?>"><?php echo $this->lang->line('reset_user_password'); ?> (Principal)</a></li>

                                <?php } ?>

                                <?php if (has_permission(EDIT, 'administrator', 'adminusername')) { ?>

                                    <li><a href="<?php echo site_url('administrator/username/otherindex'); ?>"><?php echo $this->lang->line('change_admin_username'); ?></a></li>

                                <?php } ?>


                                <?php if (has_permission(EDIT, 'administrator', 'adminpassword')) { ?>

                                    <li><a href="<?php echo site_url('administrator/password/otherindex'); ?>"><?php echo $this->lang->line('reset_admin_password'); ?></a></li>
                                ...
                                <?php if (has_permission(VIEW, 'administrator', 'provschool')) { ?>
                                    ...
                                    <li><a href="<?php echo site_url('administrator/school/provindex'); ?>"> <?php echo $this->lang->line('manage_school'); ?></a></li>

                                <?php } ?>

                                <?php if (has_permission(VIEW, 'administrator', 'zonalschool')) { ?>

                                    <li><a href="<?php echo site_url('administrator/school/zonalindex'); ?>"> <?php echo $this->lang->line('manage_school'); ?></a></li>
                                ...
                                <?php if (has_permission(VIEW, 'administrator', 'provadmin')) { ?>

                                                                                    <!--<li><a href="<?php echo site_url('administrator/provincialadmin/index'); ?>"><?php echo $this->lang->line('manage_provuser'); ?></a></li>-->
                                    <li><a href="<?php echo site_url('administrator/superadmin/indexProvincial'); ?>"> <?php echo $this->lang->line('manage_provuser'); ?></a></li>
                                ...
                                <?php if (has_permission(VIEW, 'administrator', 'zonaladmin')) { ?>
                                                                                    ...
                                                                                    <!--<li><a href="<?php echo site_url('administrator/provincialadmin/index'); ?>"><?php echo $this->lang->line('manage_provuser'); ?></a></li>-->
                                    <li><a href="<?php echo site_url('administrator/superadmin/indexZonal'); ?>"> <?php echo $this->lang->line('manage_zonaluser'); ?></a></li>

                                <?php } ?>

                                <?php if (has_permission(VIEW, 'administrator', 'subadmindefine')) { ?>


                                    <li><a href="<?php echo site_url('administrator/superadmin/indexsubject'); ?>"> <?php echo $this->lang->line('manage_subuser'); ?></a></li>

                                <?php } ?>

                                <?php if (has_permission(VIEW, 'administrator', 'depadmin')) { ?>

                                                                                    <!--<li><a href="<?php echo site_url('administrator/provincialadmin/index'); ?>"><?php echo $this->lang->line('manage_provuser'); ?></a></li>-->
                                    <li><a href="<?php echo site_url('administrator/superadmin/indexDepartment'); ?>"> <?php echo $this->lang->line('manage_departmentuser'); ?></a></li>
                    ...
                    <?php if (has_permission(VIEW, 'administrator', 'emailtemplate') || has_permission(VIEW, 'administrator', 'smstemplate') || has_permission(VIEW, 'message', 'mail') || has_permission(VIEW, 'message', 'text') || has_permission(VIEW, 'message', 'message')) { ?>
					...
					<!--////////////////////////////POST OFFICE//////////////////////////////////////////////////////////////-->
					 <!-- <?php if (has_permission(VIEW, 'postoffice', 'postoffice')) { ?>

                        <li><a><i class="fa fa-envelope-o"></i> <?php echo $this->lang->line('postofficeletter'); ?> <span class="fa fa-chevron-down"></span></a>

                            <ul class="nav child_menu">

                                <?php if (has_permission(VIEW, 'postoffice', 'postoffice')) { ?>

                                    <li><a href="<?php echo site_url('postoffice/inbox'); ?>"><?php echo $this->lang->line('postofficeletter'); ?></a></li>

                                <?php } ?>

                                <?php if (has_permission(VIEW, 'postoffice', 'postofficedepdir')) { ?>

                                    <li><a href="<?php echo site_url('postofficedep/inbox'); ?>">xxxxxxxxxx</a></li>
                    ...
                    <?php } ?> -->
                        ...
                        <li><a><i class="fa fa-file-text-o"></i> <?php echo $this->lang->line('postofficeletter'); ?> <span class="fa fa-chevron-down"></span></a>
                            ...
                            <ul class="nav child_menu">
                                ...
                                <?php if (has_permission(VIEW, 'postoffice', 'postofficedep')) { ?>

                                    <li><a href="<?php echo site_url('postoffice/postofficedep/inbox'); ?>"><?php echo $this->lang->line('postofficeletterdep'); ?></a></li>
...
<!--
                    ...
                    <?php
                    if (has_permission(VIEW, 'postoffice', 'postoffice')) {
                        ?>
                    ...
                    <?php
                    if (has_permission(VIEW, 'postoffice', 'postofficedep')) {
                        ?>
                        ...
                        <li><a><i class="fa fa-file-text-o"></i> <?php echo $this->lang->line('postofficeletter'); ?> <span class="fa fa-chevron-down"></span></a>
                            ...
                            <ul class="nav child_menu">
                                ...
                                <?php if (has_permission(VIEW, 'postoffice', 'postofficedep')) { ?>
                                      ...
                                      <li><a href="<?php echo site_url('postofficedep/inbox'); ?>"><?php echo $this->lang->line('postofficeletterdep'); ?></a></li>
 ...
 -->
                        ...
                        <li><a><i class="fa fa-tty"></i> <?php echo $this->lang->line('front_office'); ?> <span class="fa fa-chevron-down"></span></a>
                            ...
                            <ul class="nav child_menu">
                                ...
                                <?php if (has_permission(VIEW, 'frontoffice', 'dispatchall')) { ?>
                                    ...
                                    <li><a href="<?php echo site_url('frontoffice/dispatchall/index'); ?>"><?php echo $this->lang->line('postal_dispatchall'); ?></a></li>
                    ...
                    <?php if (has_permission(VIEW, 'hrm', 'designation') || has_permission(VIEW, 'hrm', 'employee') || has_permission(VIEW, 'hrm', 'provemployee') || has_permission(VIEW, 'hrm', 'zonalemployee')) { ?>
                        ...
                        <li><a><i class="fa fa-user-md"></i>  <?php echo $this->lang->line('human_resource'); ?> <span class="fa fa-chevron-down"></span></a>
                            ...
                            <ul class="nav child_menu">
                                ...
                                <?php if (has_permission(VIEW, 'hrm', 'provemployee')) { ?>

                                    <li><a href="<?php echo site_url('hrm/employee/indexprovincial'); ?>"><?php echo $this->lang->line('manage_employee'); ?></a></li>

                                <?php } ?>

                                <?php if (has_permission(VIEW, 'hrm', 'zonalemployee')) { ?>

                                    <li><a href="<?php echo site_url('hrm/employee/indexzonal'); ?>"><?php echo $this->lang->line('manage_employee'); ?></a></li>
                    ...
                    <?php if (has_permission(VIEW, 'leave', 'leave') || has_permission(VIEW, 'leave', 'type') || has_permission(VIEW, 'userleave', 'userleave')) { ?>
                        ...
                        <li><a><i class="fa fa-bell-o"></i> <?php echo $this->lang->line('manage_leave'); ?> <span class="fa fa-chevron-down"></span></a>
                            ...
                            <ul class="nav child_menu">
                                ...
                                <?php if (has_permission(VIEW, 'leave', 'application')) { ?>
                                    ...
                                    <li><a href="<?php echo site_url('leave/application/index'); ?>"><?php echo $this->lang->line('employee_leave_application'); ?> </a></li>
                    ...
                    <?php if (has_permission(VIEW, 'payroll', 'grade')) { ?>
                        ...
                        <li><a href="<?php echo site_url('payroll/grade/index'); ?>"><i class="fa fa-sort-numeric-asc"></i> <?php echo $this->lang->line('salary_grade'); ?></a></li>
                    ...
                    <?php
                    if (has_permission(VIEW, 'teacher', 'teacher_type') ||
                            has_permission(VIEW, 'teacher', 'teacher')) {
                        ?>



                        <li><a><i class="fa fa-group"></i> <?php echo $this->lang->line('teacher'); ?> <span class="fa fa-chevron-down"></span></a>

                            <ul class="nav child_menu">


                                <?php if (has_permission(VIEW, 'teacher', 'teacher_type')) { ?>

                                    <li><a href="<?php echo site_url('teacher/indextype'); ?>"> <?php echo $this->lang->line('teacher_type'); ?></a></li>

                                <?php } ?>

                                <?php if (has_permission(VIEW, 'teacher', 'teacher')) { ?>

                                    <li><a href="<?php echo site_url('teacher/index'); ?>"><?php echo $this->lang->line('teacher'); ?></a></li>

                                <?php } ?>


                                <?php if (has_permission(VIEW, 'teacher', 'teatransfer')) { ?>

                                    <li><a href="<?php echo site_url('teacher/indextransfer'); ?>"><?php echo $this->lang->line('teacher_transfer'); ?></a></li>
                    ...
                    <?php if (has_permission(VIEW, 'teacher', 'provteacher')) { ?>

                        <li><a href="<?php echo site_url('teacher/indexprovince'); ?>"><i class="fa fa-users"></i> <?php echo $this->lang->line('teacher'); ?></a> </li>

                    <?php } ?>

                    <?php if (has_permission(VIEW, 'teacher', 'zonalteacher')) { ?>

                        <li><a href="<?php echo site_url('teacher/indexzonal'); ?>"><i class="fa fa-users"></i> <?php echo $this->lang->line('teacher'); ?></a> </li>

                    <?php } ?>

                    <?php if (has_permission(VIEW, 'teacher', 'subteacher')) { ?>

                        <li><a href="<?php echo site_url('teacher/indexsub'); ?>"><i class="fa fa-users"></i> <?php echo $this->lang->line('teacher'); ?></a> </li>

                    <?php } ?>


                    <?php if (has_permission(VIEW, 'academic', 'classes') || has_permission(VIEW, 'academic', 'section') || has_permission(VIEW, 'academic', 'subject') || has_permission(VIEW, 'academic', 'syllabus') || has_permission(VIEW, 'academic', 'routine') || has_permission(VIEW, 'academic', 'promotion') || has_permission(VIEW, 'academic', 'material') || has_permission(VIEW, 'academic', 'liveclass') || has_permission(VIEW, 'teacher', 'lecture') || has_permission(VIEW, 'academic', 'subdefine') || has_permission(VIEW, 'academic', 'subassign')) { ?>

                        <li><a><i class="fa fa-university"></i> <?php echo $this->lang->line('academic_name'); ?> <span class="fa fa-chevron-down"></span></a>
                            ...
                            <ul class="nav child_menu">
                                ...
                                <?php if (has_permission(VIEW, 'academic', 'subdefine')) { ?>
                                    ...
                                    <li><a  href="<?php echo site_url('academic/subject/indexdefine'); ?>"> <?php echo $this->lang->line('sub_define'); ?> </a></li>
                                ...
                                <?php if (has_permission(VIEW, 'academic', 'subassign')) { ?>
                                    ...
                                    <li><a  href="<?php echo site_url('academic/subject/indexassign'); ?>"> <?php echo $this->lang->line('sub_assign'); ?> </a></li>
                                ...
                                <?php if (has_permission(VIEW, 'academic', 'routine')) { ?>
                                    ...
                                    <li> <a  href="<?php echo site_url('academic/routine/index'); ?>"> <?php echo $this->lang->line('class_routine'); ?></a></li>
                                ...
                                <?php if (has_permission(VIEW, 'academic', 'material')) { ?>
                                    ...
                                    <li><a  href="<?php echo site_url('academic/material/index'); ?>"><?php echo $this->lang->line('study_material'); ?></a> </li>
                    ...
                    <?php if (has_permission(VIEW, 'guardian', 'guardian')) { ?>
                        ...
                        <li><a href="<?php echo site_url('guardian/index'); ?>"><i class="fa fa-street-view"></i> <?php echo $this->lang->line('guardian'); ?></a> </li>

                    <?php } ?>

                    <?php if (has_permission(VIEW, 'guardian', 'provguardian')) { ?>

                        <li><a href="<?php echo site_url('guardian/indexprovince'); ?>"><i class="fa fa-street-view"></i> <?php echo $this->lang->line('guardian'); ?></a> </li>

                    <?php } ?>

                    <?php if (has_permission(VIEW, 'guardian', 'zonalguardian')) { ?>

                        <li><a href="<?php echo site_url('guardian/indexzonal'); ?>"><i class="fa fa-street-view"></i> <?php echo $this->lang->line('guardian'); ?></a> </li>
                    ...
                    <?php if ($this->session->userdata('role_id') == GUARDIAN) { ?>
                        ...
                        <li><a href="<?php echo site_url('guardian/feedback'); ?>"><i class="fa fa-paw"></i><?php echo $this->lang->line('feedback'); ?></a></li>
                    ...
                    <?php
                    if (has_permission(VIEW, 'student', 'type') ||
                            has_permission(ADD, 'student', 'student') ||
                           /* has_permission(ADD, 'student', 'bulk') ||*/
                            has_permission(ADD, 'student', 'admission') ||
                            has_permission(VIEW, 'student', 'provstudent') ||
                            has_permission(VIEW, 'student', 'zonalstudent') ||
                            has_permission(ADD, 'student', 'activity')||
                            has_permission(VIEW, 'student', 'news')) {
                        ?>
                        ...
                        <li><a><i class="fa fa-group"></i> <?php echo $this->lang->line('manage_student'); ?> <span class="fa fa-chevron-down"></span></a>
                            ...
                            <ul class="nav child_menu">
                                ...
                                <?php if (has_permission(VIEW, 'student', 'provstudent')) { ?>

                                    <li><a href="<?php echo site_url('student/indexprovince'); ?>"><?php echo $this->lang->line('student_list'); ?></a></li>

                                <?php } ?>

                                <?php if (has_permission(VIEW, 'student', 'zonalstudent')) { ?>

                                    <li><a href="<?php echo site_url('student/indexzonal'); ?>"><?php echo $this->lang->line('student_list'); ?></a></li>
                               ...
                               <!-- <?php if (has_permission(ADD, 'student', 'bulk')) { ?>
                                ...
                                <?php if (has_permission(VIEW, 'student', 'news')) { ?>
                                    ...
                                    <li><a href="<?php echo site_url('student/news/index'); ?>"><?php echo $this->lang->line('student_cal'); ?></a></li>
                    ...
                    <?php
                    if (has_permission(VIEW, 'attendance', 'student') ||
                    ...
                    <?php
                    if (has_permission(VIEW, 'assignment', 'assignment') || has_permission(VIEW, 'assignment', 'submission')) {
                        ?>
                        <li><a><i class="fa fa-file-word-o"></i> <?php echo $this->lang->line('assignment'); ?><span class="fa fa-chevron-down"></span></a>
                            ...
                            <ul class="nav child_menu">
                                ...
                                <?php if (has_permission(VIEW, 'assignment', 'submission')) { ?>
                                    ...
                                    <li>  <a href="<?php echo site_url('assignment/submission/index/'); ?>"> <?php echo $this->lang->line('submission'); ?></a></li>
                    ...
                    <?php
                    if (has_permission(VIEW, 'exam', 'grade') || has_permission(VIEW, 'exam', 'exam') || has_permission(VIEW, 'exam', 'grade') || has_permission(VIEW, 'exam', 'schedule') || has_permission(VIEW, 'exam', 'suggestion') || has_permission(VIEW, 'exam', 'attendance') || has_permission(VIEW, 'exam', 'mark') ||
                    ...
                    <?php
                    if (has_permission(VIEW, 'transport', 'vehicle') ||
                    ...
                    <?php
                    if (has_permission(VIEW, 'hostel', 'hostel') ||
                    ...
                    <?php
                    if (has_permission(VIEW, 'card', 'idsetting') ||
                    ...
                    <?php
                    if (has_permission(VIEW, 'announcement', 'notice') ||
                    ...
                    <?php
                    if (has_permission(VIEW, 'accounting', 'discount') ||
                        ...
                        <li><a><i class="fa fa-bar-chart"></i> <?php echo $this->lang->line('report'); ?> <span class="fa fa-chevron-down"></span></a>
                            ...
                            <ul class="nav child_menu">
                                ...
                                <?php if ($this->session->userdata('role_id') != ADMIN){
								      ...
								      if ($this->session->userdata('role_id') != ACCOUNTANT) {
								      if ($this->session->userdata('role_id') != LIBRARIN) {
								      if ($this->session->userdata('role_id') != RECEPTIONIST) {
				...
				<li><a href="<?php echo site_url('report/studsub'); ?>"><?php echo $this->lang->line('student_sub_report'); ?></a></li>
                                ...
                                ?>
                                  ...
                                  <li><a href="<?php echo site_url('report/pannualreport'); ?>"><?php echo $this->lang->line('pirven_annual_report'); ?></a></li>

                            
                                <?php 
                                    $allowed_roles = [1,18,19,26,27,31,33,34,35,36];
                                    if (in_array($this->session->userdata('role_id'), $allowed_roles)) { 
                                ?>
                                    <li><a href="<?php echo site_url('report/pirivendetails'); ?>">Piriven Details Report</a></li>
                                <?php } ?>
                    ...
                    <?php
                    if (has_permission(VIEW, 'forms', 'teachertransfer') || has_permission(VIEW, 'forms', 'teacherapplication') || has_permission(VIEW, 'forms', 'teacherformappzonal') || has_permission(VIEW, 'forms', 'teacherformappkruthy') || has_permission(VIEW, 'forms', 'teacherformappprovincial')) {
                        ?>

                        <li><a><i class="fa fa-file-text-o"></i> <?php echo $this->lang->line('forms'); ?> <span class="fa fa-chevron-down"></span></a>

                            <ul class="nav child_menu">

                                <?php if (has_permission(VIEW, 'forms', 'teachertransfer')) { ?>

                                    <li><a href="<?php echo site_url('forms/teachertransferform'); ?>"><?php echo $this->lang->line('teacher_transfer_form'); ?></a></li>

                                <?php } ?>

                                <?php if (has_permission(VIEW, 'forms', 'teacherapplication')) { ?>

                                    <li><a href="<?php echo site_url('forms/formsapply/teacherapplicationform'); ?>"><?php echo $this->lang->line('teacher_application_form'); ?></a></li>

                                <?php } ?>



                                <?php if (has_permission(VIEW, 'forms', 'teacherformappzonal')) { ?>

                                    <li><a href="<?php echo site_url('formszonal/formsapply/teacherapplicationform'); ?>"><?php echo $this->lang->line('teacher_zonal_approval'); ?></a></li>

                                <?php } ?>


								 <?php if (has_permission(VIEW, 'forms', 'teacherformappkruthy')) { ?>

                                    <li><a href="<?php echo site_url('formskruthy/formsapply/teacherapplicationform'); ?>"><?php echo $this->lang->line('teacher_kruthadhikari_approval'); ?></a></li>

                                <?php } ?>

								 <?php if (has_permission(VIEW, 'forms', 'teacherformappprovincial')) { ?>

                                    <li><a href="<?php echo site_url('formsprovincial/formsapply/teacherapplicationform'); ?>"><?php echo $this->lang->line('teacher_provincial_approval'); ?></a></li>
                    ...
                    <?php } ?>
					 ...
					 <?php
                    if (has_permission(VIEW, 'forms', 'teacherformappministry')) {
                        ?>
                        ...
                        <li><a><i class="fa fa-file-text-o"></i> <?php echo $this->lang->line('forms'); ?> <span class="fa fa-chevron-down"></span></a>
                            ...
                            <ul class="nav child_menu">
                                ...
                                <?php if (has_permission(VIEW, 'forms', 'teacherformappministry')) { ?>
                                    ...
                                    <li><a href="<?php echo site_url('formsministry/formsapply/teacherapplicationform'); ?>"><?php echo $this->lang->line('pending'); ?></a></li>

                                <?php } ?>

                                <?php if (has_permission(VIEW, 'forms', 'teacherformappministry')) { ?>

                                    <li><a href="<?php echo site_url('formsministry/formsapply/indexcom'); ?>"><?php echo $this->lang->line('approved'); ?></a></li>
                    ...
                    <?php
                    if (has_permission(VIEW, 'applications', 'vehicles') ||
                            has_permission(VIEW, 'applications', 'routes') ||
                            has_permission(VIEW, 'applications', 'members')) {
                        ?>

                        <li><a><i class="fa fa-bus"></i> <?php echo $this->lang->line('applications'); ?> <span class="fa fa-chevron-down"></span></a>

                            <ul class="nav child_menu">

                                <?php if (has_permission(VIEW, 'applications', 'vehicles')) { ?>

                                    <li><a href="<?php echo site_url('applications/vehicles/index'); ?>"><?php echo $this->lang->line('vehicles'); ?></a></li>

                                <?php } ?>

                                <?php if (has_permission(VIEW, 'applications', 'routes')) { ?>

                                    <li><a href="<?php echo site_url('applications/routes/index'); ?>"><?php echo $this->lang->line('transport_route'); ?></a></li>

                                <?php } ?>

                                <?php if (has_permission(VIEW, 'applications', 'members')) { ?>

                                    <li><a href="<?php echo site_url('applications/member/index'); ?>"><?php echo $this->lang->line('transport_member'); ?></a></li>
                    ...
                    <?php if (has_permission(VIEW, 'complain', 'complain') || has_permission(VIEW, 'complain', 'type') || has_permission(VIEW, 'usercomplain', 'usercomplain')) { ?>
                    ...
                    <?php
                    if (has_permission(VIEW, 'prozo', 'prozoprogress') ||
                            has_permission(VIEW, 'prozo', 'prozoplan')) {
                        ?>

                        <li><a><i class="fa fa-file-text-o"></i> <?php echo $this->lang->line('mainprogress'); ?> <span class="fa fa-chevron-down"></span></a>

                            <ul class="nav child_menu">

                                <?php if (has_permission(VIEW, 'prozo', 'prozoprogress')) { ?>

                                    <li><a href="<?php echo site_url('prozo/progress/index'); ?>"><?php echo $this->lang->line('progress'); ?></a></li>

                                <?php } ?>

                                <?php if (has_permission(VIEW, 'prozo', 'prozoplan')) { ?>

                                    <li><a href="<?php echo site_url('plan/progress/index'); ?>"><?php echo $this->lang->line('plan'); ?></a></li>
                    ...
                    <?php
                    if (has_permission(VIEW, 'prozo', 'depprogress') ||
                            has_permission(VIEW, 'prozo', 'depplan')) {
                        ?>
                        ...
                        <li><a><i class="fa fa-file-text-o"></i> <?php echo $this->lang->line('mainprogress'); ?> <span class="fa fa-chevron-down"></span></a>
                            ...
                            <ul class="nav child_menu">
                                ...
                                <?php if (has_permission(VIEW, 'prozo', 'depprogress')) { ?>

                                    <li><a href="<?php echo site_url('depprozo/progress/index'); ?>"><?php echo $this->lang->line('progress'); ?></a></li>

                                <?php } ?>

                                <?php if (has_permission(VIEW, 'prozo', 'depplan')) { ?>

                                    <li><a href="<?php echo site_url('depplan/progress/index'); ?>"><?php echo $this->lang->line('plan'); ?></a></li>
                    ...
                    <?php
                    if (has_permission(VIEW, 'prozo', 'subprogress') ||
                            has_permission(VIEW, 'prozo', 'subplan')) {
                        ?>
                        ...
                        <li><a><i class="fa fa-file-text-o"></i> <?php echo $this->lang->line('mainprogress'); ?> <span class="fa fa-chevron-down"></span></a>
                            ...
                            <ul class="nav child_menu">
                                ...
                                <?php if (has_permission(VIEW, 'prozo', 'subprogress')) { ?>
                                    ...
                                    <li><a href="<?php echo site_url('subprozo/progress/index'); ?>"><?php echo $this->lang->line('progress'); ?></a></li>

                                <?php } ?>

                                <?php if (has_permission(VIEW, 'prozo', 'subplan')) { ?>

                                    <li><a href="<?php echo site_url('subplan/progress/index'); ?>"><?php echo $this->lang->line('plan'); ?></a></li>
                    ...
                    <?php
                    if (
                            has_permission(VIEW, 'prozo', 'adminprozoplan') ||
                            has_permission(VIEW, 'prozo', 'adminprozoprogress')) {
                        ?>
                        ...
                        <li><a><i class="fa fa-file-text-o"></i> <?php echo $this->lang->line('mainprogress'); ?> <span class="fa fa-chevron-down"></span></a>
                            ...
                            <ul class="nav child_menu">
                                ...
                                <?php if (has_permission(VIEW, 'prozo', 'adminprozoprogress')) { ?>

                                    <li><a href="<?php echo site_url('adminprozo/progress/index'); ?>"><?php echo $this->lang->line('pendingprogress'); ?></a></li>

                                <?php } ?>

                                <?php if (has_permission(VIEW, 'prozo', 'adminprozoprogress')) { ?>

                                    <li><a href="<?php echo site_url('adminprozo/progress/indexcom'); ?>"><?php echo $this->lang->line('comprogress'); ?></a></li>
                    ...
                    if (
                        ...
                        <li><a><i class="fa fa-file-text-o"></i> <?php echo $this->lang->line('planprogress'); ?> <span class="fa fa-chevron-down"></span></a>

                            <ul class="nav child_menu">

                                <?php if (has_permission(VIEW, 'prozo', 'adminprozoplan')) { ?>

                                    <li><a href="<?php echo site_url('adminplan/progress/index'); ?>"><?php echo $this->lang->line('pendingprogress'); ?></a></li>

                                <?php } ?>

                                <?php if (has_permission(VIEW, 'prozo', 'adminprozoplan')) { ?>

                                    <li><a href="<?php echo site_url('adminplan/progress/indexcom'); ?>"><?php echo $this->lang->line('comprogress'); ?></a></li>
