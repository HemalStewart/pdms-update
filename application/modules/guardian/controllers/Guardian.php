       ...
       // $this->data['filter_prov_id'] = $province_id;
        ...
        $this->data['filter_school_id'] = $school_id;
         ...
         $this->data['provincial'] = $this->provincial;
          ...
          $this->data['district'] = $this->guardian->getdistrictData($provincial_id);
         
//         $provincial_id = $this->session->userdata('provincial_id');
        $this->data['guardians'] = $this->guardian->get_guardian_provincelist($school_id,$provincial_id);
        ...
        $this->data['list'] = TRUE;
        $this->layout->title($this->lang->line('manage_guardian') . ' | ' . SMS);
        $this->layout->view('guardian/province', $this->data);
    }
      ...
      //  check_permission(VIEW);
        ...
        $this->data['guardians'] = $this->guardian->get_guardian_zonallist($zonal_id);
        ...
        $this->data['list'] = TRUE;
        $this->layout->title($this->lang->line('manage_guardian') . ' | ' . SMS);
        $this->layout->view('guardian/zonal', $this->data);
    }
