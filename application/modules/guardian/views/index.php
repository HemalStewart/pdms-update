<div class="row">
    <div class="col-md-12 col-sm-12 col-xs-12">
        <div class="x_panel">
            <div class="x_title">
                <h3 class="head-title"><i class="fa fa-street-view"></i><small> <?php echo $this->lang->line('manage_guardian'); ?></small></h3>
...
<!--                           <?php if($this->session->userdata('role_id') == SUPER_ADMIN){  ?>                                 
                            ...
                            <?php } ?>  -->
                              ...
                              <?php echo form_open(site_url('guardian/index/'), array('name' => 'filter', 'id' => 'filter', 'class' => 'form-horizontal form-label-left'), ''); ?>
