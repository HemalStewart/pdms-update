                    ...
                    <ul  class="nav nav-tabs bordered">
                        ...
                        <?php } ?> 
                            ...
                            <?php if ($this->session->userdata('role_id') != ADMIN || $this->session->userdata('role_id') != GUARDIAN || $this->session->userdata('role_id') != STUDENT || $this->session->userdata('role_id') != TEACHER || $this->session->userdata('role_id') != ACCOUNTANT || $this->session->userdata('role_id') != LIBRARIN || $this->session->userdata('role_id') != RECEPTIONIST || $this->session->userdata('role_id') != STAFF || $this->session->userdata('role_id') != PROVINCIAL || $this->session->userdata('role_id') != ZONAL) { ?> 
                                ...
                                <?php echo form_open(site_url('administrator/school/index/'), array('name' => 'filter', 'id' => 'filter', 'class' => 'form-horizontal form-label-left'), ''); ?>
                                        ...
                                        if (isset($schools) && !empty($schools)) {
                                            ...
                                            <?php foreach ($schools as $obj) { ?>
                                                ...
                                                <tr>
                                                    ...
                                                    <td><?php echo isset($obj->provincialname) ? $obj->provincialname : ''; ?></td>

                                                    <!-- <td><?php echo $obj->districtname; ?></td> -->
                                                    <td><?php echo isset($obj->districtname) ? $obj->districtname : ''; ?></td>

                                                    <!-- <td><?php echo $obj->zonename; ?></td> -->
                                                    <td><?php echo isset($obj->zonename) ? $obj->zonename : ''; ?></td>

                                                    <!-- <td><?php echo $obj->zoneblock; ?></td> -->
                                                    <td><?php echo isset($obj->zoneblock) ? $obj->zoneblock : ''; ?></td>
                        ...
                        ?>" id="tab_add_school">
                            ...
                            <div class="x_content"> 
                                ...
                                <div class="row">            
                                    ...
                                    <div class="col-md-3 col-sm-3 col-xs-12">
                                        ...
                                        <div class="item form-group">
                                            ...
                                            <label for="pirtype"><?php echo $this->lang->line('pir_type'); ?> <span class="required">*</span></label>
                                    ...
                                    <div class="col-md-3 col-sm-3 col-xs-12">
                                        ...
                                        <div class="item form-group">
                                            ...
                                            <label for="working_time"><?php echo $this->lang->line('working_time'); ?></label>

                                            <input  class="form-control col-md-7 col-xs-12"  name="working_time"  id="working_time" value="<?php echo isset($post['working_time']) ? $post['working_time'] : ''; ?>" placeholder="<?php echo $this->lang->line('working_time'); ?>"  type="text" autocomplete="off">

                                            <div class="help-block"><?php echo form_error('working_time'); ?></div> 
                                    ...
                                    <div class="col-md-3 col-sm-3 col-xs-12">
                                        ...
                                        <div class="item form-group">
                                            ...
                                            <label for="cencus_number"><?php echo $this->lang->line('cencus_number'); ?></label>

                                            <input  class="form-control col-md-7 col-xs-12"  name="cencus_number"  id="cencus_number" value="<?php echo isset($post['cencus_number']) ? $post['cencus_number'] : ''; ?>" placeholder="<?php echo $this->lang->line('cencus_number'); ?>" type="text" autocomplete="off">

                                            <div class="help-block"><?php echo form_error('cencus_number'); ?></div> 
                                        ...
                                        <div class="item form-group">
                                            ...
                                            <select  class="form-control col-md-7 col-xs-12"  name="language" required="required">
                                                ...
                                                <?php foreach ($fields as $field) { ?>
                                                    ...
                                                    if ($field == 'id' || $field == 'label'|| $field == 'tamil'|| $field == 'mylang') {
                               ...
                               <!-- <div class="row">
                                ...
                                <div class="row">
                                    <div class="col-md-12 col-sm-12 col-xs-12">
                                        <h5 class="column-title"><strong>Piriven development fund:</strong></h5>
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col-md-3 col-sm-3 col-xs-12">
                                        <div class="item form-group">
                                            <label for="piriven_dev_fund_account_name">Name of Account</label>
                                            <input  class="form-control col-md-7 col-xs-12"  name="piriven_dev_fund_account_name"  id="piriven_dev_fund_account_name" value="<?php echo isset($post['piriven_dev_fund_account_name']) ? $post['piriven_dev_fund_account_name'] : ''; ?>" placeholder="Name of Account" type="text" autocomplete="off">
                                        </div>
                                    </div>
                                    
                                    <div class="col-md-3 col-sm-3 col-xs-12">
                                        <div class="item form-group">
                                            <label for="piriven_dev_fund_bank">Bank</label>
                                            <input  class="form-control col-md-7 col-xs-12"  name="piriven_dev_fund_bank"  id="piriven_dev_fund_bank" value="<?php echo isset($post['piriven_dev_fund_bank']) ? $post['piriven_dev_fund_bank'] : ''; ?>" placeholder="Bank" type="text" autocomplete="off">
                                        </div>
                                    </div>
                                    <div class="col-md-3 col-sm-3 col-xs-12">
                                        <div class="item form-group">
                                            <label for="piriven_dev_fund_branch">Branch</label>
                                            <input  class="form-control col-md-7 col-xs-12"  name="piriven_dev_fund_branch"  id="piriven_dev_fund_branch" value="<?php echo isset($post['piriven_dev_fund_branch']) ? $post['piriven_dev_fund_branch'] : ''; ?>" placeholder="Branch" type="text" autocomplete="off">
                                        </div>
                                    </div>
                                    <div class="col-md-3 col-sm-3 col-xs-12">
                                        <div class="item form-group">
                                            <label for="piriven_dev_fund_account_number">Account number</label>
                                            <input  class="form-control col-md-7 col-xs-12"  name="piriven_dev_fund_account_number"  id="piriven_dev_fund_account_number" value="<?php echo isset($post['piriven_dev_fund_account_number']) ? $post['piriven_dev_fund_account_number'] : ''; ?>" placeholder="Account number" type="text" autocomplete="off">
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                    <div class="col-md-12 col-sm-12 col-xs-12">
                                        <h5 class="column-title"><strong>Kruthydhikari Account:</strong></h5>
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col-md-3 col-sm-3 col-xs-12">
                                        <div class="item form-group">
                                            <label for="kruthydhikari_account_name">Name of Account</label>
                                            <input  class="form-control col-md-7 col-xs-12"  name="kruthydhikari_account_name"  id="kruthydhikari_account_name" value="<?php echo isset($post['kruthydhikari_account_name']) ? $post['kruthydhikari_account_name'] : ''; ?>" placeholder="Name of Account" type="text" autocomplete="off">
                                        </div>
                                    </div>
                                    
                                    <div class="col-md-3 col-sm-3 col-xs-12">
                                        <div class="item form-group">
                                            <label for="kruthydhikari_bank">Bank</label>
                                            <input  class="form-control col-md-7 col-xs-12"  name="kruthydhikari_bank"  id="kruthydhikari_bank" value="<?php echo isset($post['kruthydhikari_bank']) ? $post['kruthydhikari_bank'] : ''; ?>" placeholder="Bank" type="text" autocomplete="off">
                                        </div>
                                    </div>
                                    <div class="col-md-3 col-sm-3 col-xs-12">
                                        <div class="item form-group">
                                            <label for="kruthydhikari_branch">Branch</label>
                                            <input  class="form-control col-md-7 col-xs-12"  name="kruthydhikari_branch"  id="kruthydhikari_branch" value="<?php echo isset($post['kruthydhikari_branch']) ? $post['kruthydhikari_branch'] : ''; ?>" placeholder="Branch" type="text" autocomplete="off">
                                        </div>
                                    </div>
                                    <div class="col-md-3 col-sm-3 col-xs-12">
                                        <div class="item form-group">
                                            <label for="kruthydhikari_account_number">Account number</label>
                                            <input  class="form-control col-md-7 col-xs-12"  name="kruthydhikari_account_number"  id="kruthydhikari_account_number" value="<?php echo isset($post['kruthydhikari_account_number']) ? $post['kruthydhikari_account_number'] : ''; ?>" placeholder="Account number" type="text" autocomplete="off">
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-3 col-sm-3 col-xs-12">
                                            ...
                                            <div class="item form-group">
                                                ...
                                                <select  class="form-control col-md-7 col-xs-12"  name="pirtype">
                                        ...
                                        <div class="col-md-3 col-sm-3 col-xs-12">
                                            ...
                                            <div class="item form-group">
                                                ...
                                                <input  class="form-control col-md-7 col-xs-12"  name="working_time"  id="working_time" value="<?php echo isset($school) ? $school->working_time : ''; ?>" placeholder="<?php echo $this->lang->line('working_time'); ?>" type="text" autocomplete="off">
                                        ...
                                        <div class="col-md-3 col-sm-3 col-xs-12">
                                            ...
                                            <div class="item form-group">
                                                ...
                                                <input  class="form-control col-md-7 col-xs-12"  name="cencus_number"  id="cencus_number" value="<?php echo isset($school) ? $school->cencus_number : ''; ?>" placeholder="<?php echo $this->lang->line('cencus_number'); ?>" type="text" autocomplete="off">
...
-->
                                    ...
                                    <!-- Inside the <div class="tab-pane fade in active" id="tab_edit_school"> ... </div> -->

<!-- Piriven development fund fields -->
<div class="row">
                                    <div class="col-md-12 col-sm-12 col-xs-12">
                                        <h5 class="column-title"><strong>Piriven development fund:</strong></h5>
                                    </div>
...
<div class="row">
    <div class="col-md-3 col-sm-3 col-xs-12">
        <div class="item form-group">
            <label for="piriven_dev_fund_account_name">Name of Account</label>
            <input  class="form-control col-md-7 col-xs-12"  name="piriven_dev_fund_account_name"  id="piriven_dev_fund_account_name" value="<?php echo isset($school->piriven_dev_fund_account_name) ? $school->piriven_dev_fund_account_name : ''; ?>" placeholder="Name of Account" type="text" autocomplete="off">
        </div>
    </div>
    ...
    <div class="col-md-3 col-sm-3 col-xs-12">
        <div class="item form-group">
            <label for="piriven_dev_fund_bank">Bank</label>
            <input  class="form-control col-md-7 col-xs-12"  name="piriven_dev_fund_bank"  id="piriven_dev_fund_bank" value="<?php echo isset($school->piriven_dev_fund_bank) ? $school->piriven_dev_fund_bank : ''; ?>" placeholder="Bank" type="text" autocomplete="off">
        </div>
    </div>
    <div class="col-md-3 col-sm-3 col-xs-12">
        <div class="item form-group">
            <label for="piriven_dev_fund_branch">Branch</label>
            <input  class="form-control col-md-7 col-xs-12"  name="piriven_dev_fund_branch"  id="piriven_dev_fund_branch" value="<?php echo isset($school->piriven_dev_fund_branch) ? $school->piriven_dev_fund_branch : ''; ?>" placeholder="Branch" type="text" autocomplete="off">
        </div>
    </div>
    <div class="col-md-3 col-sm-3 col-xs-12">
        <div class="item form-group">
            <label for="piriven_dev_fund_account_number">Account number</label>
            <input  class="form-control col-md-7 col-xs-12"  name="piriven_dev_fund_account_number"  id="piriven_dev_fund_account_number" value="<?php echo isset($school->piriven_dev_fund_account_number) ? $school->piriven_dev_fund_account_number : ''; ?>" placeholder="Account number" type="text" autocomplete="off">
        </div>
    </div>
</div>

<!-- Kruthydhikari Account fields -->
<div class="row">
    <div class="col-md-12 col-sm-12 col-xs-12">
        <h5 class="column-title"><strong>Kruthydhikari Account:</strong></h5>
    </div>
...
<div class="row">
    <div class="col-md-3 col-sm-3 col-xs-12">
        <div class="item form-group">
            <label for="kruthydhikari_account_name"> Name of Account</label>
            <input  class="form-control col-md-7 col-xs-12"  name="kruthydhikari_account_name"  id="kruthydhikari_account_name" value="<?php echo isset($school->kruthydhikari_account_name) ? $school->kruthydhikari_account_name : ''; ?>" placeholder="Name of Account" type="text" autocomplete="off">
        </div>
    </div>
    ...
    <div class="col-md-3 col-sm-3 col-xs-12">
        <div class="item form-group">
            <label for="kruthydhikari_bank">Bank</label>
            <input  class="form-control col-md-7 col-xs-12"  name="kruthydhikari_bank"  id="kruthydhikari_bank" value="<?php echo isset($school->kruthydhikari_bank) ? $school->kruthydhikari_bank : ''; ?>" placeholder="Bank" type="text" autocomplete="off">
        </div>
    </div>
    <div class="col-md-3 col-sm-3 col-xs-12">
        <div class="item form-group">
            <label for="kruthydhikari_branch">Branch</label>
            <input  class="form-control col-md-7 col-xs-12"  name="kruthydhikari_branch"  id="kruthydhikari_branch" value="<?php echo isset($school->kruthydhikari_branch) ? $school->kruthydhikari_branch : ''; ?>" placeholder="Branch" type="text" autocomplete="off">
        </div>
    </div>
    <div class="col-md-3 col-sm-3 col-xs-12">
        <div class="item form-group">
            <label for="kruthydhikari_account_number"> Account number</label>
            <input  class="form-control col-md-7 col-xs-12"  name="kruthydhikari_account_number"  id="kruthydhikari_account_number" value="<?php echo isset($school->kruthydhikari_account_number) ? $school->kruthydhikari_account_number : ''; ?>" placeholder="Account number" type="text" autocomplete="off">
        </div>
    </div>
</div>
