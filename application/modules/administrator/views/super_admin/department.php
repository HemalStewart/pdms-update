<div class="row">
    <div class="col-md-12 col-sm-12 col-xs-12">
        <div class="x_panel">
            <div class="x_title">
                <h3 class="head-title"><i class="fa fa-user-md"></i><small> <?php echo $this->lang->line('manage_departmentuser'); ?></small></h3>
                ...
                <div class="" data-example-id="togglable-tabs">
                    ...
                    <ul  class="nav nav-tabs bordered">
                        ...
                        <?php if (has_permission(ADD, 'hrm', 'employee')) { ?>
                            <?php if (isset($edit)) { ?>
                                ...
                                ?>"><a href="<?php echo site_url('administrator/superadmin/addDepartment'); ?>"  aria-expanded="false"><i class="fa fa-plus-square-o"></i> <?php echo $this->lang->line('add'); ?></a> </li>                          
                                 <?php } else { ?>
                                <li  class="<?php
                                if (isset($add)) {
                                    echo 'active';
                    ...
                    <div class="tab-content">
                            ...
                            <div class="x_content">
                                <table id="datatable-responsive" class="table table-striped table-bordered dt-responsive nowrap" cellspacing="0" width="100%">
                                    ...
                                    <tbody>   
                                        <?php
                                        $count = 1;
                                        if (isset($departmentadmins) && !empty($departmentadmins)) {
                                            ?>
                                            <?php foreach ($departmentadmins as $obj) { ?>
                                                <tr>
                                                    <td><?php echo $count++; ?></td>                                            
                                                    <td>
                                                        <?php if ($obj->photo != '') { ?>
                                                            <img src="<?php echo UPLOAD_PATH; ?>/department-photo/<?php echo $obj->photo; ?>" alt="" width="70" /> 
                                                        <?php } else { ?>
                                                    ...
                                                    <td><?php echo $obj->department ." -". $obj->subdepartment; ?></td>
                                                    <td>
                                                        <?php if (has_permission(EDIT, 'administrator', 'superadmin')) { ?> 
                                                            <a href="<?php echo site_url('administrator/superadmin/editdepartment/' . $obj->id); ?>" class="btn btn-info btn-xs"><i class="fa fa-pencil-square-o"></i> <?php echo $this->lang->line('edit'); ?> </a><br/>
                                                        <?php } ?> 
                                                        ...
                                                        <?php if (has_permission(DELETE, 'administrator', 'superadmin')) { ?> 
                                                            <?php if (!$obj->is_default) { ?> 
                                                                <a href="<?php echo site_url('administrator/superadmin/deletedepartment/' . $obj->id); ?>" onclick="javascript: return confirm('<?php echo $this->lang->line('confirm_alert'); ?>');" class="btn btn-danger btn-xs"><i class="fa fa-trash-o"></i> <?php echo $this->lang->line('delete'); ?> </a>
                                                            <?php } ?>
                                                        <?php } ?>
                                                    </td>
                                                </tr>
                        ...
                        ?>" id="tab_add_super_admin">
                            <div class="x_content"> 
                                <?php echo form_open_multipart(site_url('administrator/superadmin/adddepartment'), array('name' => 'add', 'id' => 'add', 'class' => 'form-horizontal form-label-left'), ''); ?>
                                ...
                                <div class="ln_solid"></div>
                                 <input type="hidden" name="depid" id="edit_depid" value="2" />
                                <div class="form-group">
                                    <div class="col-md-6 col-md-offset-3">
                                        <a href="<?php echo site_url('administrator/superadmin/indexdepartment'); ?>" class="btn btn-primary"><?php echo $this->lang->line('cancel'); ?></a>
...
<!--//////////////////////EDIT/////////////////////////////////////////////////////////////////////////////////////////////////////-->
                        <?php if (isset($edit)) { ?>
                            ...
                            <div class="tab-pane fade in active" id="tab_edit_super_admin">
                                <div class="x_content"> 
                                    <?php echo form_open_multipart(site_url('administrator/superadmin/editdepartment/' . $superadmin->id), array('name' => 'edit', 'id' => 'edit', 'class' => 'form-horizontal form-label-left'), ''); ?>
                                    ...
                                    <div class="row">
                                       ...
                                       <div class="col-md-3 col-sm-3 col-xs-12">
                                        ...
                                        <div class="col-md-3 col-sm-3 col-xs-12">
                                            <div class="item form-group">
                                                <label for="department_id"><?php echo $this->lang->line('department'); ?> <span class="required">*</span></label>
                                                <input  class="form-control col-md-7 col-xs-12"  name="hiddendepartment"  id="hiddenprovincial" value="<?php echo $superadmin->department_id ?>"   type="hidden" autocomplete="off">
                                                <select  class="form-control col-md-7 col-xs-12"  name="department_id" id="edit_department_id" required="required" onchange="get_subdep(this.value, '');">
                                                    <option value="">--<?php echo $this->lang->line('select'); ?>--</option>
                                                    ...
                                                    <?php foreach ($listdepartment as $key => $value) {
                                                        ...
                                                        if (isset($superadmin) && $superadmin->department_id == $value["id"]) {
                                                            echo 'selected="selected"';
                                                        }
                                        ...
                                        <div class="col-md-3 col-sm-3 col-xs-12">
                                            <div class="item form-group">
                                                <label for="subdepartment_id"><?php echo $this->lang->line('subdepartment'); ?></label>
                                                <select  name="subdepartment_id" id="edit_subdepartment_id" placeholder="" type="text" class="form-control" >
                                                    <option value="select"><?php echo $this->lang->line('select') ?></option>
                                                </select> 
                                                <span class="text-danger"><?php echo form_error('subdepartment'); ?></span>
                                            </div>
                                        ...
                                        <div class="col-md-3 col-sm-3 col-xs-12">
                                            <div class="item form-group">
                                                ...
                                                <?php if ($superadmin->resume) { ?>
                                                    <a target="_blank" href="<?php echo UPLOAD_PATH; ?>/department-photo/<?php echo $superadmin->resume; ?>"><?php echo $superadmin->resume; ?></a> <br/>
                                                <?php } ?> 
                                            </div>
                                        </div>                                       
                                    </div>
                                        ...
                                        <div class="col-md-3 col-sm-3 col-xs-12">
                                            <div class="item form-group">
                                                ...
                                                <?php if ($superadmin->photo) { ?>
                                                    <img src="<?php echo UPLOAD_PATH; ?>/department-photo/<?php echo $superadmin->photo; ?>" alt="" width="70" /><br/><br/>
                                                <?php } ?>
                                            </div>
                                        </div>
                                    ...
                                    <div class="form-group">
                                        <div class="col-md-6 col-md-offset-3">
                                            ...
                                            <input type="hidden" name="depid" id="edit_depid" value="2" />
                                            <input type="hidden" name="user_id" id="user_id" value="<?php echo $superadmin->user_id; ?>" />
                                            <a href="<?php echo site_url('administrator/superadmin/indexdepartment'); ?>" class="btn btn-primary"><?php echo $this->lang->line('cancel'); ?></a>
...
<script type="text/javascript">
    ...
    function get_super_admin_modal(super_admin_id) {
        ...
        $.ajax({
            type: "POST",
            url: "<?php echo site_url('administrator/superadmin/get_single_Department_admin'); ?>",
