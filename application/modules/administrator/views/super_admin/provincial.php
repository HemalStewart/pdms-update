<div class="row">
    <div class="col-md-12 col-sm-12 col-xs-12">
        <div class="x_panel">
            <div class="x_title">
                <h3 class="head-title"><i class="fa fa-user-md"></i><small> <?php echo $this->lang->line('manage_provuser'); ?></small></h3>
                ...
                <div class="" data-example-id="togglable-tabs">
                    ...
                    <ul  class="nav nav-tabs bordered">
                        ...
                        <?php if(has_permission(ADD, 'hrm', 'employee')){ ?>
                            <?php if(isset($edit)){ ?>
                                <li  class="<?php if(isset($add)){ echo 'active'; }?>"><a href="<?php echo site_url('administrator/superadmin/addprovince'); ?>"  aria-expanded="false"><i class="fa fa-plus-square-o"></i> <?php echo $this->lang->line('add'); ?></a> </li>                          
                             <?php }else{ ?>
                    ...
                    <div class="tab-content">
                        <div  class="tab-pane fade in <?php if(isset($list)){ echo 'active'; }?>" id="tab_super_admin_list" >
                            ...
                            <table id="datatable-responsive" class="table table-striped table-bordered dt-responsive nowrap" cellspacing="0" width="100%">
                                ...
                                <tbody>   
                                    <?php  $count = 1; if(isset($provinceadmins) && !empty($provinceadmins)){ ?>
                                        <?php foreach($provinceadmins as $obj){ ?>
                                        <tr>
                                            <td><?php echo $count++; ?></td>                                            
                                            <td>
                                                <?php  if($obj->photo != ''){ ?>
                                                <img src="<?php echo UPLOAD_PATH; ?>/provincial-photo/<?php echo $obj->photo; ?>" alt="" width="70" /> 
                                                <?php }else{ ?>
                                            ...
                                            <td>
                                                <?php if(has_permission(EDIT, 'administrator', 'provadmin')){ ?> 
                                                    <a href="<?php echo site_url('administrator/superadmin/editprovince/'.$obj->id); ?>" class="btn btn-info btn-xs"><i class="fa fa-pencil-square-o"></i> <?php echo $this->lang->line('edit'); ?> </a><br/>
                                                <?php } ?> 
                                                ...
                                                <?php } ?>
                                                <?php if(has_permission(DELETE, 'administrator', 'provadmin')){ ?> 
                                                    <?php if(!$obj->is_default){ ?> 
                                                        <a href="<?php echo site_url('administrator/superadmin/deleteprovince/'.$obj->id); ?>" onclick="javascript: return confirm('<?php echo $this->lang->line('confirm_alert'); ?>');" class="btn btn-danger btn-xs"><i class="fa fa-trash-o"></i> <?php echo $this->lang->line('delete'); ?> </a>
                                                    <?php } ?>
                                                <?php } ?>
                                            </td>
                                        </tr>
                        ...
                        <div  class="tab-pane fade in <?php if(isset($add)){ echo 'active'; }?>" id="tab_add_super_admin">
                            <div class="x_content"> 
                               <?php echo form_open_multipart(site_url('administrator/superadmin/addprovince'), array('name' => 'add', 'id' => 'add', 'class'=>'form-horizontal form-label-left'), ''); ?>
                                    ...
                                    <div class="col-md-3 col-sm-3 col-xs-12">
                                      ...
                                      <div class="col-md-3 col-sm-3 col-xs-12">
                                        <div class="item form-group">
                                            ...
                                            <select  class="form-control col-md-7 col-xs-12"  name="provincial_id" id="provincial_id" required="required">
                                                <option value="">--<?php echo $this->lang->line('select'); ?>--</option>
                                        ...
                                        <div class="item form-group">
                                            ...
                                            <select  class="form-control col-md-7 col-xs-12 quick-field" name="role_id" id="role_id" required="required">
                                                ...
                                                <?php foreach($roles as $obj){ ?>
                                                    <?php if(in_array($obj->id, array(PROVINCIAL))){ ?>
                                ...
                                <div class="form-group">
                                    <div class="col-md-6 col-md-offset-3">
                                        <a href="<?php echo site_url('administrator/superadmin/indexProvincial'); ?>" class="btn btn-primary"><?php echo $this->lang->line('cancel'); ?></a>
...
<!--//////////////////////////EDIT/////////////////////////////////////////////////////////////////////////////////////////////////////-->
                        ...
                        <div class="tab-pane fade in active" id="tab_edit_super_admin">
                            <div class="x_content"> 
                            <?php echo form_open_multipart(site_url('administrator/superadmin/editprovince/'. $superadmin->id), array('name' => 'edit', 'id' => 'edit', 'class'=>'form-horizontal form-label-left'), ''); ?>
                                ...
                                <div class="row">                                   
                                    ...
                                    <div class="col-md-3 col-sm-3 col-xs-12">
                                        <div class="item form-group">
                                            ...
                                            <img src="<?php echo UPLOAD_PATH; ?>/provincial-photo/<?php echo $superadmin->photo; ?>" alt="" width="70" /><br/><br/>
                                            <?php } ?>
                                        </div>
                                    </div>
...
<script type="text/javascript">
    ...
    function get_super_admin_modal(super_admin_id){
        ...
        $.ajax({       
          type   : "POST",
          url    : "<?php echo site_url('administrator/superadmin/get_single_provincial_admin'); ?>",
