                                ...
                                <tbody>   
                                    <?php  $count = 1; if(isset($provinceadmins) && !empty($provinceadmins)){ ?>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <?php  if($obj->photo != ''){ ?>
                                                    <img src="<?php echo UPLOAD_PATH; ?>/prov-photo/<?php echo $obj->photo; ?>" alt="" width="60" />
                                        ...
                                        <div class="item form-group">
                                           ...
                                           <div class="col-md-3 col-sm-3 col-xs-12">
                                            <div class="item form-group">
                                                ...
                                                <select  class="form-control col-md-7 col-xs-12"  name="provincial_id" id="editprovincial" required="required">
                                                    <option value="">--<?php echo $this->lang->line('select'); ?>--</option>
