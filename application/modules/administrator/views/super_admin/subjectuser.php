<div class="row">
    <div class="col-md-12 col-sm-12 col-xs-12">
        <div class="x_panel">
            <div class="x_title">
                <h3 class="head-title"><i class="fa fa-user-md"></i><small> <?php echo $this->lang->line('manage_subuser'); ?></small></h3>
                ...
                <div class="" data-example-id="togglable-tabs">
                    ...
                    <ul  class="nav nav-tabs bordered">
                        ...
                        <?php if(has_permission(ADD, 'hrm', 'employee')){ ?>
                            <?php if(isset($edit)){ ?>
                                <li  class="<?php if(isset($add)){ echo 'active'; }?>"><a href="<?php echo site_url('administrator/superadmin/addsubject'); ?>"  aria-expanded="false"><i class="fa fa-plus-square-o"></i> <?php echo $this->lang->line('add'); ?></a> </li>                          
                             <?php }else{ ?>
                    ...
                    <div class="tab-content">
                        <div  class="tab-pane fade in <?php if(isset($list)){ echo 'active'; }?>" id="tab_super_admin_list" >
                            ...
                            <table id="datatable-responsive" class="table table-striped table-bordered dt-responsive nowrap" cellspacing="0" width="100%">
                                ...
                                <tbody>   
                                    <?php  $count = 1; if(isset($subjectadmins) && !empty($subjectadmins)){ ?>
                                        <?php foreach($subjectadmins as $obj){ ?>
                                        <tr>
                                            <td><?php echo $count++; ?></td>                                            
                                            <td>
                                                <?php  if($obj->photo != ''){ ?>
                                                <img src="<?php echo UPLOAD_PATH; ?>/subject-photo/<?php echo $obj->photo; ?>" alt="" width="70" /> 
                                                <?php }else{ ?>
                                                <img src="<?php echo IMG_URL; ?>/default-user.png" alt="" width="70" /> 
                                                <?php } ?>
                                            </td>
                                            <td><?php echo ucfirst($obj->name); ?></td>
                                            <td><?php echo $obj->sub_name; ?></td>
                                            <td><?php echo $obj->phone; ?></td>
                                            <td><?php echo $obj->email; ?></td>
                                            <td>
                                                <?php if(has_permission(EDIT, 'administrator', 'subadmindefine')){ ?> 
                                                    <a href="<?php echo site_url('administrator/superadmin/editsubject/'.$obj->id); ?>" class="btn btn-info btn-xs"><i class="fa fa-pencil-square-o"></i> <?php echo $this->lang->line('edit'); ?> </a><br/>
                                                <?php } ?> 
                                                ...
                                                <?php } ?>
                                                <?php if(has_permission(DELETE, 'administrator', 'subadmindefine')){ ?> 
                                                    <?php if(!$obj->is_default){ ?> 
                                                        <a href="<?php echo site_url('administrator/superadmin/deletesubject/'.$obj->id); ?>" onclick="javascript: return confirm('<?php echo $this->lang->line('confirm_alert'); ?>');" class="btn btn-danger btn-xs"><i class="fa fa-trash-o"></i> <?php echo $this->lang->line('delete'); ?> </a>
                                                    <?php } ?>
                                                <?php } ?>
                                            </td>
                                        </tr>
                        ...
                        <div  class="tab-pane fade in <?php if(isset($add)){ echo 'active'; }?>" id="tab_add_super_admin">
                            <div class="x_content"> 
                               <?php echo form_open_multipart(site_url('administrator/superadmin/addsubject'), array('name' => 'add', 'id' => 'add', 'class'=>'form-horizontal form-label-left'), ''); ?>
                                    ...
                                    <div class="col-md-3 col-sm-3 col-xs-12">
                                      ...
                                      <div class="col-md-3 col-sm-3 col-xs-12">
                                        <div class="item form-group">
                                            ...
                                            <select  class="form-control col-md-7 col-xs-12"  name="subject_id[]" id="subject_id" required="required" multiple="">
                                                <!--<option value="">--<?php echo $this->lang->line('select'); ?>--</option>-->
                                                <?php foreach ($listsub as $key => $value) {
                                                    ?>
                                                    <option value="<?php echo $value["id"] ?>" <?php echo set_select('subject', $value['id'], set_value('subject')); ?>><?php echo $value["sub_name"] ?></option>
                                                <?php }
                                                ?> 
                                            </select>
                                        ...
                                        <div class="item form-group">
                                            ...
                                            <select  class="form-control col-md-7 col-xs-12 quick-field" name="role_id" id="role_id" required="required">
                                                ...
                                                <?php foreach($roles as $obj){ ?>
                                                    <?php if(in_array($obj->id, array(SUBJECT))){ ?>
                                ...
                                <div class="form-group">
                                    <div class="col-md-6 col-md-offset-3">
                                        <a href="<?php echo site_url('administrator/superadmin/indexsubject'); ?>" class="btn btn-primary"><?php echo $this->lang->line('cancel'); ?></a>
...
<!--////////////////////////EDIT///////////////////////////////////////////////////////////////////////////////////////////////////////////////-->
                        ...
                        <div class="tab-pane fade in active" id="tab_edit_super_admin">
                            <div class="x_content"> 
                            <?php echo form_open_multipart(site_url('administrator/superadmin/editsubject/'. $superadmin->id), array('name' => 'edit', 'id' => 'edit', 'class'=>'form-horizontal form-label-left'), ''); ?>
                                    ...
                                    <div class="col-md-3 col-sm-3 col-xs-12">
                                        ...
                                        <div class="col-md-3 col-sm-3 col-xs-12">
                                            <div class="item form-group">
                                                ...
                                                <select  class="form-control col-md-7 col-xs-12" name="subject_id[]" id="edit_subject_id" multiple="">

                                                    <?php
                                                    foreach ($sublist as $ks => $v):
                                                        // $Subjectselect = $superadmin->subjectarray_id;
                                                        $Subjectselect = unserialize($superadmin->subjectarray_id);
                                                        ?>
                                                        <option value="<?php echo $v->id ?>" <?php
                                                        if ($Subjectselect) {
                                                            if (in_array($v->id, $Subjectselect)) {
                                                                echo "selected='selected'";
                                                            }
                                                        }
...
<!--                                           <div class="col-md-3 col-sm-3 col-xs-12">
                                            <div class="item form-group">
                                                ...
                                                <input  class="form-control col-md-7 col-xs-12"  name="hiddenprovincial"  id="hiddenprovincial" value="<?php echo $superadmin->provincial_id ?>"   type="hidden" autocomplete="off">
                                                <select  class="form-control col-md-7 col-xs-12"  name="editprovincial_id" id="editprovincial" required="required">
                                                    <option value="">--<?php echo $this->lang->line('select'); ?>--</option>
                                ...
                                <div class="row">                                   
                                    ...
                                    <div class="col-md-3 col-sm-3 col-xs-12">
                                        <div class="item form-group">
                                            ...
                                            <img src="<?php echo UPLOAD_PATH; ?>/subject-photo/<?php echo $superadmin->photo; ?>" alt="" width="70" /><br/><br/>
                                            <?php } ?>
                                        </div>
                                    </div>
...
<script type="text/javascript">
    ...
    function get_super_admin_modal(super_admin_id){
        ...
        $.ajax({       
          type   : "POST",
          url    : "<?php echo site_url('administrator/superadmin/get_single_subject_admin'); ?>",
