                    ...
                    <br/>
                     <div class="tab-content">
                        <div  class="tab-pane fade in active" id="tab_password_reset" >
                            <div class="x_content">
                                <?php echo form_open(site_url('administrator/password/otherindex'), array('name' => 'add', 'id' => 'add', 'class'=>'form-horizontal form-label-left'), ''); ?>
                                         ...
                                         <select  class="form-control col-md-12 col-xs-12"  name="role_id"  id="role_id" required="required" onchange="get_user_by_role(this.value, '');">
                                             ...
                                             <!--<option value="<?php echo $obj->id; ?>"><?php echo $obj->name; ?></option>-->
                                              <?php if(in_array($obj->id, array(PROVINCIAL))){ ?>
                                                    ...
                                                    <option value="<?php echo $obj->id; ?>"><?php echo $obj->name; ?></option>
                                                    <?php } ?>
                                                    <?php if(in_array($obj->id, array(DIRECTOR_MINISTRY))){ ?>
                                                           <option value="<?php echo $obj->id; ?>"><?php echo $obj->name; ?></option>
                                                    <?php } ?>
...
<!--                                <div class="item form-group display"> 
                                 ...
                                 <div class="form-group">
                                     <div class="col-md-6 col-md-offset-3">
                                         <a href="<?php echo site_url('administrator/password/otherindex'); ?>" class="btn btn-primary"><?php echo $this->lang->line('cancel'); ?></a>
...
//       }
   ...
   function get_user(role_id, class_id, user_id, school_id, department_id){
       ...
       $.ajax({       
            ...
            data   : { school_id:school_id, role_id : role_id , class_id: class_id, user_id:user_id, message : true, department_id: department_id},               
            async  : false,
