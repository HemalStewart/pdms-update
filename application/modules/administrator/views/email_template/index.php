                             ...
                             <?php if($this->session->userdata('role_id') == SUPER_ADMIN){  ?> 
                                <select  class="form-control col-md-7 col-xs-12" onchange="get_emailtemplate_by_school(this.value);">
                                    ...
                                    <?php foreach($schools as $obj ){ ?>
                                        <option value="<?php echo site_url('administrator/emailtemplate/index/'.$obj->id); ?>" <?php if(isset($filter_school_id) && $filter_school_id == $obj->id){ echo 'selected="selected"';} ?> > <?php echo $obj->school_name; ?> - ( <?php echo $obj->cencus_number; ?> )</option>
                                    <?php } ?>   
                                </select>                                                                                               
                            <?php } ?>
                        </li>     
