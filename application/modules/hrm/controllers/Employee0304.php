...
class Employee extends MY_Controller {
    ...
    * ********************************************************** */
    ...
    //Provincial
        ...
        public function indexprovincial($school_id = null) {
       ...
       // $this->data['filter_prov_id'] = $province_id;
        ...
        $this->data['filter_school_id'] = $school_id;
         ...
         $this->data['provincial'] = $this->provincial;
          ...
          $this->data['district'] = $this->employee->getdistrictData($provincial_id);
         
         
        $this->data['employees'] = $this->employee->get_employee_provlist($school_id,$provincial_id);
        $this->data['roles'] = $this->employee->get_list('roles', array('status' => 1), '', '', '', 'id', 'ASC');
        ...
        $this->data['list'] = TRUE;
        $this->layout->title($this->lang->line('manage_employee') . ' | ' . SMS);
        $this->layout->view('employee/provincial', $this->data);
    }
     ...
     public function indexzonal($school_id = null) {
       ...
       // check_permission(VIEW);
        ...
        $this->data['employees'] = $this->employee->get_employee_zonallist($zonal_id);
        $this->data['roles'] = $this->employee->get_list('roles', array('status' => 1), '', '', '', 'id', 'ASC');
        ...
        $this->data['list'] = TRUE;
        $this->layout->title($this->lang->line('manage_employee') . ' | ' . SMS);
        $this->layout->view('employee/zonal', $this->data);
    }
