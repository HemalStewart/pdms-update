...
class Progresssub extends MY_Controller {
    ...
    public function reject($id = null) {
        ...
        $this->data['edit'] = TRUE;
        $this->layout->title($this->lang->line('edit') . ' | ' . SMS);
        $this->layout->view('progress/indexsubreject', $this->data);
    }
    ...
    public function get_single_route() {
        ...
        $this->data['plansub'] = $this->route->get_progress_Details($route_id);
...
//        $items[] = 'note';
    ...
    public function delete($id = null) {
        ...
        redirect('adminplan/progress/index/' . $route->user_id);
    }
