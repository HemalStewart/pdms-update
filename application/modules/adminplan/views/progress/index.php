            ...
            <div class="x_content">
                <div class="" data-example-id="togglable-tabs">
                    ...
                    <div class="tab-content">
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        ...
                                                        <?php if (has_permission(EDIT, 'prozo', 'adminprozoplan') && $obj->approvel_status == 1) { ?>
                                                            <a href="<?php echo site_url('adminplan/progress/confirm/' . $obj->id); ?>" class="btn btn-info btn-xs"><i class="fa fa-pencil-square-o"></i> <?php echo $this->lang->line('approve'); ?> </a>
                                                        <?php } ?>

                                                        <?php if (has_permission(EDIT, 'prozo', 'adminprozoplan') && $obj->approvel_status == 1) { ?>
                                                            <a href="<?php echo site_url('adminplan/progress/edit/' . $obj->id); ?>" class="btn btn-dark btn-xs"><i class="fa fa-pencil-square-o"></i> <?php echo $this->lang->line('edit'); ?> </a>
                                                        <?php } ?>
                                                        ...
                                                        <?php } ?>
                                                        <?php if (has_permission(EDIT, 'prozo', 'adminprozoplan') && $obj->approvel_status == 1) { ?>
                                                            <a href="<?php echo site_url('adminplan/progress/reject/' . $obj->id); ?>" class="btn btn-danger btn-xs"><i class="fa fa-pencil-square-o"></i> <?php echo $this->lang->line('reject'); ?> </a>
                                                        <?php } ?>
                        ...
                        ?>" id="tab_add_route">
                            <div class="x_content"> 
                                <?php echo form_open(site_url('adminplan/progress/add'), array('name' => 'add', 'id' => 'add', 'class' => 'form-horizontal form-label-left'), ''); ?>
                        ...
                        <?php if (isset($edit)) { ?>
                            <div class="tab-pane fade in active" id="tab_edit_route">
                                <div class="x_content"> 
                                    <?php echo form_open(site_url('adminplan/progress/edit/' . $route->id), array('name' => 'edit', 'id' => 'edit', 'class' => 'form-horizontal form-label-left'), ''); ?>
                                    ...
                                    <div class="form-group">
                                        <div class="col-md-6 col-md-offset-3">
                                            ...
                                            <a  href="<?php echo site_url('adminplan/progress'); ?>"  class="btn btn-primary"><?php echo $this->lang->line('cancel'); ?></a>
...
<script type="text/javascript">
    ...
    function get_route_depmodal(route_id) {

        $('.fn_route_data').html('<p style="padding: 20px;"><p style="padding: 20px;text-align:center;"><img src="<?php echo IMG_URL; ?>loading.gif" /></p>');
        $.ajax({
            type: "POST",
            url: "<?php echo site_url('adminplan/progressdep/get_single_route'); ?>",
            data: {route_id: route_id},
            success: function (response) {
                if (response)
                {
        ...
        $.ajax({
            type: "POST",
            url: "<?php echo site_url('adminplan/progresssub/get_single_route'); ?>",
            data: {route_id: route_id},
            success: function (response) {
                if (response)
                {
