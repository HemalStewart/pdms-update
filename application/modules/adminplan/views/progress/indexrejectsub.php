                    ...
                    <div class="tab-content">
                        ...
                        <?php if (isset($edit)) { ?>
                            <div class="tab-pane fade in active" id="tab_edit_route">
                                <div class="x_content"> 
                                    <?php echo form_open(site_url('adminplan/progresssub/reject/' . $route->id), array('name' => 'edit', 'id' => 'edit', 'class' => 'form-horizontal form-label-left'), ''); ?>
...
<script type="text/javascript">
    function add_more(fn_stop_container) {
        ...
        $.ajax({
            url: "<?php echo site_url('adminplan/progress/getTableProductRow'); ?>",
            ...
            success: function (response) {
                ...
                $.ajax({
                    url: "<?php echo site_url('adminplan/progress/getTableProgrammeType'); ?>",
...
<div class="modal fade bs-route-modal-lg" tabindex="-1" role="dialog" aria-hidden="true">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            ...
            <div class="modal-body fn_route_data dataTable_wrapper">            
            </div>       
        </div>
    </div>
</div>
