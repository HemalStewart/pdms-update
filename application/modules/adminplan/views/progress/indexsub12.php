                    ...
                    <div class="tab-content">
                        ...
                        <?php if (isset($edit)) { ?>
                            <div class="tab-pane fade in active" id="tab_edit_route">
                                <div class="x_content"> 
                                    <?php echo form_open(site_url('adminplan/progresssub/edit/' . $route->id), array('name' => 'edit', 'id' => 'edit', 'class' => 'form-horizontal form-label-left'), ''); ?>
                ...
                $.ajax({
                    ...
                    success: function (responsetype) {
                        var data = '<tr id="row_' + row_id + '">'
                                + '<td style="width:50%;">'
                                + '<input  class="form-control col-md-12 col-xs-12"  data-row-id="' + row_id + '" style="width:auto;" type="date" name="proposed_date[]" id="addproposed_date_' + row_id + '" class="answer" placeholder="<?php echo $this->lang->line('proposed_date'); ?>" />'
                                + '</td>'
                                + '<td>'
...
//                        });
    ...
    function edit_more(fn_stop_container) {
        ...
        $.ajax({
            url: "<?php echo site_url('subplan/progress/getTableSubjectallRow'); ?>",
            ...
            success: function (response) {
                ...
                $.ajax({
                    ...
                    success: function (responsetype) {
                        var data = '<tr id="row_' + row_id + '">'
                                + '<td style="width:50%;">'
                                + '<input  class="form-control col-md-12 col-xs-12"  data-row-id="' + row_id + '" style="width:auto;" type="date" name="proposed_date[]" id="editproposed_date_' + row_id + '" class="answer" placeholder="<?php echo $this->lang->line('proposed_date'); ?>" />'
                                + '</td>'
                                + '<td>'
