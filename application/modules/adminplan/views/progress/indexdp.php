                    ...
                    <div class="tab-content">
                        ...
                        <?php if (isset($edit)) { ?>
                            <div class="tab-pane fade in active" id="tab_edit_route">
                                <div class="x_content"> 
                                    <?php echo form_open(site_url('adminplan/progressdep/edit/' . $route->id), array('name' => 'edit', 'id' => 'edit', 'class' => 'form-horizontal form-label-left'), ''); ?>
                                    ...
                                    <div class="item form-group">
                                        ...
                                        <div class="col-md-6 col-sm-6 col-xs-12">
                                            ...
                                            <select  id="edit_department_id" name="department_id" placeholder="" type="text" class="form-control" onchange="get_subdep(this.value, '');" disabled="">
                                    ...
                                    <div class="item form-group">
                                        ...
                                        <div class="col-md-6 col-sm-6 col-xs-12">
                                            ...
                                            <select id="edit_subdepartment_id" name="subdepartment_id" placeholder="" type="text" class="form-control" disabled="">
                                                <option value="select"><?php echo $this->lang->line('select') ?></option>
