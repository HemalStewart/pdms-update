...
class Routesub_Model extends MY_Model {
    ...
    public function get_progress_list($user_id) {
        ...
        $this->db->select('N.*, S.monthname,U.username as fullname,D.department,SD.subdepartment');

        $this->db->from('deptplan_monthlydetails AS N');

      
        $this->db->join('month AS S', 'S.id = N.month', 'left');
        $this->db->join('users AS U', 'U.id = N.user_id', 'left');
         $this->db->join('department AS D', 'D.id = N.department_id', 'left');
...
//        }
    ...
    public function get_single_route($route_id) {
        ...
        $this->db->from('subplan_monthlydetails AS N');
    ...
    public function get_progress_Details($route_id) {
        ...
        $this->db->from('subplan_programme AS N');
