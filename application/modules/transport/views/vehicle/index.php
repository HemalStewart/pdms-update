                    ...
                    <ul  class="nav nav-tabs bordered">
                        ...
                        <?php if ($this->session->userdata('role_id') == SUPER_ADMIN) { ?>                                 
                            ...
                            <?php foreach ($schools as $obj) { ?>
                                                                                        <option value="<?php echo site_url('transport/vehicle/index/' . $obj->id); ?>" <?php
                        ...
                        <li class="li-class-list">
                            ...
                            <?php if ($this->session->userdata('role_id') == SUPER_ADMIN) { ?>              
                                ...
                                <?php echo form_open(site_url('transport/vehicle/index/'), array('name' => 'filter', 'id' => 'filter', 'class' => 'form-horizontal form-label-left'), ''); ?>
