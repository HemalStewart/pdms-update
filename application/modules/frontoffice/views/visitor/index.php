                    ...
                    <ul  class="nav nav-tabs bordered">
                        ...
                        <li class="li-class-list">
                            ...
                            <?php if ($this->session->userdata('role_id') == SUPER_ADMIN) { ?> 
                                ...
                                <?php echo form_open(site_url('frontoffice/visitor/index'), array('name' => 'filter', 'id' => 'filter', 'class' => 'form-horizontal form-label-left'), ''); ?>
                                    ...
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        <select  class="form-control col-md-12 col-xs-12"  name="class_id"  id="add_class_id"  onchange="get_user('', this.value,'');">
                                            ...
                                            <?php if(isset($classes) &&  !empty($classes)){ ?>
                                                ...
                                                <option value="<?php echo $obj->School_classid; ?>" ><?php echo $obj->name; ?></option>
                                                <?php } ?> 
                                            <?php } ?> 
                                        </select>
