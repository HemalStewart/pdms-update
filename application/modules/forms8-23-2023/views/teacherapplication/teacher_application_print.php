                    ...
                    <div class="certificate">
                        ...
                        <div class="certificate-top">
						 ...
						 <div class="row" style="padding-left: 25px;padding-top: 10px"> 
								...
								<li><?php echo $this->lang->line('text209'); ?> :- <?php echo "<span style='color:black; text-decoration: underline;text-decoration-style: dashed'>" .$forms->piriven_name."</span>"; ?><br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
								...
								<tr>
									...
									<br>
									 ...
									 <table id="datatable-responsive" class="table table-striped table-bordered dt-responsive nowrap fn_add_stop_1container dataTables_wrapper" cellspacing="0" width="100%" style="padding: 4px;position:relative">
									    <tr>
									        <th colspan="6" style="text-align: left;width: 100%"><?php echo $this->lang->line('text218'); ?> :- <?php echo "<span style='color:black; text-decoration: underline;text-decoration-style: dashed'>" .$forms->exam_name."</span>"; ?></th>
									    </tr>
										 <tr>
										 ...
										 <tr>
											 <th colspan="3" style="width: 50%">
												 ...
												 <?php echo $this->lang->line('tea_year'); ?> :- <?php echo "<span style='color:black; text-decoration: underline;text-decoration-style: dashed'>" .$forms->year_h1."</span>"; ?>
															
										     </th>
											 <th colspan="3" style="width: 50%">
							
												 <?php echo $this->lang->line('tea_year'); ?> :- <?php echo "<span style='color:black; text-decoration: underline;text-decoration-style: dashed'>" .$forms->year_h2."</span>"; ?>
										 ...
										 <tr>
											 ...
											 <th colspan="3" style="width: 50%">
												 ...
												 <?php echo $this->lang->line('text213'); ?> :- <?php echo "<span style='color:black; text-decoration: underline;text-decoration-style: dashed'>" .$forms->exam_noh1."</span>"; ?>
															
										     </th>
											 <th colspan="3" style="width: 50%">
							
												 <?php echo $this->lang->line('text213'); ?> :- <?php echo "<span style='color:black; text-decoration: underline;text-decoration-style: dashed'>" .$forms->exam_noh2."</span>"; ?>
										 ...
										 <tr>
											 ...
											 <th colspan="3" style="width: 50%">
												 ...
												 <?php echo $this->lang->line('text221'); ?> :- <?php echo "<span style='color:black; text-decoration: underline;text-decoration-style: dashed'>" .$forms->datehi."</span>"; ?>
															
										     </th>
											 <th colspan="3" style="width: 50%">
							
												 <?php echo $this->lang->line('text221'); ?> :- <?php echo "<span style='color:black; text-decoration: underline;text-decoration-style: dashed'>" .$forms->datehii."</span>"; ?>
								...
								<tr>
										  ...
										  <tr>
                                                            <td>01</td>
                                                            <td style="width: 50%">
															<?php echo "<span style='color:black;'>" .  $forms->hex1_sub1."</span>";?>
											                  <div class="help-block"><?php echo form_error('hex1_sub1'); ?></div>
															</td>
                                                             <td>
															<?php echo "<span style='color:black;'>" .  $forms->hex1_sub1_grade."</span>";?>
											                  <div class="help-block"><?php echo form_error('hex1_sub1_grade'); ?></div>
															</td>
															
															<td>01</td>
                                                            <td style="width: 50%">
															<?php echo "<span style='color:black;'>" .  $forms->hex2_sub1."</span>";?>
											                  <div class="help-block"><?php echo form_error('hex2_sub1'); ?></div>
															</td>
                                                             <td>
															<?php echo "<span style='color:black; '>" .  $forms->hex2_sub1_grade."</span>";?>
								...
								<li>
								    <?php echo $this->lang->line('text222'); ?> :- <?php echo "<span style='color:black; text-decoration: underline;text-decoration-style: dashed'>" .$forms->other_qualifications."</span>";?>
							    </li>
									
								
								<li>
								    1<?php echo $this->lang->line('text223'); ?> :- <?php echo "<span style='color:black; text-decoration: underline;text-decoration-style: dashed'>" .$forms->yes_no."</span>";?>
                                    ...
                                    .2<?php echo $this->lang->line('text228'); ?> :- <?php echo "<span style='color:black; text-decoration: underline;text-decoration-style: dashed'>" .$forms->leave_reson."</span>";?><br>
								    ...
								    <?php echo $this->lang->line('text230'); ?><br><br>
								    <?php echo $this->lang->line('date'); ?>
								    <?php echo "<span style='color:black; text-decoration: underline;text-decoration-style: dashed'>" .$forms->datev."</span>";?><br>
                                ...
                                <ul style="list-style: decimal-leading-zero;">
                                    ...
                                    <li class="col-md-12">
									    ...
									    <?php echo "<span class='col-md-3 ol-sm-2 col-xs-12'>". $this->lang->line('text240')."</span>"; ?> 
                                    ...
                                    <li class="col-md-12">
									    ...
									    <?php echo "<span class='col-md-3 ol-sm-2 col-xs-12'>". $this->lang->line('text241')."</span>"; ?> 
									
									        <div class="col-md-3 ol-sm-2 col-xs-12" style="text-align: center">
							        ...
							        <li class="col-md-12">
									    ...
									    <?php echo "<span class='col-md-3 ol-sm-2 col-xs-12'>". $this->lang->line('text244')."</span>"; ?> 
									...
									<?php echo "<span class='col-md-5 ol-sm-2 col-xs-12'>". $this->lang->line('text250')."</span>"; ?> 
							        ...
							        <li>
							            ...
							            <?php echo "<span style='color:black; text-decoration: underline;text-decoration-style: dashed'>" .$forms->additional_appointment."</span>"; ?>
							        </li>
								
								    <li>.1 &nbsp;<?php echo $this->lang->line('text252'); ?> :- 
								        <?php echo "<span style='color:black; text-decoration: underline;text-decoration-style: dashed'>" .$forms->piriven_teacher_name."</span>"; ?><br>
								
								        .2 &nbsp;<?php echo $this->lang->line('text253'); ?> :- 
								        <?php echo "<span style='color:black; text-decoration: underline;text-decoration-style: dashed'>" .$forms->jobtitle_subject."</span>"; ?><br>
								
								        .3 &nbsp;<?php echo $this->lang->line('text254'); ?> :- 
								        <?php echo "<span style='color:black; text-decoration: underline;text-decoration-style: dashed'>" .$forms->highedu_subjects."</span>"; ?><br>
								
								        .4 &nbsp;<?php echo $this->lang->line('text255'); ?> :- 
								        <?php echo "<span style='color:black; text-decoration: underline;text-decoration-style: dashed'>" .$forms->teacher_rej_no."</span>"; ?><br>
								
								        .5 &nbsp;<?php echo $this->lang->line('text256'); ?> :- 
								        <?php echo "<span style='color:black; text-decoration: underline;text-decoration-style: dashed'>" .$forms->datevi."</span>"; ?><br>
								
								        .6 &nbsp;<?php echo $this->lang->line('text257'); ?> :- 
								        <?php echo "<span style='color:black; text-decoration: underline;text-decoration-style: dashed'>" .$forms->datatable-responsive."</span>"; ?><br>
								
								        .7 &nbsp;<?php echo $this->lang->line('text265'); ?> 
								    ...
								    <div>
								        ...
								        <?php echo $this->lang->line('date'); ?>
								        <?php echo $forms->dateviii; ?><br>
								        <?php echo $this->lang->line('text273a'); ?>
								        <?php if ($forms->sig1_photo) { ?>
                                ...
                                <div>
                                    <?php echo $this->lang->line('date'); ?>
                                    <?php echo $forms->dateix; ?><br>
                                    <?php echo $this->lang->line('text278'); ?>
                                    <?php if ($forms->sig1_photo) { ?>
                                ...
                                <div>
		                            ...
		                            <?php echo "<span style='color:black; text-decoration: underline;text-decoration-style: dashed'>" .  $forms->datex."</span>";?><br>
                                ...
                                <div>
                                    <?php echo $this->lang->line('date'); ?>
                                    <?php echo $forms->datexi; ?><br>
                                    <?php echo $this->lang->line('text284'); ?>
                                    <?php echo $this->lang->line('text284a'); ?>
                                    <?php if ($forms->sig1_photo) { ?>
                                ...
                                <div>
                                    <?php echo $this->lang->line('date'); ?>
                                    <?php echo $forms->datexii; ?><br>
                                    <?php echo $this->lang->line('text288'); ?>
                                    <?php if ($forms->sig1_photo) { ?>
                                ...
                                <div>
                                    <?php echo $this->lang->line('date'); ?>
                                    <?php echo $forms->datexiii; ?>
                                    <?php echo $this->lang->line('text290'); ?>
                                    <?php if ($forms->sig1_photo) { ?>
                                ...
                                <div>
                                    <?php echo $this->lang->line('date'); ?>
                                    <?php echo $forms->datexiv; ?><br>
                                    <?php echo $this->lang->line('text292'); ?>
                                    <?php if ($forms->sig1_photo) { ?>
                                ...
                                <div>
                                    <?php echo $this->lang->line('date'); ?>
                                    <?php echo $forms->datexv; ?><br>
                                    <?php echo $this->lang->line('text295'); ?>
                                    <?php if ($forms->sig1_photo) { ?>
