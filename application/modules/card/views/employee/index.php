                                            ...
                                            <div class="card-block">
                                                ...
                                                <div class="card-main">
                                                    ...
                                                    <div class="card-info">
                                                        ...
                                                        <p><span class="card-title"><?php echo $this->lang->line('phone'); ?></span><span class="card-value">: <?php echo $obj->phone; ?></span></p>
                                                        <p><span class="card-title"><?php echo $this->lang->line('nic1'); ?></span><span class="card-value">: <?php echo $obj->national_id; ?></span></p>
                                                        ...
                                                        <p><span class="card-title"><?php echo $this->lang->line('appointment_date2'); ?></span><span class="card-value">: <?php echo date($this->global_setting->date_format, strtotime($obj->joining_date)); ?></span></p>
                                                    </div>
                                                </div>
