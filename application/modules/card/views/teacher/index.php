                                            ...
                                            <div class="card-block">
                                                <div class="card-top">
                                                    ...
                                                    <div class="card-school">
                                                        <h4><?php echo isset($setting->school_name) ? $setting->school_name : $school->school_name; ?></h4>
                                                ...
                                                <div class="card-main">
                                                    ...
                                                    <div class="card-info">
                                                        <p><span class="card-title"><?php echo $this->lang->line('teacher_name'); ?></span><span class="card-dots">:</span><span class="card-value"><?php echo $obj->name; ?></span></p>
                                                        <p><span class="card-title"><?php echo $this->lang->line('responsibility'); ?></span><span class="card-dots">:</span><span class="card-value"><?php echo $obj->responsibility; ?></span></p><br>
                                                        <p><span class="card-title"><?php echo $this->lang->line('phone'); ?></span><span class="card-dots">:</span><span class="card-value"><?php echo $obj->phone; ?></span></p>
                                                        <p><span class="card-title"><?php echo $this->lang->line('nic1'); ?></span><span class="card-dots">:</span><span class="card-value"><?php echo $obj->national_id; ?></span></p>
                                                        <p><span class="card-title"><?php echo $this->lang->line('blood_group'); ?></span><span class="card-dots">:</span><span class="card-value"><?php echo $this->lang->line($obj->blood_group); ?></span></p>
                                                        <p><span class="card-title"><?php echo $this->lang->line('birth_date'); ?></span><span class="card-dots">:</span><span class="card-value"><?php echo date($this->global_setting->date_format, strtotime($obj->dob)); ?></span></p>
                                                        <p><span class="card-title"><?php echo $this->lang->line('appointment_date2'); ?></span><span class="card-dots">:</span><span class="card-value"><?php echo date($this->global_setting->date_format, strtotime($obj->joining_date)); ?></span></p>
