...
<div class="row">
    <div class="col-md-12 col-sm-12 col-xs-12">
        <div class="x_panel">
            <div class="x_title">
                <h3 class="head-title"><i class="fa fa-file-text-o"></i><small> <?php echo $this->lang->line('depplanprogress'); ?></small></h3>
                ...
                <div class="" data-example-id="togglable-tabs">
                    ...
                    <ul  class="nav nav-tabs bordered">
                        ...
                        ?>"><a href="#tab_route_list"   role="tab" data-toggle="tab" aria-expanded="true"><i class="fa fa-list-ol"></i> <?php echo $this->lang->line('list'); ?></a> </li>
                            <?php if(date("d") < "5"){if (has_permission(ADD, 'prozo', 'depplan')) { ?>
                                <?php if (isset($edit)) { ?>
                                <li  class="<?php
                                if (isset($add)) {
                                    echo 'active';
                                }
                                ?>"><a href="<?php echo site_url('depplan/progress/add'); ?>"  aria-expanded="false"><i class="fa fa-plus-square-o"></i> <?php echo $this->lang->line('add'); ?></a> </li>                          
                                 <?php } else { ?>
                                <li  class="<?php
                                if (isset($add)) {
                                    echo 'active';
...
මාසික ප්‍රගතිය පිළිබඳ තොරතුරු ඇතුළත් කිරීමට ලබා දී තිබූ කාලය අවසන්.';;
                    ...
                    <div class="tab-content">
                                        ...
                                        if (isset($routes) && !empty($routes)) {
                                            ...
                                            foreach ($routes as $obj) {
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <?php if (has_permission(EDIT, 'prozo', 'depplan') && $obj->confirmstatus != 2) { ?>
                                                            <a href="<?php echo site_url('depplan/progress/edit/' . $obj->id); ?>" class="btn btn-info btn-xs"><i class="fa fa-pencil-square-o"></i> <?php echo $this->lang->line('edit'); ?> </a>
                                                        <?php } ?>
                                                        <?php if (has_permission(EDIT, 'prozo', 'depplan') && $obj->confirmstatus != 2) { ?>
                                                            <a href="<?php echo site_url('depplan/progress/confirm/' . $obj->id); ?>" class="btn btn-main btn-xs"><i class="fa fa-check-square-o"></i> <?php echo $this->lang->line('confirm'); ?> </a>
                                                        <?php } ?>
                                                        ...
                                                        <?php } ?>
                                                        <?php if (has_permission(DELETE, 'prozo', 'depplan') && $obj->confirmstatus != 2) { ?>
                                                            <a href="<?php echo site_url('depplan/progress/delete/' . $obj->id); ?>" onclick="javascript: return confirm('<?php echo $this->lang->line('confirm_alert'); ?>');" class="btn btn-danger btn-xs"><i class="fa fa-trash-o"></i> <?php echo $this->lang->line('delete'); ?> </a>
                                                        <?php } ?>
                                                    </td>
                                                </tr>
                                            <?php } ?>
                        ...
                        ?>" id="tab_add_route">
                            <div class="x_content"> 
                                <?php echo form_open(site_url('depplan/progress/add'), array('name' => 'add', 'id' => 'add', 'class' => 'form-horizontal form-label-left'), ''); ?>
                                ...
                                <div class="row">                  
                                    <div class="col-md-12 col-sm-12 col-xs-12">
                                        <h5  class="column-title"><strong><?php echo $this->lang->line('depplanprogress'); ?>:</strong></h5>
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="item form-group">
...
<!--                                                        <td>
                                ...
                                <div class="form-group">
                                    <div class="col-md-6 col-md-offset-3">
                                        <a href="<?php echo site_url('depplan/progress'); ?>" class="btn btn-primary"><?php echo $this->lang->line('cancel'); ?></a>
                        ...
                        <?php if (isset($edit)) { ?>
                            <div class="tab-pane fade in active" id="tab_edit_route">
                                <div class="x_content"> 
                                    <?php echo form_open(site_url('depplan/progress/edit/' . $route->id), array('name' => 'edit', 'id' => 'edit', 'class' => 'form-horizontal form-label-left'), ''); ?>
...
//        $.ajax({
//            url: "<?php echo site_url('depplan/progress/getTableProductRow'); ?>",
//
//            type: 'post',
//            dataType: 'json',
//            success: function (response) {
        ...
        $.ajax({
            url: "<?php echo site_url('depplan/progress/getTableProgrammeType'); ?>",
    ...
    function remove(obj, stop_id) {
        ...
        if (stop_id)
        {
            if (confirm('<?php echo $this->lang->line('confirm_alert'); ?>')) {
                $.ajax({
                    type: "POST",
                    url: "<?php echo site_url('depplan/progress/remove_event'); ?>",
...
<script type="text/javascript">
    ...
    function get_route_modal(route_id) {
        ...
        $.ajax({
            type: "POST",
            url: "<?php echo site_url('depplan/progress/get_single_route'); ?>",
