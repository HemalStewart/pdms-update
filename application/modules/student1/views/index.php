...
<!--                                    <div class="col-md-3 col-sm-3 col-xs-12">
                                ...
                                <div class="row">                  
                                    <div class="col-md-12 col-sm-12 col-xs-12">
                                        <h5  class="column-title"><strong><?php echo $this->lang->line('admission_infor'); ?>:</strong></h5>
                                    </div>
                                </div>
...
<!--                                     <div class="col-md-3 col-sm-3 col-xs-12">
                                ...
                                <div class="<?php echo ($post['is_guardian']) && $post['is_guardian'] != 'exist_guardian' ? '' :'display'; ?> fn_except_exist"> 
                                    ...
                                    <!--        <input  class="form-control col-md-7 col-xs-12"  name="gud_password"  id="gud_password" value="" placeholder="<?php echo $this->lang->line('password'); ?>" required="required" type="text" autocomplete="off">-->
