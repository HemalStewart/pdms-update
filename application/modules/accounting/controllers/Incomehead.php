...
class Incomehead extends MY_Controller {
    ...
    function __construct() {
        parent::__construct();
         $this->load->model('Incomehead_Model', 'incomehead', true);   
          ...
          $listprovincial = $this->incomehead->listprovincial();
    ...
    private function _prepare_incomehead_validation() {
        ...
        $this->form_validation->set_rules('title', $this->lang->line('income_head'), 'trim|required');
        $this->form_validation->set_rules('title', $this->lang->line('account_type'), 'trim|required');
        $this->form_validation->set_rules('account_number', $this->lang->line('account_number'), 'trim|required');   
        ...
        $this->form_validation->set_rules('branch_code', $this->lang->line('branch_code'), 'trim|required');   
