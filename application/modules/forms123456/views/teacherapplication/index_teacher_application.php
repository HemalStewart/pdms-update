                                                    ...
                                                    <table id="datatable-responsive" class="table table-striped table-bordered dt-responsive nowrap" cellspacing="0" width="100%">
                                                        ...
                                                        <thead>
                                                            <tr>
                                                                ...
                                                                <td>
                                                                    <input  class="form-control col-md-7 col-xs-12"  name="vacancy_extra"  id="vacancy" value="vacancy" placeholder=""  type="number" autocomplete="off">
                                                                    <div class="help-block"><?php echo form_error('vacancy'); ?></div>
                                                                </td>
                                                                <th style="vertical-align: super;"><?php echo $this->lang->line('text243'); ?></th>
                                                                <td>
                                                                    <input  class="form-control col-md-7 col-xs-12"  name="vacancy_extra"  id="extra" value="extra" placeholder=""  type="number" autocomplete="off">
