<div class="row">
    <div class="col-md-12 col-sm-12 col-xs-12">
        <div class="x_panel">
            <div class="x_title">
                <h3 class="head-title"><i class="fa fa-bar-chart"></i><small> <?php echo $this->lang->line('progressproc_report'); ?></small></h3>                
            ...
            <div class="x_content filter-box no-print"> 
                <?php echo form_open_multipart(site_url('report/progressproc'), array('name' => 'plan', 'id' => 'plan', 'class' => 'form-horizontal form-label-left'), ''); ?>
                <div class="row">                    
                    <div class="col-md-10 col-sm-10 col-xs-12">
                        ...
                        <?php foreach ($groups as $key => $value) { ?>
                            ...
                            if (isset($group_by) && $group_by == $key) {
                                echo 'selected="selected"';
                            }
                            ?>><?php echo $value; ?></option>
                        <?php } ?>
                                                            <option value="class" <?php
                        if (isset($group_by) && $group_by == 'class') {
                            echo 'selected="selected"';
                        }
                        ?>><?php echo $this->lang->line('class'); ?></option>
                                                        </select>
                                                    </div>
                                                </div>-->
            ...
            <div class="x_content">
                <div class="" data-example-id="togglable-tabs">
                    ...
                    <ul  class="nav nav-tabs bordered no-print">
                        ...
                        <li><a href="#tab_deptabular"   role="tab" data-toggle="tab"   aria-expanded="true"><i class="fa fa-list-ol"></i> <?php echo $this->lang->line('depprozoprogress'); ?></a> </li>
                        <li><a href="#tab_subtabular"   role="tab" data-toggle="tab"   aria-expanded="true"><i class="fa fa-list-ol"></i> <?php echo $this->lang->line('subprozoprogress'); ?></a> </li>
                    </ul>
                    <br/>
...
<!--<td><?php echo $this->lang->line('username'); ?></td>-->
                                    ...
                                    <tbody>   
                                        ...
                                        $count = 1;
                                        if (isset($progressproc) && !empty($progressproc)) {
                                            ?>
                                            <?php
                                            foreach ($progressproc as $obj) {
                         ...
                         <div  class="tab-pane fade in" id="tab_subtabular" >
                            <div class="x_content">
                                <table id="subdatatable-responsive" class="table table-striped table-bordered dt-responsive nowrap" cellspacing="0" width="100%">
                                    <thead>
                                        <tr>
                                            <th><?php echo $this->lang->line('sl_no'); ?></th>
                                            <th><?php echo $this->lang->line('month'); ?></th>
...
<!--<td><?php echo $this->lang->line('username'); ?></td>-->
                                    ...
                                    <tbody>   
                                        ...
                                        $count = 1;
                                         if (isset($subprogressproc) && !empty($subprogressproc)) {
                                            ?>
                                            <?php
                                            foreach ($subprogressproc as $obj) {
                         ...
                         <div  class="tab-pane fade in" id="tab_deptabular" >
                            <div class="x_content">
                                <table id="depdatatable-responsive" class="table table-striped table-bordered dt-responsive nowrap" cellspacing="0" width="100%">
                                    <thead>
                                        <tr>
                                            <th><?php echo $this->lang->line('sl_no'); ?></th>
                                            <th><?php echo $this->lang->line('month'); ?></th>
...
<!--<td><?php echo $this->lang->line('username'); ?></td>-->
                                    ...
                                    <tbody>   
                                        ...
                                        $count = 1;
                                        if (isset($depplanproc) && !empty($depplanproc)) {
                                            ?>
                                            <?php
                                            foreach ($depplanproc as $obj) {
...
<script type="text/javascript">
    ...
    dom: 'Bfrtip',
     ...
     $('#subdatatable-responsive').DataTable({
    dom: 'Bfrtip',
            iDisplayLength: 15,
            buttons: [
                    'copyHtml5',
      ...
      $('#depdatatable-responsive').DataTable({
    dom: 'Bfrtip',
            iDisplayLength: 15,
            buttons: [
                    'copyHtml5',
