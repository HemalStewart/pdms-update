                ...
                <div class="" data-example-id="togglable-tabs">
                    ...
                    <ul  class="nav nav-tabs bordered no-print">
                        <li class="active"><a href="#tab_tabular" role="tab" data-toggle="tab" aria-expanded="true"><i class="fa fa-list-ol"></i> <?php echo $this->lang->line('p&z_plan_report'); ?></a> </li>
                          <li><a href="#tab_deptabular"   role="tab" data-toggle="tab"   aria-expanded="true"><i class="fa fa-list-ol"></i> <?php echo $this->lang->line('dep_plan_report'); ?></a> </li>
                          <li><a href="#tab_subtabular"   role="tab" data-toggle="tab"   aria-expanded="true"><i class="fa fa-list-ol"></i> <?php echo $this->lang->line('subplanprogress'); ?></a> </li>
                    </ul>
                    <br/>
...
<!--<td><?php echo $this->lang->line('username'); ?></td>-->
                                    ...
                                    <tbody>   
                                        ...
                                        $count = 1;
                                        if (isset($subplanproc) && !empty($subplanproc)) {
                                            ?>
                                            <?php
                                            foreach ($subplanproc as $obj) {
...
<!--<td><?php echo $this->lang->line('username'); ?></td>-->
                                    ...
                                    <tbody>   
                                        ...
                                        $count = 1;
                                        if (isset($depprogressproc) && !empty($depprogressproc)) {
                                            ?>
                                            <?php
                                            foreach ($depprogressproc as $obj) {
