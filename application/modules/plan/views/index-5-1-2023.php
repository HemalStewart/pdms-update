                                            ...
                                            foreach ($routes as $obj) {
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        ...
                                                        <?php } ?>
                                                        <?php if (has_permission(EDIT, 'prozo', 'prozoplan') && $obj->confirmstatus != 2) { ?>
                                                            <a href="<?php echo site_url('plan/progress/confirm/' . $obj->id); ?>" class="btn btn-warning btn-xs"><i class="fa fa-check-square-o"></i> <?php echo $this->lang->line('confirm'); ?> </a>
                                                        <?php } ?>
                ...
                $.ajax({
                    ...
                    success: function (responsetype) {
                        var data = '<tr id="row_' + row_id + '">'
                                + '<td style="width:50%;">'
                                + '<input  class="form-control col-md-12 col-xs-12 datepicker"  data-row-id="' + row_id + '" style="width:auto;" type="text" name="proposed_date[]" id="addproposed_date_' + row_id + '" placeholder="<?php echo $this->lang->line('addproposed_date'); ?>" />'
                                + '</td>'
                                + '<td>'
