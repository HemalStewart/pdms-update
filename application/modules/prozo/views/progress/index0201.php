                            ...
                            <div class="x_content"> 
                                ...
                                <?php if ($this->session->userdata('role_id') == ZONAL) { ?>
                                    ...
                                    <div class="item form-group">
                                        ...
                                        <div class="col-md-6 col-sm-6 col-xs-12">
                                            <select  class="form-control col-md-7 col-xs-12"  name="district_id" id="add_district_id" required="required" onchange="get_zonal_by_district(this.value, '');">
                                                <option value="">--<?php echo $this->lang->line('select'); ?>--</option>
                                            ...
                                            <div class="scrollit">
                                                <table style="width:100%;" class="fn_add_stop_container responsive" id="product_info_table"> 
                                                    ...
                                                    <tr>               
                                                        ...
                                                        <td>
                                                            <input  class="form-control col-md-12 col-xs-12" style="width:auto;" type='number' name="expected_cost[]" id="expected_cost" value="" placeholder="<?php echo $this->lang->line('expected_cost'); ?>"/>
                                                        </td>
                                                        <td>
                                    ...
                                    <?php if ($this->session->userdata('role_id') == ZONAL) { ?>
                                        ...
                                        <div class="item form-group">
                                            ...
                                            <div class="col-md-6 col-sm-6 col-xs-12">
                                                ...
                                                <input class="form-control col-md-7 col-xs-12"  name="hiddencurrent_zonal"  id="edit_hiddencurrent_zonal" value="<?php echo $route->zonal_id; ?>" type="hidden" autocomplete="off">
                                                ...
                                                <table style="width:100%;" class="fn_edit_stop_container responsive" id="product_editinfo_table"> 
                                                    ...
                                                    foreach ($route_stops as $obj) {
                                                        ...
                                                        <tr>               
                                                            ...
                                                            <td>
                                                                <input  class="form-control col-md-12 col-xs-12" style="width:auto;" type='number' name="expected_cost[]" id="edit_expected_cost" value="<?php echo $obj->expected_cost; ?>" placeholder="<?php echo $this->lang->line('expected_cost'); ?>"/>
                                                            </td>
                                                            <td>
...
//                        });
                                                            ...
                                                            data += '</select>' +
                                                                    ...
                                                                    + '</td>'
                                                                    + '<td>'
                                                                    + '<input  class="form-control col-md-12 col-xs-12"  data-row-id="' + row_id + '" style="width:auto;" type="number" name="expected_cost[]" id="expected_cost_' + row_id + '" value="" placeholder="<?php echo $this->lang->line('expected_cost'); ?>"/>'
                                                                    + '</td>'
                                                                    + '<td>'
...
//            success: function (response) {
                                                    ...
                                                    $.ajax({
                                                        ...
                                                        success: function (responsetype) {
                                                            var data = '<tr id="row_' + row_id + '">'
                                                                    + '<td style="width:50%;">'
                                                                    + '<input  class="form-control col-md-12 col-xs-12 datepicker"  data-row-id="' + row_id + '" style="width:auto;" type="text" name="proposed_date[]" id="editproposed_date_' + row_id + '"  placeholder="<?php echo $this->lang->line('addproposed_date'); ?>" />'
                                                                    + '</td>'
                                                                    + '<td>'
...
//                        });
                                                            ...
                                                            data += '</select>' +
                                                                    ...
                                                                    + '</td>'
                                                                    + '<td>'
                                                                    + '<input  class="form-control col-md-12 col-xs-12"  data-row-id="' + row_id + '" style="width:auto;" type="number" name="expected_cost[]" id="editexpected_cost_' + row_id + '" value="" placeholder="<?php echo $this->lang->line('expected_cost'); ?>"/>'
                                                                    + '</td>'
                                                                    + '<td>'
