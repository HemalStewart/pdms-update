                                            ...
                                            foreach ($routes as $obj) {
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        ...
                                                        <?php } ?>
                                                        <?php if (has_permission(EDIT, 'prozo', 'prozoprogress') && $obj->confirmstatus != 2) { ?>
                                                            <a href="<?php echo site_url('prozo/progress/confirm/' . $obj->id); ?>" class="btn btn-warning btn-xs"><i class="fa fa-check-square-o"></i> <?php echo $this->lang->line('confirm'); ?> </a>
                                                        <?php } ?>
                                                            ...
                                                            var role_id = '';
                                                                ...
                                                                $.ajax({
                                                                    ...
                                                                    success: function (response) {
                                                                        if (response)
                                                                        {
                                                                            mstartdate = response.startdate;
                                                                            menddate = response.enddate;
                                                                        }
                                                                    }
                                                                });
...
//        var nextmonth = curToday.getMonth()+1;
//        var nextyear = dtToday.getFullYear();


                                                                var mfDate = year + "-" + month + "-" + mstartdate;


                                                                var endDate = year + "-" + month + "-" + menddate;
...
//        alert(district_id, zonal_id);
        ...
        $.ajax({
            type: "POST",
            url: "<?php echo site_url('ajax/get_zonal_by_districtnewval'); ?>",
