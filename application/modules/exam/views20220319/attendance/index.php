                                ...
                                <div class="item form-group"> 
                                    ...
                                    <select  class="form-control col-md-7 col-xs-12 fn_school_id" name="school_id" id="school_id" required="required">
                                        ...
                                        <?php foreach ($schools as $obj) { ?>
                                            ...
                                            if (isset($school_id) && $school_id == $obj->id) {
                            ...
                            <div class="item form-group"> 
                                ...
                                <select  class="form-control col-md-7 col-xs-12" name="exam_id" id="exam_id"  required="required">
                                    ...
                                    <?php foreach ($exams as $obj) { ?>
                                        <option value="<?php echo $obj->id; ?>" <?php
                                        if (isset($exam_id) && $exam_id == $obj->id) {
                                            echo 'selected="selected"';
                                        }
                            ...
                            <div class="item form-group"> 
                                ...
                                <select  class="form-control col-md-7 col-xs-12" name="class_id" id="class_id"  required="required" onchange="get_section_subject_by_class(this.value, '', '');">
                                    ...
                                    <?php foreach ($classes as $obj) { ?>
                                        <?php
                                        if ($this->session->userdata('role_id') == TEACHER && !in_array($obj->id, $teacher_student_data)) {
                                            continue;
                                            ?>
                                            <?php
                                        } elseif ($this->session->userdata('role_id') == GUARDIAN && !in_array($obj->id, $guardian_class_data)) {
                                            continue;
                                        }
                                        ?>
                                        <option value="<?php echo $obj->id; ?>" <?php
...
<?php } ?> 
        ...
        <?php } ?>
                                    ...
                                    <td>
                                        <?php if (has_permission(VIEW, 'exam', 'attendance') && !has_permission(EDIT, 'exam', 'attendance')) { ?>
                                            <input type="checkbox" value="1" itemid="<?php echo $obj->student_id; ?>" name="student_<?php echo $obj->id; ?>"  disabled="disabled" class="" <?php
                                            if ($attendance) {
                                                echo 'checked="checked"';
                                            }
                                            ?> />
                                        <?php } else if (has_permission(EDIT, 'exam', 'attendance')) { ?> 
                                            <input type="checkbox" value="1" itemid="<?php echo $obj->student_id; ?>" name="student_<?php echo $obj->id; ?>" class="present fn_single_attendnce" <?php
                                            if ($attendance) {
                                                echo 'checked="checked"';
                                            }
                                            ?> />
