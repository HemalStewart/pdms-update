                                    ...
                                    <select  class="form-control col-md-7 col-xs-12" onchange="get_suggestion_list_by_class(this.value);">
                                        ...
                                        <?php foreach($listclass as $obj ){ ?>
                                            <?php if($this->session->userdata('role_id') == STUDENT){ ?>
                                                ...
                                                <option value="<?php echo site_url('exam/suggestion/index/'.$obj->School_classesid); ?>" <?php if(isset($class_id) && $class_id == $obj->School_classesid){ echo 'selected="selected"';} ?> ><?php echo $obj->School_className; ?></option>
                                            ...
                                            <?php if(isset($listclass) && !empty($listclass)){ ?>
                                                <?php foreach($listclass as $obj ){ ?>
                                                  <?php
                                                    ...
                                                    ?>
                                                    <option value="<?php echo $obj->School_classesid; ?>" <?php if($obj->School_classesid == $suggestion->class_id){ echo 'selected="selected"'; } ?>><?php echo $obj->School_className; ?></option>
                                                <?php } ?>                                            
                                            <?php } ?>                                            
                                        </select>
                                        <div class="help-block"><?php echo form_error('class_id'); ?></div>
