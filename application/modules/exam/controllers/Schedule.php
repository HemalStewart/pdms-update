...
//        $this->data['schedules'] = $this->schedule->get_schedule_list($class_id, $school_id, @$school->academic_year_id);
         ...
         $this->data['schedules'] = $this->schedule->get_schedule_list($province_id,$district_id,$zonal_id,$edu_id,$schools_id,$school_id,$class_id, @$school->academic_year_id);
        ...
        if($school){
         ...
         $eschoolid = $this->session->userdata('school_id');
     //   $this->data['exams'] = $this->schedule->getexamData($eschoolid);
        
        $pirtype = $this->session->userdata('pirtype');
        $listclass = $this->schedule->getclassData($pirtype);
