...
<!--                        <li class="li-class-list">
    ...
    <li class="li-class-list">
                              ...
                              <?php echo form_open(site_url('announcement/notice/index/'), array('name' => 'filter', 'id' => 'filter', 'class' => 'form-horizontal form-label-left'), ''); ?>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <?php if(has_permission(DELETE, 'announcement', 'notice')){ ?>
                                                    <a href="<?php echo site_url('announcement/notice/delete/'.$obj->id); ?>" class="btn btn-danger btn-xs"><i class="fa fa-trash-o"></i> <?php echo $this->lang->line('delete'); ?> </a>
                                                <?php } ?>
                                            </td>
                                        </tr>
                                        <?php } ?>
