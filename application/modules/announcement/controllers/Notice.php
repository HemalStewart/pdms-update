...
class Notice extends MY_Controller {
    ...
    * ********************************************************** */
    public function index($school_id = null) {
        ...
        $this->data['notices'] = $this->notice->get_noticeschool_list($school_id,$user_id);
...
//        $this->data['filter_school_id'] = $school_id;
    ...
    * ********************************************************** */
    public function view($id = null) {
       ...
       public function viewindex($id = null) {
        ...
        $this->data['detail'] = TRUE;
        $this->layout->title($this->lang->line('view') . ' ' . $this->lang->line('notice') . ' | ' . SMS);
        $this->layout->view('notice/get-single-notice', $this->data);
    }
