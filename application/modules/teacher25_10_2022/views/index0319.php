                                        ...
                                        if (isset($teachers) && !empty($teachers)) {
                                            ...
                                            <?php foreach ($teachers as $obj) { ?>
                                                <tr>
                                                    ...
                                                    <th><?php echo $obj->national_id; ?></td>
                            ...
                            <div class="x_content"> 
                                ...
                                <div class="row"> 
                                   ...
                                   <!-- <div class="col-md-3 col-sm-3 col-xs-12">
                                     ...
                                     <div class="col-md-3 col-sm-3 col-xs-12">
                                        <div class="item form-group">
                                            <label for="salary_grade_id"><?php echo $this->lang->line('salary_grade'); ?> 
                                ...
                                <div class="x_content"> 
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-3 col-sm-3 col-xs-12">
                                            <div class="item form-group">
                                                <label for="ordination_date"><?php echo $this->lang->line('ordination_date'); ?></label>
                                                <input  class="form-control col-md-7 col-xs-12"  name="ordination_date"  id="edit_ordination_date" value="<?php echo isset($teacher->ordination_date) ? date('Y-m-d', strtotime($teacher->ordination_date)) : ''; ?>" placeholder="<?php echo $this->lang->line('ordination_date'); ?>" type="text" autocomplete="off">
                                                <div class="help-block"><?php echo form_error('ordination_date'); ?></div>
                                            </div>
                                        </div>
...
-->                                                <input  class="form-control col-md-7 col-xs-12"  name="higher_ordination_date"  id="edit_higher_ordination_date" value="<?php echo isset($post['higher_ordination_date']) ? $post['higher_ordination_date'] : ''; ?>" placeholder="<?php echo $this->lang->line('higher_ordination_date'); ?>"type="text" autocomplete="off">
                                                <div class="help-block"><?php echo form_error('higher_ordination_date'); ?></div>
                                            </div>
                                        </div>
