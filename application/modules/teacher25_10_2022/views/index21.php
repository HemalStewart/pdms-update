                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-3 col-sm-3 col-xs-12">
                                        <div class="item form-group">
                                            ...
                                            <select  class="form-control col-md-7 col-xs-12" name="responsibility" id="responsibility">
                                                <option value="">--<?php echo $this->lang->line('select'); ?>--</option>                                                                                    
                                                <option value="Sinhala" <?php
                                                if (isset($post['responsibility']) && $post['responsibility'] == 'Sinhala') {
                                                    echo 'selected="selected"';
                                                }
                                                ?>><?php echo $this->lang->line('Sinhala'); ?></option>                                           
                                                <option value="Pali" <?php
                                                if (isset($post['responsibility']) && $post['responsibility'] == 'Pali') {
                                                    echo 'selected="selected"';
                                                }
                                                ?>><?php echo $this->lang->line('Pali'); ?></option>
                                                <option value="Sanskrit" <?php
                                                if (isset($post['responsibility']) && $post['responsibility'] == 'Sanskrit') {
                                                    echo 'selected="selected"';
                                                }
                                                ?>><?php echo $this->lang->line('Sanskrit'); ?></option>  
                                            </select>
                                        ...
                                        <div class="item form-group">
                                            ...
                                            <!--<div class="help-block"><?php echo form_error('religion'); ?></div>-->
                                             ...
                                             <select  class="form-control col-md-7 col-xs-12"  name="religion"  id="religion" >
                                                ...
                                                if (isset($post['religion']) && $post['religion'] == 'Buddhist') {
                                                    echo 'selected="selected"';
                                                }
                                                ?>>Buddhist</option>                                           
                                                <option value="Catholic" <?php
                                                if (isset($post['religion']) && $post['religion'] == 'Catholic') {
                                                    echo 'selected="selected"';
                                                }
                                                ?>>Catholic</option>
                                                 <option value="Islam" <?php
                                                if (isset($post['religion']) && $post['religion'] == 'Islam') {
                                                    echo 'selected="selected"';
                                                }
                                                ?>>Islam</option>
                                            </select>
                                    ...
                                    <div class="col-md-3 col-sm-3 col-xs-12">
                                        <div class="item form-group">
                                           ...
                                           <!--   <select  class="form-control col-md-7 col-xs-12"  name="teacher_type"  id="teacher_type" >
                                                <option value="">--<?php echo $this->lang->line('select'); ?>--</option>                                                                                    
                                                <option value="Monk" <?php
                                                if (isset($post['teacher_type']) && $post['teacher_type'] == 'Monk') {
                                                    echo 'selected="selected"';
                                                }
                                                ?>>Monk</option>                                           
                                                <option value="Catholic" <?php
                                                if (isset($post['teacher_type']) && $post['teacher_type'] == 'Lay') {
                                                    echo 'selected="selected"';
                                                }
                                                ?>>Lay</option>
                                        ...
                                        <div class="item form-group">
                                            ...
                                            <!--<input  class="form-control col-md-7 col-xs-12"  name="ordination_chapter"  id="ordination_chapter" value="<?php echo isset($post['ordination_chapter']) ? $post['ordination_chapter'] : ''; ?>" placeholder="<?php echo $this->lang->line('ordination_chapter'); ?>"  type="text" autocomplete="off">-->
                                             ...
                                             <select  class="form-control col-md-7 col-xs-12"  name="ordination_chapter"  id="ordination_chapter" >
                                                <option value="">--<?php echo $this->lang->line('select'); ?>--</option>                                                                                    
                                                <option value="Siam Nikaya" <?php
                                                if (isset($post['ordination_chapter']) && $post['ordination_chapter'] == 'Siam Nikaya') {
                                                    echo 'selected="selected"';
                                                }
                                                ?>>Siam Nikaya</option>                                           
                                                <option value="Amarapura Nikaya " <?php
                                                if (isset($post['ordination_chapter']) && $post['ordination_chapter'] == 'Amarapura Nikaya ') {
                                                    echo 'selected="selected"';
                                                }
                                                ?>>Amarapura Nikaya </option>
                                                 <option value="Ramanna Nikaya" <?php
                                                if (isset($post['ordination_chapter']) && $post['ordination_chapter'] == 'Ramanna Nikaya') {
                                                    echo 'selected="selected"';
                                                }
                                                ?>>Ramanna Nikaya</option>
                                            </select>
                                        ...
                                        <div class="col-md-3 col-sm-3 col-xs-12">
                                            <div class="item form-group">
                                                ...
                                                <select  class="form-control col-md-7 col-xs-12" name="religion" id="edit_religion">
                                                    <option value="">--<?php echo $this->lang->line('select'); ?>--</option>                                                                                    
                                                    <option value="Buddhist" <?php
                                                    if ($teacher->pension_age == buddhist) {
                                                        echo 'selected="selected"';
                                                    }
                                                    ?>>Buddhist</option>                                           
                                                    <option value="Catholic" <?php
                                                    if ($teacher->pension_age == catholic) {
                                                        echo 'selected="selected"';
                                                    }
                                                    ?>>Catholic</option>
                                                     <option value="Islam" <?php
                                                    if ($teacher->pension_age == islam) {
                                                        echo 'selected="selected"';
                                                    }
                                                    ?>>Islam</option> 
                                                </select>
