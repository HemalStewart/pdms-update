...
<!---************************************************-->
 <li class="li-class-list">
                              ...
                              <?php echo form_open(site_url('event/index/'), array('name' => 'filter', 'id' => 'filter', 'class' => 'form-horizontal form-label-left'), ''); ?>
                        ...
                        <div  class="tab-pane fade in <?php if(isset($add)){ echo 'active'; }?>" id="tab_add_event">
                            <div class="x_content"> 
                               <?php echo form_open_multipart(site_url('event/add'), array('name' => 'add', 'id' => 'add', 'class'=>'form-horizontal form-label-left'), ''); ?>
                                ...
                                <div class="item form-group">
                                    <label class="control-label col-md-3 col-sm-3 col-xs-12" for="event_from"><?php echo $this->lang->line('from_date'); ?> 
                                    </label>
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        <input  class="form-control col-md-7 col-xs-12"  name="event_from"  id="add_event_from" value="<?php echo isset($post['event_from']) ?  $post['event_from'] : ''; ?>" placeholder="<?php echo $this->lang->line('from_date'); ?>"type="text" autocomplete="off">
                                        <div class="help-block"><?php echo form_error('event_from'); ?></div>
                                    </div>
                                </div>
                                
                                <div class="item form-group">
                                    <label class="control-label col-md-3 col-sm-3 col-xs-12" for="event_to"><?php echo $this->lang->line('to_date'); ?>
                                    </label>
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        <input  class="form-control col-md-7 col-xs-12"  name="event_to"  id="add_event_to" value="<?php echo isset($post['event_to']) ?  $post['event_to'] : ''; ?>" placeholder="<?php echo $this->lang->line('to_date'); ?>" type="text" autocomplete="off">
