...
//        check_permission(VIEW);
        ...
        if ($_POST) {
            ...
            $piriventype_id = $this->input->post('piriventype_id');
            $subclass_id = $this->input->post('subclass_id');
           
        }

        //  $this->data['class_id'] = $class_id;
        $this->data['filter_piriventype_id'] = $piriventype_id;
        $this->data['filter_subclass_id'] = $subclass_id;



        $this->data['subjects'] = $this->subject->get_subject_definelist($piriventype_id, $subclass_id);
...
//        }
        ...
        $this->data['list'] = TRUE;
        $this->data['schools'] = $this->schools;
         $this->data['privtype'] = $this->privtype;
...
//            $school_id = $this->input->post('school_id');
            $classn_id = $this->input->post('class_nid');
        }

          $pirtype = $this->session->userdata('pirtype');
//        $listclass = $this->subject->getclassData($pirtype);
         $this->data['classdata'] = $this->subject->getclassData($pirtype);
        ...
        $this->data['class_id'] = $class_id;
        $this->data['filter_class_nid'] = $classn_id;
       // $this->data['filter_school_id'] = $school_id;
       // $this->data['subjects'] = $this->subject->get_subject_list($classn_id, $school_id);
        
         $this->data['subjects'] = $this->subject->get_subject_list($province_id, $district_id, $zonal_id, $edu_id, $schooln_id,$classn_id);

              if ($this->session->userdata('role_id') == PROVINCIAL) {
            $province_id = $this->session->userdata('provincial_id');
            $this->data['district'] = $this->subject->getdistrictData($province_id);
        }

        if ($this->session->userdata('role_id') == ZONAL) {
            $zonal_id = $this->session->userdata('zonal_id');
            $this->data['education'] = $this->subject->getzonalData($zonal_id);
        }
        ...
        if ($this->session->userdata('role_id') != SUPER_ADMIN) {
         ...
         $pirtype = $this->session->userdata('pirtype');
        $listclass = $this->subject->listclasstype($pirtype);
...
//        $items[] = 'author';
      ...
      //  $items[] = 'name';
        ...
        $data['name'] = $this->input->post('Sublist_id');
        $data['sub_defineid'] = $this->input->post('name');
        $data['Submainid'] = $this->input->post('Submainid');
