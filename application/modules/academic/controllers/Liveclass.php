    ...
    public function index($class_id = null ) {
        ...
        if ($this->session->userdata('role_id') != SUPER_ADMIN) {
         ...
         if ($this->session->userdata('role_id') == PROVINCIAL) {
            ...
            $this->data['district'] = $this->liveclass->getdistrictData($province_id);
        }

        if ($this->session->userdata('role_id') == ZONAL) {
            $zonal_id = $this->session->userdata('zonal_id');
            $this->data['education'] = $this->liveclass->getzonalData($zonal_id);
        }
        ...
        $listclass = $this->liveclass->getclassData($pirtype);
