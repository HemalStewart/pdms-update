    ...
    public function index($class_id = null) {
        ...
        check_permission(VIEW);
         ...
         if ($this->session->userdata('role_id') == PROVINCIAL) {
            ...
            $this->data['district'] = $this->material->getdistrictData($province_id);
        }

        if ($this->session->userdata('role_id') == ZONAL) {
            $zonal_id = $this->session->userdata('zonal_id');
            $this->data['education'] = $this->material->getzonalData($zonal_id);
        }
        ...
        $listclass = $this->material->getclassData($pirtype);
