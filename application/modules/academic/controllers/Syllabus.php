...
class Syllabus extends MY_Controller {
    ...
    function __construct() {
        ...
        $this->load->model('Ajax_Model', 'ajax', true);  
         ...
         $this->data['listprovincial'] = $listprovincial;
          ...
          $listpirtype = $this->syllabus->listpirtype();
        $this->data['listpirtype'] = $listpirtype;
         
           $subject_id = $this->session->userdata('subject_id');
        $this->data['sublist'] = $this->syllabus->getsubjectData($subject_id);
    }
    ...
    public function index($class_id = null) {
        ...
        if ($_POST) {
         ...
         $this->data['filter_piriven_id'] = $piriven_id;
        $this->data['filter_fclass_id'] = $fclass_id;        
        
     //   $this->data['class_id'] = $class_id;
      //  $this->data['filter_class_id'] = $class_id;
//        $this->data['filter_school_id'] = $school_id;
        $this->data['syllabuses'] = $this->syllabus->get_syllabus_list($piriven_id, $fclass_id);            
