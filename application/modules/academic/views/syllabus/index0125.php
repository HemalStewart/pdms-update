...
<!--                                    <select  class="form-control col-md-7 col-xs-12" style="width:auto;" name="school_id"  onchange="get_class_by_school(this.value, '');">
                                 ...
                                 <select  class="form-control col-md-7 col-xs-12" style="width:auto;" id="filter_piriven_id" name="piriven_id"  onchange="get_class_by_piriven(this.value, '');this.form.submit();">
                                            <option value="">--<?php echo $this->lang->line('select_school'); ?>--</option> 
                                        <?php foreach($privtype as $obj ){ ?>
                                            <option value="<?php echo $obj->School_TypeId; ?>" <?php if(isset($filter_piriven_id) && $filter_piriven_id == $obj->School_TypeId){ echo 'selected="selected"';} ?> > <?php echo $obj->School_Type; ?></option>
                                        <?php } ?>   
                                    </select>
                                    <select  class="form-control col-md-7 col-xs-12" id="filter_fclass_id" name="fclass_id"  style="width:auto;" onchange="this.form.submit();">
                                ...
                                <tbody>   
                                    <?php $count = 1; if(isset($syllabuses) && !empty($syllabuses)){ ?>
                                        ...
                                        <tr>
                                            ...
                                            <?php } ?>
                                            <td><?php echo $obj->School_Type; ?></td>
                                        ...
                                        <select  class="form-control col-md-7 col-xs-12 data_subject"  name="subject_id"  id="add_subject_id" required="required" >
                                            <option value="">--<?php echo $this->lang->line('select'); ?>--</option>      
                                             ...
                                             <?php foreach ($sublist as $key => $value) {
                                                ?>
                                                <option value="<?php echo $value["id"] ?>" <?php echo set_select('subject_id', $value['id'], set_value('subject_id')); ?>><?php echo $value["sub_name"] ?></option>
                                            <?php }
                                            ?> 
                                        </select>
                                        ...
                                        <select  class="form-control col-md-7 col-xs-12 data_subject"  name="subject_id"  id="edit_subject_id" required="required" >
                                            <option value="">--<?php echo $this->lang->line('select'); ?>--</option>       
                                              ...
                                              <?php foreach ($sublist as $key => $value) { ?>
                                                    ...
                                                    if (isset($syllabus) && $syllabus->subject_id == $value["id"]) {
                                                        echo 'selected="selected"';
                                                    }
                                        ...
                                        <div class="col-md-6 col-sm-6 col-xs-12">
                                            <select  class="form-control col-md-7 col-xs-12"  name="pirtype" id="edit_pirtype" onchange="get_pirtype(this.value, '');"> 
                                                ...
                                                <?php foreach ($listpirtype as $key => $value) {
                                                    ...
                                                    <option value="<?php echo $value["School_TypeId"] ?>" <?php
                                                    if (isset($syllabus) && $syllabus->pirtype == $value["School_TypeId"]) {
                                                        echo 'selected="selected"';
                                                    }
                                                    ?>><?php echo ucfirst($value["School_Type"]); ?></option>
                                                        <?php } ?>  
...
<?php if (isset($filter_fclass_id)) { ?>
        get_class_by_piriven('<?php echo $filter_piriven_id; ?>', '<?php echo $filter_fclass_id; ?>');
<?php } ?>

    function get_class_by_piriven(piriven_id, fclass_id) {

        $.ajax({
            type: "POST",
            url: "<?php echo site_url('ajax/get_class_by_piriven'); ?>",
            data: {piriven_id: piriven_id, fclass_id: fclass_id},
            async: false,
            success: function (response) {
                if (response)
                {
                    $('#filter_fclass_id').html(response);
                }
            }
        });
    }
