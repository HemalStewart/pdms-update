                            ...
                            <?php } else { ?> 
                                <select  class="form-control col-md-7 col-xs-12" onchange="get_subject_by_class(this.value);">
                                    <?php if ($this->session->userdata('role_id') != STUDENT) { ?>
                                        <option value="<?php echo site_url('academic/subject/indexassign'); ?>">--<?php echo $this->lang->line('select'); ?>--</option> 
                                    <?php } ?> 
                                    ...
                                    <?php foreach ($classes as $obj) { ?>
                                        <?php if ($this->session->userdata('role_id') == STUDENT) { ?>
                                            ...
                                            ?>
                                            <option value="<?php echo site_url('academic/subject/indexassign/' . $obj->id); ?>" <?php
                                            if (isset($class_id) && $class_id == $obj->id) {
                                                echo 'selected="selected"';
                                            }
                                            ?> ><?php echo $obj->name; ?></option>
                                                <?php } elseif ($this->session->userdata('role_id') == GUARDIAN) { ?>
                                                    <?php
                                                    if (!in_array($obj->id, $guardian_class_data)) {
                                                        continue;
                                                    }
                                                    ?>
                                            <option value="<?php echo site_url('academic/subject/indexassign/' . $obj->id); ?>" <?php
                        ...
                        ?>" id="tab_add_subject">
                            <div class="x_content"> 
                                ...
                                <div class="item form-group">
                                    <label class="control-label col-md-3 col-sm-3 col-xs-12" for="privname"><?php echo $this->lang->line('class'); ?> <?php echo $this->lang->line('name'); ?> <span class="required">*</span></label>
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        <select  class="form-control col-md-7 col-xs-12"  name="privname" id="privname" required="required">
                                            <option value="">--<?php echo $this->lang->line('select'); ?>--</option>
                                            <?php foreach ($listclass as $key => $value) {
                                                ?>
                                                <option value="<?php echo $value["id"] ?>" <?php echo set_select('pirtype', $value['name'], set_value('name')); ?>><?php echo $value["Subject_Name"] ?></option>
                                            <?php }
                                            ?> 
                                        </select>
                                        <div class="help-block"><?php echo form_error('privname'); ?></div> 
                                    </div>
                                </div>
                                ...
                                <div class="item form-group">
                                    ...
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        <input  class="form-control col-md-7 col-xs-12"  name="code"  id="code" readonly="" value="<?php echo isset($post['code']) ? $post['code'] : ''; ?>" placeholder="<?php echo $this->lang->line('subject_code'); ?>"  type="text" autocomplete="off">
                            ...
                            <div class="tab-pane fade in active" id="tab_edit_subject">
                                <div class="x_content"> 
                                    ...
                                    <div class="item form-group">
                                        ...
                                        <div class="col-md-6 col-sm-6 col-xs-12">
                                            <select  class="form-control col-md-7 col-xs-12"  name="edit_name"  id="edit_name" required="required" >
                                                <option value="">--<?php echo $this->lang->line('select'); ?>--</option> 
                                                <?php foreach ($listclass as $key => $value) {
                                                    ?>
                                                    <option value="<?php echo $value["id"] ?>" <?php
                                                    if (isset($subject) && $subject->pirevn_id == $value["id"]) {
                                                        echo 'selected="selected"';
                                                    }
                                                    ?>><?php echo ucfirst($value["Subject_Name"]); ?></option>
                                                        <?php } ?>                                           
                                            </select>
                                            <div class="help-block"><?php echo form_error('name'); ?></div>
                                        </div>
                                    ...
                                    <div class="item form-group">
                                        <label class="control-label col-md-3 col-sm-3 col-xs-12" for="code"><?php echo $this->lang->line('subject_code'); ?></label>
                                        <div class="col-md-6 col-sm-6 col-xs-12">
                                            <input  class="form-control col-md-7 col-xs-12"  name="edit_code"  id="edit_code" readonly=""value="<?php echo isset($subject->code) ? $subject->code : ''; ?>" placeholder="<?php echo $this->lang->line('subject'); ?> <?php echo $this->lang->line('code'); ?>" type="text" autocomplete="off">
                                            <div class="help-block"><?php echo form_error('code'); ?></div>
                                    ...
                                    <div class="item form-group">
                                        <label class="control-label col-md-3 col-sm-3 col-xs-12" for="type"><?php echo $this->lang->line('type'); ?> </label>
                                        <div class="col-md-6 col-sm-6 col-xs-12">
                                            <select  class="form-control col-md-7 col-xs-12" name="edit_type" id="edit_type" >
                                                <option value="">--<?php echo $this->lang->line('select'); ?>--</option>
                                                <?php $types = get_subject_type(); ?>
                                                <?php foreach ($types as $key => $value) { ?>
                                    ...
                                    <div class="item form-group">
                                        ...
                                        <div class="col-md-6 col-sm-6 col-xs-12">
                                            <select  class="form-control col-md-7 col-xs-12"  name="edit_class_id"  id="edit_class_id" required="required" >
                                                <option value="">--<?php echo $this->lang->line('select'); ?>--</option> 
                                                <?php foreach ($classes as $obj) { ?>
                                                    <option value="<?php echo $obj->id; ?>" <?php
                                    ...
                                    <div class="item form-group">
                                        ...
                                        <div class="col-md-6 col-sm-6 col-xs-12">
                                            <select  class="form-control col-md-7 col-xs-12"  name="edit_teacher_id"  id="edit_teacher_id" required="required" >
                                                <option value="">--<?php echo $this->lang->line('select'); ?>--</option> 
                                                <?php foreach ($teachers as $obj) { ?>
                                                    <option value="<?php echo $obj->id; ?>" <?php
...
<script type="text/javascript">
    ...
    var tot_count = 0;
    var pirtype = $('#privname').val();
    $(document).ready(function () {


        $(document).on('change', '#privname', function (e) {
            $('#code').html("");
            ...
            $.ajax({
                type: "POST",
                url: "<?php echo site_url('ajax/getfetchsubjectdefine'); ?>",
                data: {'pirtype_id': pirtype_id},
                dataType: "json",
                success: function (data) {
                    $('input[name=code]').val(data.Subject_Code);
                    $('input[name=name]').val(data.Subject_Name);
                }
            });
        });
        ...
        $(document).on('change', '#edit_name', function (e) {
            $('#edit_code').html("");
            var pirtype_id = $(this).val();
            ...
            $.ajax({
                ...
                dataType: "json",
                success: function (data) {
//                    alert(data.Subject_Code);
                    $('input[name=edit_code]').val(data.Subject_Code);
                    $('input[name=edit_name]').val(data.Subject_Name);
                }
            });
        });
