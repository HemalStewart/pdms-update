                                        ...
                                        if (isset($classes) && !empty($classes)) {
                                            ...
                                            <?php foreach ($classes as $obj) { ?>
                                                ...
                                                <tr>
                                                    ...
                                                    <td><?php echo $obj->schoolclass; ?></td>
                        ...
                        ?>" id="tab_add_class">
                            <div class="x_content"> 
                                ...
                                <div class="item form-group">
                                    ...
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        <select  class="form-control col-md-7 col-xs-12"  name="name" id="add_name" required="required">
                                            <option value="">--<?php echo $this->lang->line('select'); ?>--</option>
                                            <?php foreach ($listclass as $key => $value) {
                                                ?>
                                                <option value="<?php echo $value["School_className"] ?>" <?php echo set_select('pirtype', $value['name'], set_value('name')); ?>><?php echo $value["School_className"] ?></option>
                                            <?php }
                                            ?> 
                                        </select>
                                        <div class="help-block"><?php echo form_error('name'); ?></div> 
...
<!--                                    <div class="item form-group">
                                    ...
                                    <div class="item form-group">
                                        ...
                                        <div class="col-md-6 col-sm-6 col-xs-12">
                                            <select  class="form-control col-md-7 col-xs-12"  name="name"  id="edit_name" required="required" >
                                                <option value="">--<?php echo $this->lang->line('select'); ?>--</option> 
                                                <?php foreach ($listclass as $key => $value) {
                                                    ?>
                                                    <option value="<?php echo $value["School_className"] ?>" <?php
                                                    if (isset($class) && $class->name == $value["School_className"]) {
                                                        echo 'selected="selected"';
                                                    }
