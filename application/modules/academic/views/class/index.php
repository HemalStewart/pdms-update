            ...
            <div class="x_content">
                <div class="" data-example-id="togglable-tabs">
                    ...
                    <ul  class="nav nav-tabs bordered">
                        ...
                        ?>"><a href="#tab_class_list"   role="tab" data-toggle="tab" aria-expanded="true"><i class="fa fa-list-ol"></i> <?php echo $this->lang->line('list'); ?></a> </li>
                            <?php if (has_permission(ADD, 'academic', 'classes')) { ?>
                                ...
                                ?>"><a href="<?php echo site_url('academic/classes/add'); ?>"  aria-expanded="false"><i class="fa fa-plus-square-o"></i> <?php echo $this->lang->line('add'); ?></a> </li>                          
                                 <?php } else { ?>
                                <li  class="<?php
                                if (isset($add)) {
                                    echo 'active';
                                }
                                ?>"><a href="#tab_add_class"  role="tab"  data-toggle="tab" aria-expanded="false"><i class="fa fa-plus-square-o"></i> <?php echo $this->lang->line('add'); ?></a> </li>                          
                                 <?php } ?>
                        ...
                        <li class="li-class-list">
                            ...
                            <?php if ($this->session->userdata('role_id') == ADMIN) { ?>
                                ...
                                ?>    
                                <?php echo form_open(site_url('academic/classes/index/'), array('name' => 'filter', 'id' => 'filter', 'class' => 'form-horizontal form-label-left'), ''); ?>
                    ...
                    <div class="tab-content">
                                        ...
                                        if (isset($classes) && !empty($classes)) {
                                            ...
                                            <?php foreach ($classes as $obj) { ?>
                                                ...
                                                if ($this->session->userdata('role_id') == GUARDIAN) {
                                                    if (!in_array($obj->id, $guardian_data)) {
                                                        continue;
                                                    }
                                                } elseif ($this->session->userdata('role_id') == STUDENT) {
                        ...
                        ?>" id="tab_add_class">
                            <div class="x_content"> 
                                ...
                                <div class="item form-group">
                                    <label class="control-label col-md-3 col-sm-3 col-xs-12" for="name"><?php echo $this->lang->line('class'); ?> <?php echo $this->lang->line('name'); ?> <span class="required">*</span></label>
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        <select  class="form-control col-md-7 col-xs-12"  name="school_classesid" id="add_school_classesid" required="required" onchange="get_classname(this.value, '');">
                                            <option value="">--<?php echo $this->lang->line('select'); ?>--</option>
                                            <?php foreach ($listclass as $key => $value) {
                                                ?>
                                                <option value="<?php echo $value["School_classesid"] ?>" <?php echo set_select('pirtype', $value['School_className'], set_value('school_classesid')); ?>><?php echo $value["School_className"] ?></option>
                                            <?php }
                                            ?> 
                                        </select>
                                        <input  class="form-control col-md-7 col-xs-12"  name="name"  id="add_name" value="<?php echo isset($post['name']) ? $post['name'] : ''; ?>"  required="required" type="hidden" autocomplete="off">
                                        <input  class="form-control col-md-7 col-xs-12"  name="short_code"  id="add_short_code" value="<?php echo isset($post['short_code']) ? $post['short_code'] : ''; ?>"  required="required" type="hidden" autocomplete="off">
                              ...
                              <!--  <div class="item form-group">
                                ...
                                <div class="item form-group">
                                    <label class="control-label col-md-3 col-sm-3 col-xs-12" for="teacher_id"><?php echo $this->lang->line('sec_head'); ?> <span class="required">*</span>
                                    </label>
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                            ...
                            <div class="tab-pane fade in active" id="tab_edit_class">
                                <div class="x_content"> 
                                    ...
                                    <div class="item form-group">
                                        ...
                                        <div class="col-md-6 col-sm-6 col-xs-12">
                                            <select  class="form-control col-md-7 col-xs-12"  name="school_classesid"  id="edit_school_classesid" required="required" onchange="get_classname(this.value, '');">
                                                <option value="">--<?php echo $this->lang->line('select'); ?>--</option> 
                                                <?php foreach ($listclass as $key => $value) {
                                                    ?>
                                                    <option value="<?php echo $value["School_classesid"] ?>" <?php
                                                    if (isset($class) && $class->school_classesid == $value["School_classesid"]) {
                                                        echo 'selected="selected"';
                                                    }
                                            ...
                                            <input  class="form-control col-md-7 col-xs-12"  name="name"  id="edit_name"   required="required" type="hidden" autocomplete="off" value="<?php echo isset($class->name) ? $class->name : ''; ?>">
                                            <input  class="form-control col-md-7 col-xs-12"  name="short_code"  id="edit_short_code"   required="required" type="hidden" autocomplete="off" value="<?php echo isset($class->short_code) ? $class->short_code : ''; ?>">
                                            <div class="help-block"><?php echo form_error('name'); ?></div>
                                        </div>
                                    </div>
