                                            ...
                                            foreach ($teacherapplicationformval as $obj) {
                                                $CurStatusID = $obj->cur_status;
                                                 ...
                                                 if ($CurStatusID == 1) {
                                                    ...
                                                    $Status1 = "Forwarded to Zonal";
                                                    $color = "bg-yellow";
												} elseif ($CurStatusID == 4) {
                                                    $Status1 = "Forwarded to Provincial";
                                                    $color = "bg-green";
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <?php if (has_permission(EDIT, 'forms', 'teacherformappministry') && $obj->cur_status == 5) { ?>
                                                        ...
                                                        <?php if (has_permission(EDIT, 'forms', 'teacherformappministry') && $obj->cur_status == 5) { ?>
                                                            <a href="<?php echo site_url('formsministry/Formsapply/confirm/' . $obj->id); ?>" class="btn btn-warning btn-xs"><i class="fa fa-check-square-o"></i> <?php echo $this->lang->line('approve'); ?> </a>
                                                        <?php } ?>
