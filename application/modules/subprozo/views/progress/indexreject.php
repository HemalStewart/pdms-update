...
<!--                                            <div class="help-block">
                                    ...
                                    <div class="form-group">
                                        <div class="col-md-6 col-md-offset-3">
                                            ...
                                            <a  href="<?php echo site_url('subprozo/progress/index'); ?>"  class="btn btn-primary"><?php echo $this->lang->line('cancel'); ?></a>
...
<script type="text/javascript">
    function add_more(fn_stop_container) {
        ...
        $.ajax({
            url: "<?php echo site_url('subprozo/progress/getTableProductRow'); ?>",
