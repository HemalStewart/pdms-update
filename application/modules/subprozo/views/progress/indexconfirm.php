                    ...
                    <div class="tab-content">
                        ...
                        <?php if (isset($edit)) { ?>
                            <div class="tab-pane fade in active" id="tab_edit_route">
                                <div class="x_content"> 
                                    <?php echo form_open(site_url('subprozo/progress/confirm/' . $route->id), array('name' => 'edit', 'id' => 'edit', 'class' => 'form-horizontal form-label-left'), ''); ?>
        ...
        <!--                                                            <td>
                                    ...
                                    <div class="form-group">
                                        <div class="col-md-6 col-md-offset-3">
                                            ...
                                            <a  href="<?php echo site_url('depprozo/progress/index'); ?>"  class="btn btn-primary"><?php echo $this->lang->line('cancel'); ?></a>
