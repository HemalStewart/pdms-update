                ...
                <div class="" data-example-id="togglable-tabs">
                    ...
                    <!--                                <select  class="form-control col-md-7 col-xs-12" id="filter_school_id" onchange="get_teacher_by_school(this.value);">
                                ...
                                <?php foreach ($schools as $obj) { ?>
                                                                                <option value="<?php echo site_url('teacher/index/' . $obj->id); ?>" <?php
                                ...
                                <!--
                                                                <select  class="form-control col-md-7 col-xs-12" style="width:auto;" name="provincial" id="add_provincial">
                                ...
                                ?>   
                                                                ...
                                                                <select  class="form-control col-md-7 col-xs-12" id="add_district_id" name="district_id"  style="width:auto;" >
                                                                    <option value="select"><?php echo $this->lang->line('select_district') ?></option>
                                                                </select>
                                
                                                                <select  class="form-control col-md-7 col-xs-12" id="add_zonal_id" name="zonal_id"  style="width:auto;" >
                                                                    <option value="select"><?php echo $this->lang->line('select_zonal') ?></option>
                                                                </select>
                                
                                                                <select  class="form-control col-md-7 col-xs-12" id="add_educational_id" name="educational_id"  style="width:auto;" >
                                                                    <option value="select"><?php echo $this->lang->line('select_edu') ?></option>
                                                                </select>
                                
                                                                <select  class="form-control col-md-7 col-xs-12" id="add_school_id" name="school_id"  style="width:auto;" onchange="get_teacher_by_school(this.value);">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-3 col-sm-3 col-xs-12">
                                        <div class="item form-group">
                                            ...
                                            <input  class="form-control col-md-7 col-xs-12"  name="pension_date"  id="add_pension_date" value="<?php echo isset($post['pension_date']) ? $post['pension_date'] : ''; ?>" placeholder="<?php echo $this->lang->line('pension_date'); ?>"  type="text" autocomplete="off">
                                    ...
                                    <div class="col-md-3 col-sm-3 col-xs-12">
                                        <div class="item form-group">
                                            ...
                                            <select  class="form-control col-md-7 col-xs-12" name="salary_type" id="salary_type" required="required">
                                                ...
                                                if (isset($post['salary_type']) && $post['salary_type'] == 'monthly') {
                                                    echo 'selected="selected"';
                                                }
                                                ?>><?php echo $this->lang->line('monthly'); ?></option>                                           
                                                <option value="hourly" <?php
                                                if (isset($post['salary_type']) && $post['salary_type'] == 'hourly') {
                                                    echo 'selected="selected"';
                                                }
                                ...
                                <div class="x_content"> 
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-3 col-sm-3 col-xs-12">
                                            <div class="item form-group">
                                                <label for="ordination_date"><?php echo $this->lang->line('ordination_date'); ?></label>
                                                <input  class="form-control col-md-7 col-xs-12"  name="ordination_date"  id="edit_ordination_date" value="<?php echo isset($teacher->ordination_date) ? date('d-m-Y', strtotime($teacher->ordination_date)) : ''; ?>" placeholder="<?php echo $this->lang->line('ordination_date'); ?>" type="text" autocomplete="off">
                                                <div class="help-block"><?php echo form_error('ordination_date'); ?></div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-md-3 col-sm-3 col-xs-12">
                                            <div class="item form-group">
                                                <label for="higher_ordination_date"><?php echo $this->lang->line('higher_ordination_date'); ?></label>
                                                <input  class="form-control col-md-7 col-xs-12"  name="higher_ordination_date"  id="edit_higher_ordination_date" value="<?php echo isset($teacher->higher_ordination_date) ? date('d-m-Y', strtotime($teacher->higher_ordination_date)) : ''; ?>" placeholder="<?php echo $this->lang->line('higher_ordination_date'); ?>"type="text" autocomplete="off">
                                                <div class="help-block"><?php echo form_error('higher_ordination_date'); ?></div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-md-3 col-sm-3 col-xs-12">
                                            <div class="item form-group">
                                                <label for="pension_date"><?php echo $this->lang->line('pension_date'); ?></lable>
                                                    <input  class="form-control col-md-7 col-xs-12"  name="pension_date"  id="edit_pension_date" value="<?php echo isset($teacher->pension_date) ? date('d-m-Y', strtotime($teacher->pension_date)) : ''; ?>" placeholder="<?php echo $this->lang->line('pension_date'); ?>" type="text" autocomplete="off">
                                                    <div class="help-block"><?php echo form_error('pension_date'); ?></div>
                                            </div>
                                        </div>
