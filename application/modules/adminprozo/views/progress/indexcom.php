                                                ...
                                                <table style="width:100%;" class="fn_edit_stop_container responsive"> 
                                                    ...
                                                    foreach ($route_stops as $obj) {
                                                        ...
                                                        <tr>               
                                                            ...
                                                            <td>
                                                                <input  class="form-control col-md-12 col-xs-12" style="width:auto;" type="text" name="reason[]" id="reason" value="<?php echo $obj->stop_km; ?>" placeholder="<?php echo $this->lang->line('reason'); ?>" />
                                                            </td>
                                                            <td>
                                                                <input  class="form-control col-md-12 col-xs-12" style="width:auto;" type='text' name="address[]" id="address" value="<?php echo $obj->address; ?>" placeholder="<?php echo $this->lang->line('address'); ?>"/>
                                                            </td>
                                                            <td>
