                    ...
                    <div class="tab-content">
                        ...
                        <?php if (isset($edit)) { ?>
                            <div class="tab-pane fade in active" id="tab_edit_route">
                                <div class="x_content"> 
                                    <?php echo form_open(site_url('adminprozo/progresssub/reject/' . $route->id), array('name' => 'edit', 'id' => 'edit', 'class' => 'form-horizontal form-label-left'), ''); ?>
                                                ...
                                                <table style="width:100%;" class="fn_edit_stop_container responsive"> 
                                                    ...
                                                    foreach ($route_stops as $obj) {
                                                        ...
                                                        <tr>               
															...
															<td>
                                                                        <select class="form-control col-md-12 col-xs-12"  id="edit_subject_<?php echo $couter; ?>" name="subject[]" style="width:200px;" required onchange="get_subject(<?php echo $obj->id; ?>);">
                                                                            <option value=""></option>
...
<!--                                            <div class="help-block">
                                    ...
                                    <div class="form-group">
                                        <div class="col-md-6 col-md-offset-3">
                                            ...
                                            <a  href="<?php echo site_url('adminprozo/progress/index'); ?>"  class="btn btn-primary"><?php echo $this->lang->line('cancel'); ?></a>
