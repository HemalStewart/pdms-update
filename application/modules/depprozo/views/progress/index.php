...
<div class="row">
    <div class="col-md-12 col-sm-12 col-xs-12">
        <div class="x_panel">
            <div class="x_title">
                <h3 class="head-title"><i class="fa fa-file-text-o"></i><small> <?php echo $this->lang->line('subprozoprogress'); ?></small></h3>
                ...
                <div class="" data-example-id="togglable-tabs">
                    ...
                    <ul  class="nav nav-tabs bordered">
                        ...
                        ?>"><a href="#tab_route_list"   role="tab" data-toggle="tab" aria-expanded="true"><i class="fa fa-list-ol"></i> <?php echo $this->lang->line('list'); ?></a> </li>
                            <?php if(date("d") < "5"){if (has_permission(ADD, 'prozo', 'depprogress')) { ?>
                                <?php if (isset($edit)) { ?>
                                <li  class="<?php
                                if (isset($add)) {
                                    echo 'active';
                                }
                                ?>"><a href="<?php echo site_url('depprozo/progress/add'); ?>"  aria-expanded="false"><i class="fa fa-plus-square-o"></i> <?php echo $this->lang->line('add'); ?></a> </li>                          
                                 <?php } else { ?>
                                <li  class="<?php
                                if (isset($add)) {
                                    echo 'active';
...
මාසික ප්‍රගතිය පිළිබඳ තොරතුරු ඇතුළත් කිරීමට ලබා දී තිබූ කාලය අවසන්.';;
                    ...
                    <div class="tab-content">
                                        ...
                                        if (isset($routes) && !empty($routes)) {
                                            ...
                                            foreach ($routes as $obj) {
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <?php if (has_permission(EDIT, 'prozo', 'depprogress') && $obj->confirmstatus != 2) { ?>
                                                            <a href="<?php echo site_url('depprozo/progress/edit/' . $obj->id); ?>" class="btn btn-info btn-xs"><i class="fa fa-pencil-square-o"></i> <?php echo $this->lang->line('edit'); ?> </a>
                                                        <?php } ?>
                                                        <?php if (has_permission(EDIT, 'prozo', 'depprogress') && $obj->confirmstatus != 2) { ?>
                                                             <a href="<?php echo site_url('depprozo/progress/confirm/' . $obj->id); ?>" class="btn btn-main btn-xs"><i class="fa fa-check-square-o"></i> <?php echo $this->lang->line('confirm'); ?> </a>
                                                        <?php } ?>
                                                        ...
                                                        <?php } ?>
                                                        <?php if (has_permission(DELETE, 'prozo', 'depprogress') && $obj->confirmstatus != 2) { ?>
                                                            <a href="<?php echo site_url('depprozo/progress/delete/' . $obj->id); ?>" onclick="javascript: return confirm('<?php echo $this->lang->line('confirm_alert'); ?>');" class="btn btn-danger btn-xs"><i class="fa fa-trash-o"></i> <?php echo $this->lang->line('delete'); ?> </a>
                                                        <?php } ?>
                                                    </td>
                                                </tr>
                                            <?php } ?>
                        ...
                        ?>" id="tab_add_route">
                            <div class="x_content"> 
                                <?php echo form_open(site_url('depprozo/progress/add'), array('name' => 'add', 'id' => 'add', 'class' => 'form-horizontal form-label-left'), ''); ?>
                                ...
                                <div class="item form-group">
                                    ...
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        ...
                                        <input  class="form-control col-md-12 col-xs-12" style="width:auto;" type='hidden' name="provincialidval" id="add_provincialidval" value="<?php echo $listprov->provincialid; ?>" />
                                ...
                                <div class="item form-group">
                                    <label class="control-label col-md-3 col-sm-3 col-xs-12" for="department_id"><?php echo $this->lang->line('department'); ?> <span class="required">*</span></label>

                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        <select  class="form-control col-md-7 col-xs-12"  name="department_id" id="department_id" required="required" onchange="get_subdep(this.value, '');">
                                            <option value="">--<?php echo $this->lang->line('select'); ?>--</option>
                                ...
                                <div class="item form-group">
                                    <label class="control-label col-md-3 col-sm-3 col-xs-12" for="subdepartment_id"><?php echo $this->lang->line('subdepartment'); ?> <span class="required">*</span></label>

                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        <select  class="form-control col-md-7 col-xs-12"  id="add_subdepartment_id" name="subdepartment_id" required="required" >
                                            <option value="">--<?php echo $this->lang->line('select'); ?>--</option>

                                        </select>
                                        <div class="help-block"><?php echo form_error('subdepartment'); ?></div> 
                                ...
                                <div class="form-group">
                                    <div class="col-md-6 col-md-offset-3">
                                        <a href="<?php echo site_url('depprozo/progress'); ?>" class="btn btn-primary"><?php echo $this->lang->line('cancel'); ?></a>
                        ...
                        <?php if (isset($edit)) { ?>
                            <div class="tab-pane fade in active" id="tab_edit_route">
                                <div class="x_content"> 
                                    <?php echo form_open(site_url('depprozo/progress/edit/' . $route->id), array('name' => 'edit', 'id' => 'edit', 'class' => 'form-horizontal form-label-left'), ''); ?>
                               ...
                               <div class="item form-group">
                                        <label class="control-label col-md-3 col-sm-3 col-xs-12" for="department_id"><?php echo $this->lang->line('department'); ?></label>
                                        <div class="col-md-6 col-sm-6 col-xs-12">
                                            <input  class="form-control col-md-7 col-xs-12"  name="hiddendepartment"  id="hiddenprovincial" value="<?php echo $route->department_id ?>"   type="hidden" autocomplete="off">

                                            <select  id="edit_department_id" name="department_id" placeholder="" type="text" class="form-control" onchange="get_subdep(this.value, '');">
                                                ...
                                                <?php foreach ($listdepartment as $key => $value) {
                                                    ...
                                                    <option value="<?php echo $value["id"] ?>" <?php
                                                    if (isset($route) && $route->department_id == $value["id"]) {
                                                        echo 'selected="selected"';
                                                    }
                                                    ?>><?php echo ucfirst($value["department"]); ?></option>
                                                        <?php } ?>    
                                            </select> 
                                       ...
                                       <div class="item form-group">
                                        <label class="control-label col-md-3 col-sm-3 col-xs-12" for="subdepartment_id"><?php echo $this->lang->line('subdepartment'); ?></label>
                                        <div class="col-md-6 col-sm-6 col-xs-12">
                                            <input  class="form-control col-md-7 col-xs-12"  name="hiddensub"  id="hiddensub" value="<?php echo $route->subdepartment_id ?>"   type="hidden" autocomplete="off">


                                            <select id="edit_subdepartment_id" name="subdepartment_id" placeholder="" type="text" class="form-control" >
                                                <option value="select"><?php echo $this->lang->line('select') ?></option>
...
//        $.ajax({
//            url: "<?php echo site_url('depprozo/progress/getTableProductRow'); ?>",
//
//            type: 'post',
//            dataType: 'json',
//            success: function (response) {
                ...
                $.ajax({
                    url: "<?php echo site_url('depprozo/progress/getTableProgrammeType'); ?>",
...
var role_id = '';
                                                            ...
                                                            $.ajax({
                                                                ...
                                                                type: 'ajax',
                                                                method: 'get',
                                                                url: "<?php echo site_url('prozo/progress/getprogressdate'); ?>",
    ...
    function remove(obj, stop_id) {
        ...
        if (stop_id)
        {
            if (confirm('<?php echo $this->lang->line('confirm_alert'); ?>')) {
                $.ajax({
                    type: "POST",
                    url: "<?php echo site_url('depprozo/progress/remove_event'); ?>",
...
<script type="text/javascript">
    ...
    function get_route_modal(route_id) {
        ...
        $.ajax({
            type: "POST",
            url: "<?php echo site_url('depprozo/progress/get_single_route'); ?>",
