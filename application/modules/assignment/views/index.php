                                ...
                                <select  class="form-control col-md-7 col-xs-12" onchange="get_assignment_by_class(this.value);">
                                    ...
                                    <?php foreach($listclass as $obj ){ ?>
                                        <?php if($this->session->userdata('role_id') == STUDENT){ ?>
                                            ...
                                            <option value="<?php echo site_url('assignment/index/'.$obj->School_classesid); ?>" <?php if(isset($class_id) && $class_id == $obj->School_classesid){ echo 'selected="selected"';} ?> ><?php echo $obj->School_className; ?></option>
                                        ...
                                        <select  class="form-control col-md-7 col-xs-12"  name="class_id"  id="edit_class_id" required="required" onchange="get_subject_by_class(this.value, ''); get_section_by_class(this.value, '');">
                                            ...
                                            <?php if(isset($listclass) && !empty($listclass)){ ?>
                                                <?php foreach($listclass as $obj ){ ?>
                                                    ...
                                                    ?>
                                                    <option value="<?php echo $obj->School_classesid; ?>" <?php if($assignment->class_id == $obj->School_classesid){ echo 'selected="selected"';} ?>><?php echo $obj->School_className; ?></option>
                                                <?php } ?>                                            
                                            <?php } ?>                                            
                                        </select>
                                        <div class="help-block"><?php echo form_error('class_id'); ?></div>
