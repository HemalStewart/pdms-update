                                ...
                                <select  class="form-control col-md-7 col-xs-12" onchange="get_submission_by_class(this.value);">
                                    ...
                                    <?php foreach($listclass as $obj ){ ?>
                                        <?php if($this->session->userdata('role_id') == STUDENT){ ?>
                                            ...
                                            <option value="<?php echo site_url('assignment/submission/index/'.$obj->School_classesid); ?>" <?php if(isset($class_id) && $class_id == $obj->School_classesid){ echo 'selected="selected"';} ?> ><?php echo $obj->School_className; ?></option>
                                        <?php }elseif($this->session->userdata('role_id') == GUARDIAN){ ?>
                                            <?php if (!in_array($obj->School_classesid, $guardian_access_data)) { continue; } ?>
                                            <option value="<?php echo site_url('assignment/submission/index/'.$obj->School_classesid); ?>" <?php if(isset($class_id) && $class_id == $obj->School_classesid){ echo 'selected="selected"';} ?> ><?php echo $obj->School_className; ?></option>
                                        <?php }elseif($this->session->userdata('role_id') == TEACHER){ ?>
                                            <?php if (!in_array($obj->School_classesid, $teacher_access_data)) { continue; } ?>
                                            <option value="<?php echo site_url('assignment/submission/index/'.$obj->School_classesid); ?>" <?php if(isset($class_id) && $class_id == $obj->School_classesid){ echo 'selected="selected"';} ?> ><?php echo $obj->School_className; ?></option>
                                        <?php }else{ ?>
                                            <option value="<?php echo site_url('assignment/submission/index/'.$obj->School_classesid); ?>" <?php if(isset($class_id) && $class_id == $obj->School_classesid){ echo 'selected="selected"';} ?> ><?php echo $obj->School_className; ?></option>
                                        <?php } ?>                                            
                                ...
                                <div class="item form-group">
                                    ...
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        <select  class="form-control col-md-7 col-xs-12"  name="class_id"  id="add_class_id" required="required" onchange="get_section_by_class(this.value, '');" >
                                            <option value="">--<?php echo $this->lang->line('select'); ?>--</option> 
                                            <?php if(isset($listclass) && !empty($listclass) && $this->session->userdata('role_id') != SUPER_ADMIN){ ?>
                                                <?php foreach($listclass as $obj ){ ?>
                                                   <?php
                                                     if($this->session->userdata('role_id') == STUDENT){
                                                         if ($obj->School_classesid != $this->session->userdata('class_id')){ continue; }
                                                     }else if($this->session->userdata('role_id') == TEACHER){
                                                       if (!in_array($obj->School_classesid, $teacher_access_data)) {continue; }
                                                     }else if($this->session->userdata('role_id') == GUARDIAN){
                                                        if (!in_array($obj->School_classesid, $guardian_access_data)) {continue; }
                                                     } 
                                                    ?>
                                        ...
                                        <select  class="form-control col-md-7 col-xs-12"  name="class_id"  id="edit_class_id" required="required" onchange=" get_section_by_class(this.value, '');">
                                            ...
                                            <?php if(isset($listclass) && !empty($listclass) && $this->session->userdata('role_id') != SUPER_ADMIN){ ?>
                                                <?php foreach($listclass as $obj ){ ?>
                                                    ...
                                                    ?>
                                                    <option value="<?php echo $obj->School_classesid; ?>" <?php if($submission->class_id == $obj->School_classesid){ echo 'selected="selected"';} ?>><?php echo $obj->School_className; ?></option>
                                                <?php } ?>                                            
                                            <?php } ?>                                            
                                        </select>
                                        <div class="help-block"><?php echo form_error('class_id'); ?></div>
