                                            ...
                                            foreach ($routes as $obj) {
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        ...
                                                        <?php } ?>
                                                        <?php if (has_permission(EDIT, 'prozo', 'prozoplan') && $obj->confirmstatus != 2) { ?>
                                                            <a href="<?php echo site_url('plan/progress/confirm/' . $obj->id); ?>" class="btn btn-main btn-xs"><i class="fa fa-check-square-o"></i> <?php echo $this->lang->line('confirm'); ?> </a>
                                                        <?php } ?>
                                                ...
                                                <table style="width:100%;" class="fn_add_stop_container responsive"> 
                                                    ...
                                                    <tr>               
                                                        ...
                                                        <td>
                                                         ...
                                                         <td>
                                                            <select class="form-control col-md-12 col-xs-12"  id="add_program_type_1" data-row-id="row_1" name="program_type[]" style="width:100%;" onchange="get_program_type(1);" required>
                                                                <option value=""></option>
                                                        ...
                                                        <td>
                                                            <select class="form-control col-md-12 col-xs-12"  id="add_program_1" data-row-id="row_1" name="program[]" style="width:100%;" required>
                                                                <option value=""></option>
    ...
    function remove(obj, stop_id) {
        ...
        if (stop_id)
        {
            if (confirm('<?php echo $this->lang->line('confirm_alert'); ?>')) {
                $.ajax({
                    type: "POST",
                    url: "<?php echo site_url('plan/progress/remove_event'); ?>",
