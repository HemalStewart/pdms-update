                 ...
                 <div class="col-sm-12">                 
                    <div class="certificate">
                        ...
                        <div class="certificate-top">
						 ...
						 <div class="row" style="padding-left: 25px;padding-top: 10px"> 
								...
								<li>
								    <?php echo $this->lang->line('text223'); ?> :- <?php echo "<span style='color:black; text-decoration: underline;text-decoration-style: dashed'>" .$forms1->yes_no."</span>";?><br>
                    ...
                    <?php } ?> 
								    ...
								    <li class="col-md-12">
										...
										.1 &nbsp;<?php echo $this->lang->line('text252'); ?> :- 
								        <?php echo "<span style='color:black; text-decoration: underline;text-decoration-style: dashed'>" .$forms2->piriven_teacher_name."</span>"; ?><br>
								
								        .2 &nbsp;<?php echo $this->lang->line('text253'); ?> :- 
								        <?php echo "<span style='color:black; text-decoration: underline;text-decoration-style: dashed'>" .$forms2->jobtitle_subject."</span>"; ?><br>
								
								        .3 &nbsp;<?php echo $this->lang->line('text254'); ?> :- 
								        <?php echo "<span style='color:black; text-decoration: underline;text-decoration-style: dashed'>" .$forms2->highedu_subjects."</span>"; ?><br>
								
								        .4 &nbsp;<?php echo $this->lang->line('text255'); ?> :- 
								        <?php echo "<span style='color:black; text-decoration: underline;text-decoration-style: dashed'>" .$forms2->teacher_rej_no."</span>"; ?><br>
								
								        .5 &nbsp;<?php echo $this->lang->line('text256'); ?> :- 
								        <?php echo "<span style='color:black; text-decoration: underline;text-decoration-style: dashed'>" .$forms2->datevi."</span>"; ?><br>
								
								        .6 &nbsp;<?php echo $this->lang->line('text257'); ?> :- 
								        <?php echo "<span style='color:black; text-decoration: underline;text-decoration-style: dashed'>" .$forms2->datatable-responsive."</span>"; ?><br>
