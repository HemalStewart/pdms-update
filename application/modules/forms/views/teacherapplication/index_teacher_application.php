                                        ...
                                        if (isset($teacherapplicationformval) && !empty($teacherapplicationformval)) {
                                            ...
                                            foreach ($teacherapplicationformval as $obj) {
                                                ...
                                                <tr>
                                                    ...
                                                    <!--<td><?php echo $obj->type_e; ?>&nbsp;<?php echo $obj->initial_name_e; ?></td>-->
                           ...
                           <?php echo form_open(site_url('forms/formsapply/teacherapplicationformadd'), array('name' => 'add', 'id' => 'add', 'class' => 'form-horizontal form-label-left', 'enctype' => 'multipart/form-data'), ''); ?>
                                ...
                                <div class="tab-content">
                                      ...
                                      <div class="tab-pane fade in active" id="tab_zero">
                                        ...
                                        <div class="row" style="font-size: 16px;">
                                            ...
                                            <div class="col-md-3 col-sm-2 col-xs-12" style="margin-left: 0px; margin-right: -40px;">
											 ...
											 <div class="col-md-2 col-sm-2 col-xs-12" style="margin-left: 0px; margin-right: 0px;">
                                                <div class="item form-group">
                                                    <select  class="form-control col-md-7 col-xs-12" name="type_e" id="type_e" required="required">
                                                       <option value="">--<?php echo $this->lang->line('select'); ?>--</option>
                                                        <?php $type_es = get_en_type(); ?>
                                                <?php foreach ($type_es as $key => $value) { ?>
                                                    <option value="<?php echo $key; ?>" <?php
                                                    if (isset($post['type_e']) && $post['type_e'] == $key) {
                                                        echo 'selected="selected"';
                                                    }
                                                    ?>><?php echo $value; ?></option>
                                                        <?php } ?>
									   ...
									   <div class="row" style="font-size: 16px;">
                                        ...
                                        <div class="row" style="font-size: 16px;">
                                           ...
                                           <div class="col-md-3 col-sm-2 col-xs-12">
                                                <div class="item form-group">
                                                    <input readonly class="form-control col-md-7 col-xs-12"  name="nationality"  id="nationality" value="<?php echo isset($post['nationality']) ? $post['nationality'] : 'Sri lankan'; ?>" placeholder="" type="text" autocomplete="off">
								 ...
								 <div class="form-group">
                                    <div class="col-md-12" style="color: red;font-size: 18px;font-weight: 700;text-align: center">
                                  ...
                                  <div class="tab-pane fade in " id="tab_first">
                                        ...
                                        <div class="row" style="font-size: 16px;">
                                            ...
                                            <div class="col-md-5 col-sm-2 col-xs-12" style="margin-left: 0px; margin-right: -45px;">
                                                <div class="item form-group">
                                                    <div>04.&nbsp;<?php echo $this->lang->line('text244'); ?></div>
                                                </div>
                                            </div>
                            ...
                            <?php echo form_open_multipart(site_url('forms/formsapply/teacherapplicationformedit/' . $forms->id), array('name' => 'edit', 'id' => 'edit', 'class' => 'form-horizontal form-label-left'), ''); ?>
                                    ...
                                    <br>
                                     ...
                                     <div class="tab-content">
                                        ...
                                        <div class="tab-pane fade in active" id="edit_tab_zero">
                                            ...
                                            <div class="col-md-3 col-sm-2 col-xs-12" style="margin-left: 0px; margin-right: -40px;">
                                                <div class="item form-group">
												  ...
												  <div class="col-md-2 col-sm-2 col-xs-12" style="margin-left: 0px; margin-right: 0px;">
                                                    <div class="item form-group">
                                                   	  <select  class="form-control col-md-7 col-xs-12" name="type_e" id="type_e">
                                                    <option value="">--<?php echo $this->lang->line('select'); ?>--</option> 
                                                    <?php $type_es = get_en_type(); ?>
                                                    <?php foreach ($type_es as $key => $value) { ?>
                                                        <option value="<?php echo $key; ?>" <?php
										...
										<div class="col-md-3 col-sm-3 col-xs-12">
                                            <div class="item form-group">
											    ...
											    value="<?php
												 ...
												 placeholder="<?php echo $this->lang->line('datei'); ?>" type="text" autocomplete="off">
                                                <div class="help-block"><?php echo form_error('datei'); ?></div>
                                            </div>
                                        </div>
										 ...
										 <div class="row" style="font-size: 16px;">
                                            ...
                                            <div class="col-md-5 col-sm-2 col-xs-12">
                                                <div class="item form-group">
													 <input readonly class="form-control col-md-7 col-xs-12"  name="nationality"  id="nationalitynationality" value="<?php echo isset($forms->nationality) ? $forms->nationality : ''; ?>" placeholder="" type="text" autocomplete="off">
                                                    <div class="help-block"><?php echo form_error('nationality'); ?></div>
                                                </div>
                                            </div>
                                       ...
                                       <div class="row" style="font-size: 16px;">
                                                    ...
                                                    <table id="datatable-responsive" class="table table-striped table-bordered dt-responsive nowrap fn_add_stop_1container" cellspacing="0" width="100%">
                                                        ...
                                                        <tr>
                                                            ...
                                                            <th colspan="3">
                                                                ...
                                                                <div class="col-md-8 col-sm-2 col-xs-12">
																	...
																	<input type="text"  class="form-control col-md-7 col-xs-12"  name="year1"  id="edit_year1" value="<?php echo isset($forms->year1) ? $forms->year1 : ''; ?>"  placeholder="<?php echo $this->lang->line('year1'); ?>"  autocomplete="off"/>
                                                            ...
                                                            <th colspan="3">
                                                                ...
                                                                <div class="col-md-8 col-sm-2 col-xs-12">
                                                                    <div class="item form-group">
                                                                        <input  class="form-control col-md-7 col-xs-12"  name="year2"  id="edit_year2" value="<?php echo isset($forms->year2) ? $forms->year2 : ''; ?>" placeholder="" type="text" autocomplete="off">
                                                                        <div class="help-block"><?php echo form_error('year2'); ?></div>
                                                                    </div>
                                                                </div>
                                                            </th>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>
																...
																<select  class="form-control col-md-7 col-xs-12" name="ex1_sub1"  id="ex1_sub1" >
																	...
																	<?php foreach ($listsubjects as $key => $value) { ?>
                                                                       ...
                                                                       if ($forms->ex1_sub1 == $value["sub_name"]) {
                                                                            echo 'selected="selected"';
                                                                        }
                                                            ...
                                                            <td>
                                                                <select  class="form-control col-md-7 col-xs-12" name="ex2_sub1"  id="ex2_sub1">
																	...
																	<?php foreach ($listsubjects as $key => $value) { ?>
                                                                       <option value="<?php echo $value["sub_name"] ?>" <?php
                                                                       if ($forms->ex2_sub1 == $value["sub_name"]) {
                                                                            echo 'selected="selected"';
                                                                        }
                                                                      ?>><?php echo $value["sub_name"] ?></option>
                                                                    <?php } ?>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <select  class="form-control col-md-7 col-xs-12" name="ex1_sub2"  id="ex1_sub2">
																	...
																	<?php foreach ($listsubjects as $key => $value) { ?>
                                                                       <option value="<?php echo $value["sub_name"] ?>" <?php
                                                                       if ($forms->ex1_sub2 == $value["sub_name"]) {
                                                                            echo 'selected="selected"';
                                                                        }
                                                                      ?>><?php echo $value["sub_name"] ?></option>
                                                                    <?php } ?>
                                                            ...
                                                            <td>
                                                               <select  class="form-control col-md-7 col-xs-12" name="ex2_sub2"  id="ex2_sub2"  >
																	...
																	<?php foreach ($listsubjects as $key => $value) { ?>
                                                                       <option value="<?php echo $value["sub_name"] ?>" <?php
                                                                       if ($forms->ex2_sub2 == $value["sub_name"]) {
                                                                            echo 'selected="selected"';
                                                                        }
                                                                      ?>><?php echo $value["sub_name"] ?></option>
                                                                    <?php } ?>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <select  class="form-control col-md-7 col-xs-12" name="ex1_sub3"  id="ex1_sub3"  >
																	...
																	<?php foreach ($listsubjects as $key => $value) { ?>
                                                                       <option value="<?php echo $value["sub_name"] ?>" <?php
                                                                       if ($forms->ex1_sub3 == $value["sub_name"]) {
                                                                            echo 'selected="selected"';
                                                                        }
                                                                      ?>><?php echo $value["sub_name"] ?></option>
                                                                    <?php } ?>
                                                            ...
                                                            <td>
                                                                <select  class="form-control col-md-7 col-xs-12" name="ex2_sub3"  id="ex2_sub3" >
																	...
																	<?php foreach ($listsubjects as $key => $value) { ?>
                                                                       <option value="<?php echo $value["sub_name"] ?>" <?php
                                                                       if ($forms->ex2_sub3 == $value["sub_name"]) {
                                                                            echo 'selected="selected"';
                                                                        }
                                                                      ?>><?php echo $value["sub_name"] ?></option>
                                                                    <?php } ?>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <select  class="form-control col-md-7 col-xs-12" name="ex1_sub4"  id="ex1_sub4" >
																	...
																	<?php foreach ($listsubjects as $key => $value) { ?>
                                                                       <option value="<?php echo $value["sub_name"] ?>" <?php
                                                                       if ($forms->ex1_sub4 == $value["sub_name"]) {
                                                                            echo 'selected="selected"';
                                                                        }
                                                                      ?>><?php echo $value["sub_name"] ?></option>
                                                                    <?php } ?>
                                                            ...
                                                            <td>
                                                                <select  class="form-control col-md-7 col-xs-12" name="ex2_sub4"  id="ex2_sub4" >
																	...
																	<?php foreach ($listsubjects as $key => $value) { ?>
                                                                       <option value="<?php echo $value["sub_name"] ?>" <?php
                                                                       if ($forms->ex2_sub4 == $value["sub_name"]) {
                                                                            echo 'selected="selected"';
                                                                        }
                                                                      ?>><?php echo $value["sub_name"] ?></option>
                                                                    <?php } ?>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <select  class="form-control col-md-7 col-xs-12" name="ex1_sub5"  id="ex1_sub5" >
																	...
																	<?php foreach ($listsubjects as $key => $value) { ?>
                                                                       <option value="<?php echo $value["sub_name"] ?>" <?php
                                                                       if ($forms->ex1_sub5 == $value["sub_name"]) {
                                                                            echo 'selected="selected"';
                                                                        }
                                                                      ?>><?php echo $value["sub_name"] ?></option>
                                                                    <?php } ?>
                                                            ...
                                                            <td>
                                                                <select  class="form-control col-md-7 col-xs-12" name="ex2_sub5"  id="ex2_sub5" >
																	...
																	<?php foreach ($listsubjects as $key => $value) { ?>
                                                                       <option value="<?php echo $value["sub_name"] ?>" <?php
                                                                       if ($forms->ex2_sub5 == $value["sub_name"]) {
                                                                            echo 'selected="selected"';
                                                                        }
                                                                      ?>><?php echo $value["sub_name"] ?></option>
                                                                    <?php } ?>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <select  class="form-control col-md-7 col-xs-12" name="ex1_sub6"  id="ex1_sub6" >
																	...
																	<?php foreach ($listsubjects as $key => $value) { ?>
                                                                       <option value="<?php echo $value["sub_name"] ?>" <?php
                                                                       if ($forms->ex1_sub6 == $value["sub_name"]) {
                                                                            echo 'selected="selected"';
                                                                        }
                                                                      ?>><?php echo $value["sub_name"] ?></option>
                                                                    <?php } ?>
                                                            ...
                                                            <td>
                                                                <input  class="form-control col-md-7 col-xs-12"  name="ex1_sub6_grade"  id="ex1_sub6_grade" value="<?php echo isset($forms->ex1_sub1_grade) ? $forms->ex1_sub6_grade : ''; ?>" placeholder="" type="text" autocomplete="off">
                                                                <div class="help-block"><?php echo form_error('ex1_sub6_grade'); ?></div>
                                                            </td>
                                                            ...
                                                            <td>
                                                                <select  class="form-control col-md-7 col-xs-12" name="ex2_sub6"  id="ex2_sub6" >
																	...
																	<?php foreach ($listsubjects as $key => $value) { ?>
                                                                       <option value="<?php echo $value["sub_name"] ?>" <?php
                                                                       if ($forms->ex2_sub6 == $value["sub_name"]) {
                                                                            echo 'selected="selected"';
                                                                        }
                                                                      ?>><?php echo $value["sub_name"] ?></option>
                                                                    <?php } ?>
                                                            ...
                                                            <td>
                                                                <input  class="form-control col-md-7 col-xs-12"  name="ex2_sub6_grade"  id="ex2_sub6_grade" value="<?php echo isset($forms->ex2_sub1_grade) ? $forms->ex2_sub6_grade : ''; ?>" placeholder="" type="text" autocomplete="off">
                                                                <div class="help-block"><?php echo form_error('ex2_sub6_grade'); ?></div>
                                                            </td>
                                                        </tr>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <select  class="form-control col-md-7 col-xs-12" name="ex1_sub7"  id="ex1_sub7" >
																	...
																	<?php foreach ($listsubjects as $key => $value) { ?>
                                                                       <option value="<?php echo $value["sub_name"] ?>" <?php
                                                                       if ($forms->ex1_sub7 == $value["sub_name"]) {
                                                                            echo 'selected="selected"';
                                                                        }
                                                                      ?>><?php echo $value["sub_name"] ?></option>
                                                                    <?php } ?>
                                                            ...
                                                            <td>
                                                                <input  class="form-control col-md-7 col-xs-12"  name="ex1_sub7_grade"  id="ex1_sub7_grade" value="<?php echo isset($form->ex1_sub7_grade) ? $form->ex1_sub7_grade : ''; ?>" placeholder="" type="text" autocomplete="off">
                                                                <div class="help-block"><?php echo form_error('ex1_sub7_grade'); ?></div>
                                                            </td>
                                                            ...
                                                            <td>
																<select  class="form-control col-md-7 col-xs-12" name="ex2_sub7"  id="ex2_sub7"  >
																	...
																	<?php foreach ($listsubjects as $key => $value) { ?>
                                                                       <option value="<?php echo $value["sub_name"] ?>" <?php
                                                                       if ($forms->ex2_sub7 == $value["sub_name"]) {
                                                                            echo 'selected="selected"';
                                                                        }
                                                                      ?>><?php echo $value["sub_name"] ?></option>
                                                                    <?php } ?>
                                                            ...
                                                            <td>
                                                                <input  class="form-control col-md-7 col-xs-12"  name="ex2_sub7_grade"  id="ex2_sub7_grade" value="<?php echo isset($form->ex2_sub7_grade) ? $form->ex2_sub7_grade : ''; ?>" placeholder="" type="text" autocomplete="off">
                                                                <div class="help-block"><?php echo form_error('ex2_sub7_grade'); ?></div>
                                                            </td>
                                                        </tr>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <select  class="form-control col-md-7 col-xs-12" name="ex1_sub8"  id="ex1_sub8" >
																	...
																	<?php foreach ($listsubjects as $key => $value) { ?>
                                                                       <option value="<?php echo $value["sub_name"] ?>" <?php
                                                                       if ($forms->ex1_sub8 == $value["sub_name"]) {
                                                                            echo 'selected="selected"';
                                                                        }
                                                                      ?>><?php echo $value["sub_name"] ?></option>
                                                                    <?php } ?>
                                                            ...
                                                            <td>
                                                                <select  class="form-control col-md-7 col-xs-12" name="ex2_sub8"  id="ex2_sub8" >
																	...
																	<?php foreach ($listsubjects as $key => $value) { ?>
                                                                       <option value="<?php echo $value["sub_name"] ?>" <?php
                                                                       if ($forms->ex2_sub8 == $value["sub_name"]) {
                                                                            echo 'selected="selected"';
                                                                        }
                                                                      ?>><?php echo $value["sub_name"] ?></option>
                                                                    <?php } ?>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>
																...
																<?php foreach ($listsubjects as $key => $value) { ?>
                                                                       <option value="<?php echo $value["sub_name"] ?>" <?php
                                                                       if ($forms->ex1_sub9 == $value["sub_name"]) {
                                                                            echo 'selected="selected"';
                                                                        }
                                                                      ?>><?php echo $value["sub_name"] ?></option>
                                                                    <?php } ?>
                                                            ...
                                                            <td>
																...
																<?php foreach ($listsubjects as $key => $value) { ?>
                                                                       <option value="<?php echo $value["sub_name"] ?>" <?php
                                                                       if ($forms->ex2_sub9 == $value["sub_name"]) {
                                                                            echo 'selected="selected"';
                                                                        }
                                                                      ?>><?php echo $value["sub_name"] ?></option>
                                                                    <?php } ?>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <select  class="form-control col-md-7 col-xs-12" name="ex1_sub10"  id="ex1_sub10"  >
																	...
																	<?php foreach ($listsubjects as $key => $value) { ?>
                                                                       <option value="<?php echo $value["sub_name"] ?>" <?php
                                                                       if ($forms->ex1_sub10 == $value["sub_name"]) {
                                                                            echo 'selected="selected"';
                                                                        }
                                                                      ?>><?php echo $value["sub_name"] ?></option>
                                                                    <?php } ?>
                                                            ...
                                                            <td>
                                                                <select  class="form-control col-md-7 col-xs-12" name="ex2_sub10"  id="ex2_sub10"  >
																	...
																	<?php foreach ($listsubjects as $key => $value) { ?>
                                                                       <option value="<?php echo $value["sub_name"] ?>" <?php
                                                                       if ($forms->ex2_sub10 == $value["sub_name"]) {
                                                                            echo 'selected="selected"';
                                                                        }
                                                                      ?>><?php echo $value["sub_name"] ?></option>
                                                                    <?php } ?>
                                        ...
                                        <div class="row" style="font-size: 16px;">
                                            ...
                                            <div class="col-md-12 col-sm-12 col-xs-12">
                                                    ...
                                                    <table id="datatable-responsive" class="table table-striped table-bordered dt-responsive nowrap fn_add_stop_2container" cellspacing="0" width="100%">
                                                        <tr>
                                                            ...
                                                            <th colspan="6">
										                        ...
										                        <div class="col-md-4 col-sm-2 col-xs-12">
                                                <div class="item form-group">
													<select  class="form-control col-md-7 col-xs-12" name="higher_exam_type" id="higher_exam_type">
														
														 <option value="">--<?php echo $this->lang->line('select'); ?>--</option>                                                                                    
                                                       <?php $higher_exam_types = get_exam(); ?>
                                                <?php foreach ($higher_exam_types as $key => $value) { ?>
                                                    <option value="<?php echo $key; ?>" <?php
                                                    if ($forms1->higher_exam_type == $key) {
                                                        echo 'selected="selected"';
                                                    }
                                                    ?>><?php echo $value; ?></option>
                                                        <?php } ?>
                                                ...
                                                <div class="item form-group">
													...
													<input  class="form-control col-md-7 col-xs-12"  name="higher_exam"  id="higher_exam" value="<?php echo isset($forms1->higher_exam) ? $forms1->higher_exam : ''; ?>" placeholder="" type="text" autocomplete="off" style="display:none;">
                                                                        <div class="help-block"><?php echo form_error('exam_name'); ?></div>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <th colspan="3">
                                                                ...
                                                                <div class="col-md-8 col-sm-2 col-xs-12">
                                                                    <div class="item form-group">
                                                                        <input  class="form-control col-md-7 col-xs-12"  name="year_h1"  id="edit_year_h1" value="<?php echo isset($forms1->year_h1) ? $forms1->year_h1 : ''; ?>" placeholder="" type="text" autocomplete="off">
                                                                        <div class="help-block"><?php echo form_error('year_h1'); ?></div>
                                                                    </div>
                                                                </div>
                                                            ...
                                                            <th colspan="3">
                                                                ...
                                                                <div class="col-md-8 col-sm-2 col-xs-12">
                                                                    <div class="item form-group">
                                                                        <input  class="form-control col-md-7 col-xs-12"  name="year_h2"  id="edit_year_h2" value="<?php echo isset($forms1->year_h2) ? $forms1->year_h2 : ''; ?>" placeholder="" type="text" autocomplete="off">
                                                                        <div class="help-block"><?php echo form_error('year_h2'); ?></div>
                                                                    </div>
                                                                </div>
                                                            </th>
                                                            ...
                                                            <th colspan="3">
                                                                ...
                                                                <div class="col-md-8 col-sm-2 col-xs-12">
                                                                    <div class="item form-group">
                                                                        <input  class="form-control col-md-7 col-xs-12"  name="exam_noh1"  id="exam_noh1" value="<?php echo isset($forms1->exam_noh1) ? $forms1->exam_noh1 : ''; ?>" placeholder="" type="text" autocomplete="off">
                                                                        <div class="help-block"><?php echo form_error('exam_noh1'); ?></div>
                                                                    </div>
                                                                </div>
                                                            </th>
                                                            <th colspan="3">
                                                                ...
                                                                <div class="col-md-8 col-sm-2 col-xs-12">
                                                                    <div class="item form-group">
                                                                        <input  class="form-control col-md-7 col-xs-12"  name="exam_noh2"  id="exam_noh2" value="<?php echo isset($forms1->exam_noh2) ? $forms1->exam_noh2 : ''; ?>" placeholder="" type="text" autocomplete="off">
                                                                        <div class="help-block"><?php echo form_error('exam_noh2'); ?></div>
                                                                    </div>
                                                                </div>
                                                            </th>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <th colspan="3">
                                                                ...
                                                                <div class="col-md-8 col-sm-2 col-xs-12">
                                                                    <div class="item form-group">
                                                                        <input  class="form-control col-md-7 col-xs-12"  name="datehi"  id="edit_datehi" 
																			    value="<?php
												                        if($forms1->datehi!='1970-01-01') {
													                      echo date('d-m-Y', strtotime($forms1->datehi));
												                         } 
												                       else echo ''; ?>" 
												                            placeholder="<?php echo $this->lang->line('datehi'); ?>" type="text" autocomplete="off">
                                                                        <div class="help-block"><?php echo $this->lang->line('datehi'); ?></div>
                                                                    </div>
                                                                </div>
                                                            </th>
                                                            <th colspan="3">
                                                                ...
                                                                <div class="col-md-8 col-sm-2 col-xs-12">
                                                                    <div class="item form-group">
                                                                        <input  class="form-control col-md-7 col-xs-12"  name="datehii"  id="edit_datehii" 
																			  value="<?php
												                        if($forms1->datehii!='1970-01-01') {
													                      echo date('d-m-Y', strtotime($forms1->datehii));
												                         } 
												                       else echo ''; ?>" 
																			   placeholder="<?php echo $this->lang->line('datehii'); ?>" type="text" autocomplete="off">
                                                                        <div class="help-block"><?php echo $this->lang->line('datehii'); ?></div>
                                                                    </div>
                                                                </div>
                                                            </th>
                                                        ...
                                                        <tr>
                                                            <td>01</td>
                                                            <td>
                                                                <input  class="form-control col-md-7 col-xs-12"  name="hex1_sub1"  id="hex1_sub1" value="<?php echo isset($forms1->hex1_sub1) ? $forms1->hex1_sub1 : ''; ?>" placeholder="" type="text" autocomplete="off">
                                                                <div class="help-block"><?php echo form_error('hex1_sub1'); ?></div>
                                                            </td>
                                                            <td>
                                                                <input  class="form-control col-md-7 col-xs-12"  name="hex1_sub1_grade"  id="hex1_sub1_grade" value="<?php echo isset($forms1->hex1_sub1_grade) ? $forms1->hex1_sub1_grade : ''; ?>" placeholder="" type="text" autocomplete="off">
                                                                <div class="help-block"><?php echo form_error('hex1_sub1_grade'); ?></div>
                                                            </td>

                                                            <td>01</td>
                                                            <td>
                                                                <input  class="form-control col-md-7 col-xs-12"  name="hex2_sub1"  id="hex2_sub1" value="<?php echo isset($forms1->hex2_sub1) ? $forms1->hex2_sub1 : ''; ?>" placeholder="" type="text" autocomplete="off">
                                                                <div class="help-block"><?php echo form_error('hex2_sub1'); ?></div>
                                                            </td>
                                                            <td>
                                                                <input  class="form-control col-md-7 col-xs-12"  name="hex2_sub1_grade"  id="hex2_sub1_grade" value="<?php echo isset($forms1->hex2_sub1_grade) ? $forms1->hex2_sub1_grade : ''; ?>" placeholder="" type="text" autocomplete="off">
                                                                <div class="help-block"><?php echo form_error('hex2_sub1_grade'); ?></div>
                                                            </td>
                                                        </tr>
                                                        ...
                                                        <tr>
                                                            <td>02</td>
                                                            <td>
                                                                <input  class="form-control col-md-7 col-xs-12"  name="hex1_sub2"  id="hex1_sub2" value="<?php echo isset($forms1->hex1_sub2) ? $forms1->hex1_sub2 : ''; ?>" placeholder="" type="text" autocomplete="off">
                                                                <div class="help-block"><?php echo form_error('hex1_sub2'); ?></div>
                                                            </td>
                                                            <td>
                                                                <input  class="form-control col-md-7 col-xs-12"  name="hex1_sub2_grade"  id="hex1_sub2_grade" value="<?php echo isset($forms1->hex1_sub2_grade) ? $forms1->hex1_sub2_grade : ''; ?>" placeholder="" type="text" autocomplete="off">
                                                                <div class="help-block"><?php echo form_error('hex1_sub2_grade'); ?></div>
                                                            </td>
                                                            ...
                                                            <td>02</td>
                                                            <td>
                                                                <input  class="form-control col-md-7 col-xs-12"  name="hex2_sub2"  id="hex2_sub2" value="<?php echo isset($forms1->hex2_sub2) ? $forms1->hex2_sub2 : ''; ?>" placeholder="" type="text" autocomplete="off">
                                                                <div class="help-block"><?php echo form_error('hex2_sub2'); ?></div>
                                                            </td>
                                                            <td>
                                                                <input  class="form-control col-md-7 col-xs-12"  name="hex2_sub2_grade"  id="hex2_sub2_grade" value="<?php echo isset($forms1->hex2_sub2_grade) ? $forms1->hex2_sub2_grade : ''; ?>" placeholder="" type="text" autocomplete="off">
                                                                <div class="help-block"><?php echo form_error('hex2_sub2_grade'); ?></div>
                                                            </td>
                                                        </tr>
													    ...
													    <tr>
                                                            <td>03</td>
                                                            <td>
                                                                <input  class="form-control col-md-7 col-xs-12"  name="hex1_sub3"  id="hex1_sub3" value="<?php echo isset($forms1->hex1_sub3) ? $forms1->hex1_sub3 : ''; ?>" placeholder="" type="text" autocomplete="off">
                                                                <div class="help-block"><?php echo form_error('hex1_sub3'); ?></div>
                                                            </td>
                                                            <td>
                                                                <input  class="form-control col-md-7 col-xs-12"  name="hex1_sub3_grade"  id="hex1_sub3_grade" value="<?php echo isset($forms1->hex1_sub3_grade) ? $forms1->hex1_sub3_grade : ''; ?>" placeholder="" type="text" autocomplete="off">
                                                                <div class="help-block"><?php echo form_error('hex1_sub3_grade'); ?></div>
                                                            </td>

                                                            <td>03</td>
                                                            <td>
                                                                <input  class="form-control col-md-7 col-xs-12"  name="hex2_sub3"  id="hex2_sub3" value="<?php echo isset($forms1->hex2_sub3) ? $forms1->hex2_sub3 : ''; ?>" placeholder="" type="text" autocomplete="off">
                                                                <div class="help-block"><?php echo form_error('hex2_sub3'); ?></div>
                                                            </td>
                                                            <td>
                                                                <input  class="form-control col-md-7 col-xs-12"  name="hex2_sub3_grade"  id="hex2_sub3_grade" value="<?php echo isset($forms1->hex2_sub3_grade) ? $forms1->hex2_sub3_grade : ''; ?>" placeholder="" type="text" autocomplete="off">
                                                                <div class="help-block"><?php echo form_error('hex2_sub3_grade'); ?></div>
                                                            </td>
                                                        </tr>
                                                        ...
                                                        <tr>
                                                            <td>04</td>
                                                            <td>
                                                                <input  class="form-control col-md-7 col-xs-12"  name="hex1_sub4"  id="hex1_sub4" value="<?php echo isset($forms1->hex1_sub4) ? $forms1->hex1_sub4 : ''; ?>" placeholder="" type="text" autocomplete="off">
                                                                <div class="help-block"><?php echo form_error('hex1_sub4'); ?></div>
                                                            </td>
                                                            <td>
                                                                <input  class="form-control col-md-7 col-xs-12"  name="hex1_sub4_grade"  id="hex1_sub4_grade" value="<?php echo isset($forms1->hex1_sub4_grade) ? $forms1->hex1_sub4_grade : ''; ?>" placeholder="" type="text" autocomplete="off">
                                                                <div class="help-block"><?php echo form_error('hex1_sub4_grade'); ?></div>
                                                            </td>

                                                            <td>04</td>
                                                            <td>
                                                                <input  class="form-control col-md-7 col-xs-12"  name="hex2_sub4"  id="hex2_sub4" value="<?php echo isset($forms1->hex2_sub4) ? $forms1->hex2_sub4 : ''; ?>" placeholder="" type="text" autocomplete="off">
                                                                <div class="help-block"><?php echo form_error('hex2_sub4'); ?></div>
                                                            </td>
                                                            <td>
                                                                <input  class="form-control col-md-7 col-xs-12"  name="hex2_sub4_grade"  id="hex2_sub4_grade" value="<?php echo isset($forms1->hex2_sub4_grade) ? $forms1->hex2_sub4_grade : ''; ?>" placeholder="" type="text" autocomplete="off">
                                                                <div class="help-block"><?php echo form_error('hex2_sub4_grade'); ?></div>
                                                            </td>
                                                        </tr>
                                                        ...
                                                        <tr>
                                                            <td>05</td>
                                                            <td>
                                                                <input  class="form-control col-md-7 col-xs-12"  name="hex1_sub5"  id="hex1_sub5" value="<?php echo isset($forms1->hex1_sub5) ? $forms1->hex1_sub5 : ''; ?>" placeholder="" type="text" autocomplete="off">
                                                                <div class="help-block"><?php echo form_error('hex1_sub5'); ?></div>
                                                            </td>
                                                            <td>
                                                                <input  class="form-control col-md-7 col-xs-12"  name="hex1_sub5_grade"  id="hex1_sub5_grade" value="<?php echo isset($forms1->hex1_sub5_grade) ? $forms1->hex1_sub5_grade : ''; ?>" placeholder="" type="text" autocomplete="off">
                                                                <div class="help-block"><?php echo form_error('hex1_sub5_grade'); ?></div>
                                                            </td>

                                                            <td>05</td>
                                                            <td>
                                                                <input  class="form-control col-md-7 col-xs-12"  name="hex2_sub5"  id="hex2_sub5" value="<?php echo isset($forms1->hex2_sub5) ? $forms1->hex2_sub5 : ''; ?>" placeholder="" type="text" autocomplete="off">
                                                                <div class="help-block"><?php echo form_error('hex2_sub4'); ?></div>
                                                            </td>
                                                            <td>
                                                                <input  class="form-control col-md-7 col-xs-12"  name="hex2_sub5_grade"  id="hex2_sub5_grade" value="<?php echo isset($forms1->hex2_sub5_grade) ? $forms1->hex2_sub5_grade : ''; ?>" placeholder="" type="text" autocomplete="off">
                                                                <div class="help-block"><?php echo form_error('hex2_sub5_grade'); ?></div>
                                                            </td>
                                                        </tr>
														...
														<tr>
                                                            <td>06</td>
                                                            <td>
                                                                <input  class="form-control col-md-7 col-xs-12"  name="hex1_sub6"  id="hex1_sub6" value="<?php echo isset($forms1->hex1_sub6) ? $forms1->hex1_sub6 : ''; ?>" placeholder="" type="text" autocomplete="off">
                                                                <div class="help-block"><?php echo form_error('hex1_sub6'); ?></div>
                                                            </td>
                                                            <td>
                                                                <input  class="form-control col-md-7 col-xs-12"  name="hex1_sub6_grade"  id="hex1_sub6_grade" value="<?php echo isset($forms1->hex1_sub1_grade) ? $forms1->hex1_sub6_grade : ''; ?>" placeholder="" type="text" autocomplete="off">
                                                                <div class="help-block"><?php echo form_error('hex1_sub6_grade'); ?></div>
                                                            </td>

                                                            <td>06</td>
                                                            <td>
                                                                <input  class="form-control col-md-7 col-xs-12"  name="hex2_sub6"  id="hex2_sub6" value="<?php echo isset($forms1->hex2_sub6) ? $forms1->hex2_sub6 : ''; ?>" placeholder="" type="text" autocomplete="off">
                                                                <div class="help-block"><?php echo form_error('hex2_sub6'); ?></div>
                                                            </td>
                                                            <td>
                                                                <input  class="form-control col-md-7 col-xs-12"  name="hex2_sub6_grade"  id="hex2_sub6_grade" value="<?php echo isset($forms1->hex2_sub1_grade) ? $forms1->hex2_sub6_grade : ''; ?>" placeholder="" type="text" autocomplete="off">
                                                                <div class="help-block"><?php echo form_error('hex2_sub6_grade'); ?></div>
                                                            </td>
                                                        </tr>
                                                        ...
                                                        <tr>
                                                            <td>07</td>
                                                            <td>
                                                                <input  class="form-control col-md-7 col-xs-12"  name="hex1_sub7"  id="hex1_sub7" value="<?php echo isset($forms1->hex1_sub7) ? $forms1->hex1_sub7 : ''; ?>" placeholder="" type="text" autocomplete="off">
                                                                <div class="help-block"><?php echo form_error('hex1_sub7'); ?></div>
                                                            </td>
                                                            <td>
                                                                <input  class="form-control col-md-7 col-xs-12"  name="hex1_sub7_grade"  id="hex1_sub7_grade" value="<?php echo isset($forms1->hex1_sub7_grade) ? $forms1->hex1_sub7_grade : ''; ?>" placeholder="" type="text" autocomplete="off">
                                                                <div class="help-block"><?php echo form_error('hex1_sub7_grade'); ?></div>
                                                            </td>

                                                            <td>07</td>
                                                            <td>
                                                                <input  class="form-control col-md-7 col-xs-12"  name="hex2_sub7"  id="hex2_sub7" value="<?php echo isset($forms1->hex2_sub7) ? $forms1->hex2_sub7: ''; ?>" placeholder="" type="text" autocomplete="off">
                                                                <div class="help-block"><?php echo form_error('hex2_sub7'); ?></div>
                                                            </td>
                                                            <td>
                                                                <input  class="form-control col-md-7 col-xs-12"  name="hex2_sub7_grade"  id="hex2_sub7_grade" value="<?php echo isset($forms1->hex2_sub7_grade) ? $forms1->hex2_sub7_grade : ''; ?>" placeholder="" type="text" autocomplete="off">
                                                                <div class="help-block"><?php echo form_error('hex2_sub7_grade'); ?></div>
                                                            </td>
                                                        </tr>
														...
														<tr>
                                                            <td>08</td>
                                                            <td>
                                                                <input  class="form-control col-md-7 col-xs-12"  name="hex1_sub8"  id="hex1_sub8" value="<?php echo isset($forms1->hex1_sub8) ? $forms1->hex1_sub8 : ''; ?>" placeholder="" type="text" autocomplete="off">
                                                                <div class="help-block"><?php echo form_error('hex1_sub8'); ?></div>
                                                            </td>
                                                            <td>
                                                                <input  class="form-control col-md-7 col-xs-12"  name="hex1_sub8_grade"  id="hex1_sub8_grade" value="<?php echo isset($forms1->hex1_sub8_grade) ? $forms1->hex1_sub8_grade : ''; ?>" placeholder="" type="text" autocomplete="off">
                                                                <div class="help-block"><?php echo form_error('hex1_sub8_grade'); ?></div>
                                                            </td>

                                                            <td>08</td>
                                                            <td>
                                                                <input  class="form-control col-md-7 col-xs-12"  name="hex2_sub8"  id="hex2_sub8" value="<?php echo isset($forms1->hex2_sub8) ? $forms1->hex2_sub8 : ''; ?>" placeholder="" type="text" autocomplete="off">
                                                                <div class="help-block"><?php echo form_error('hex2_sub8'); ?></div>
                                                            </td>
                                                            <td>
                                                                <input  class="form-control col-md-7 col-xs-12"  name="hex2_sub8_grade"  id="hex2_sub8_grade" value="<?php echo isset($forms1->hex2_sub8_grade) ? $forms1->hex2_sub8_grade : ''; ?>" placeholder="" type="text" autocomplete="off">
                                                                <div class="help-block"><?php echo form_error('hex2_sub8_grade'); ?></div>
                                                            </td>
                                                        </tr>
                                                        ...
                                                        <tr>
                                                            <td>09</td>
                                                            <td>
                                                                <input  class="form-control col-md-7 col-xs-12"  name="hex1_sub9"  id="hex1_sub9" value="<?php echo isset($forms1->hex1_sub9) ? $forms1->hex1_sub9 : ''; ?>" placeholder="" type="text" autocomplete="off">
                                                                <div class="help-block"><?php echo form_error('hex1_sub9'); ?></div>
                                                            </td>
                                                            <td>
                                                                <input  class="form-control col-md-7 col-xs-12"  name="hex1_sub9_grade"  id="hex1_sub9_grade" value="<?php echo isset($forms1->hex1_sub9_grade) ? $forms1->hex1_sub9_grade : ''; ?>" placeholder="" type="text" autocomplete="off">
                                                                <div class="help-block"><?php echo form_error('hex1_sub9_grade'); ?></div>
                                                            </td>

                                                            <td>09</td>
                                                            <td>
                                                                <input  class="form-control col-md-7 col-xs-12"  name="hex2_sub9"  id="hex2_sub9" value="<?php echo isset($forms1->hex2_sub9)  ? $forms1->hex2_sub9 : ''; ?>" placeholder="" type="text" autocomplete="off">
                                                                <div class="help-block"><?php echo form_error('hex2_sub9'); ?></div>
                                                            </td>
                                                            <td>
                                                                <input  class="form-control col-md-7 col-xs-12"  name="hex2_sub9_grade"  id="hex2_sub9_grade" value="<?php echo isset($forms1->hex2_sub9_grade) ? $forms1->hex2_sub9_grade : ''; ?>" placeholder="" type="text" autocomplete="off">
                                                                <div class="help-block"><?php echo form_error('hex2_sub9_grade'); ?></div>
                                                            </td>
                                                        </tr>
                                                        ...
                                                        <tr>
                                                            <td>10</td>
                                                            <td>
                                                                <input  class="form-control col-md-7 col-xs-12"  name="hex1_sub10"  id="hex1_sub10" value="<?php echo isset($forms1->hex1_sub10) ? $forms1->hex1_sub10 : ''; ?>" placeholder="" type="text" autocomplete="off">
                                                                <div class="help-block"><?php echo form_error('hex1_sub1'); ?></div>
                                                            </td>
                                                            <td>
                                                                <input  class="form-control col-md-7 col-xs-12"  name="hex1_sub10_grade"  id="hex1_sub10_grade" value="<?php echo isset($forms1->hex1_sub10_grad) ? $forms1->hex1_sub10_grad : ''; ?>" placeholder="" type="text" autocomplete="off">
                                                                <div class="help-block"><?php echo form_error('hex1_sub10_grade'); ?></div>
                                                            </td>

                                                            <td>10</td>
                                                            <td>
                                                                <input  class="form-control col-md-7 col-xs-12"  name="hex2_sub10"  id="hex2_sub10" value="<?php echo isset($forms1->hex2_sub10) ? $forms1->hex2_sub10 : ''; ?>" placeholder="" type="text" autocomplete="off">
                                                                <div class="help-block"><?php echo form_error('hex2_sub1'); ?></div>
                                                            </td>
                                                            <td>
                                                                <input  class="form-control col-md-7 col-xs-12"  name="hex2_sub10_grade"  id="hex2_sub10_grade" value="<?php echo isset($forms1->hex2_sub10_grad) ? $forms1->hex2_sub10_grad : ''; ?>" placeholder="" type="text" autocomplete="off">
                                                                <div class="help-block"><?php echo form_error('hex2_sub10_grade'); ?></div>
                                                            </td>
                                                        </tr>
									    ...
									    <div class="row" style="font-size: 16px;">
                                            ...
                                            <div class="col-md-8 col-sm-2 col-xs-12">
                                                <div class="item form-group">
													 <textarea  class="form-control col-md-7 col-xs-12 textarea-5column"  name="other_qualifications"  id="other_qualifications" placeholder=" "><?php echo isset($forms1->other_qualifications) ? $forms1->other_qualifications : ''; ?></textarea>
                                     ...
                                     <div id="showyes" class="yesOnly" style="display:none;"> 
                                         <table style="width:100%;" class="table table-striped table-bordered dt-responsive nowrap fn_edit_stop_container responsive"> 
                                             <tr>               
                                                            <th rowspan="2" style="text-align: center"><?php echo $this->lang->line('text225'); ?></th>
                                                            <th rowspan="2" style="text-align: center"><?php echo $this->lang->line('text226'); ?></th>
                                                            <th colspan="2" style="text-align: center"><?php echo $this->lang->line('text227'); ?></th>
                                            ...
                                            <?php $couter = 1; foreach($new_teacher_app_01_working as $obj){ ?> 
                                            <tr>               
                                              <td>                                                  
                                                  <input type="hidden" name="stop_id[]" value="<?php echo $obj->id; ?>" />
                                                  <input  class="form-control col-md-12 col-xs-12" style="width:auto;" type="text" name="working_place[]" value="<?php echo $obj->working_place; ?>" placeholder="<?php echo $this->lang->line('225'); ?>" />
                                              </td>
                                              <td>
                                                  <input  class="form-control col-md-12 col-xs-12" style="width:auto;" type='text' name="working_designation[]" value="<?php echo $obj->working_designation; ?>" placeholder="<?php echo $this->lang->line('text226'); ?>"/>
                                              </td>
                                              <td>
                                        ...
                                        <div class="help-block">
										 ...
										 <div class="row" style="font-size: 16px;">
                                            ...
                                            <div class="col-md-8 col-sm-2 col-xs-12">
                                                <div class="item form-group">
                                                    <textarea  class="form-control col-md-7 col-xs-12 textarea-4column"  name="leave_reson"  id="leave_reson"
													placeholder=" "><?php echo isset($forms1->leave_reson) ? $forms1->leave_reson : ''; ?></textarea>
                                                </div>
                                            </div>
                                        </div>
                                            ...
                                            <div class="item form-group">
                                                ...
                                                <input  class="form-control col-md-7 col-xs-12"  name="dateiv"  id="edit_dateiv" 
											    value="<?php
												 if($forms1->dateiv !='1970-01-01') {
													 echo date('d-m-Y', strtotime($forms1->dateiv));
												 } 
												 else echo ''; ?>" 
												 placeholder="<?php echo $this->lang->line('date'); ?>" type="text" autocomplete="off">
										 ...
										 <div class="row" style="font-size: 16px;">
                                            <div class="col-md-6 col-sm-6 col-xs-12">
                                                <div class="item form-group">
                                                    <label for="date_submit"> <?php echo $this->lang->line('date'); ?></label>
                                                    <input  class="form-control col-md-7 col-xs-12"   type="text" id="edit_datev" name="datev" 
														   value="<?php
												 if($forms1->datev !='1970-01-01') {
													 echo date('d-m-Y', strtotime($forms1->datev));
												 } 
												 else echo ''; ?>"  
								 ...
								 <div class="form-group">
                                    <div class="col-md-12 col-md-offset-3" style="color: red;font-size: 18px;font-weight: 700">
									    ...
									    <!--== tab_first =============================================================================================================================-->
										 ...
										 <div class="tab-pane fade in " id="edit_tab_first">
                                                ...
                                                <div class="item form-group">
                                                    <table id="datatable-responsive" class="table table-striped table-bordered dt-responsive nowrap" cellspacing="0" width="100%">
                                                        ...
                                                        <tbody>
                                                            <tr>
                                                                <td>
                                                                    <input  class="form-control col-md-7 col-xs-12"  name="annual_year1"  id="annual_year1" value="<?php echo isset($forms2->annual_year1) ? $forms2->annual_year1 : ''; ?>" placeholder="<?php echo $this->lang->line('tea_year'); ?>"  type="number" autocomplete="off">
                                                                    <div class="help-block"><?php echo form_error('7iidate'); ?></div>
                                                                </td>
                                                                <td>
                                                                    <input  class="form-control col-md-7 col-xs-12"  name="annual_month1"  id="annual_month1" value="<?php echo isset($forms2->annual_month1) ? $forms2->annual_month1 : ''; ?>" placeholder="<?php echo $this->lang->line('month'); ?>"  type="number" autocomplete="off">                                                                           
                                                                    <div class="help-block"><?php echo form_error('7iidate'); ?></div>
                                                                </td>
                                                                <td>
                                                                    <input  class="form-control col-md-7 col-xs-12"  name="annual_date1"  id="annual_date1" value="<?php echo isset($forms2->annual_date1) ? $forms2->annual_date1 : ''; ?>" placeholder="<?php echo $this->lang->line('date'); ?>"  type="number" autocomplete="off">                                                                          
                                                                    <div class="help-block"><?php echo form_error('7iidate'); ?></div>
                                                                </td>
                                                ...
                                                <div class="item form-group">
                                                    <table id="datatable-responsive" class="table table-striped table-bordered dt-responsive nowrap" cellspacing="0" width="100%">
                                                        ...
                                                        <tbody>
                                                            <tr>
                                                                <td>
                                                                    <input  class="form-control col-md-7 col-xs-12"  name="annual_year2"  id="annual_year2" value="<?php echo isset($forms2->annual_year2) ? $forms2->annual_year2 : ''; ?>" placeholder="<?php echo $this->lang->line('tea_year'); ?>"  type="number" autocomplete="off">
                                                                    <div class="help-block"><?php echo form_error('7iidate'); ?></div>
                                                                </td>
                                                                <td>
                                                                    <input  class="form-control col-md-7 col-xs-12"  name="annual_month2"  id="annual_month2" value="<?php echo isset($forms2->annual_month2) ? $forms2->annual_month2 : ''; ?>" placeholder="<?php echo $this->lang->line('month'); ?>"  type="number" autocomplete="off">                                                                           
                                                                    <div class="help-block"><?php echo form_error('7iidate'); ?></div>
                                                                </td>
                                                                <td>
                                                                    <input  class="form-control col-md-7 col-xs-12"  name="annual_date2"  id="annual_date2" value="<?php echo isset($forms2->annual_date2) ? $forms2->annual_date2 : ''; ?>" placeholder="<?php echo $this->lang->line('date'); ?>"  type="number" autocomplete="off">                                                                          
                                                                    <div class="help-block"><?php echo form_error('7iidate'); ?></div>
                                                                </td>
                                                    ...
                                                    <table id="datatable-responsive" class="table table-striped table-bordered dt-responsive nowrap" cellspacing="0" width="100%">
                                                        ...
                                                        <thead>
                                                           ...
                                                           <tbody>
                                                            <tr>
                                                                <td>
                                                                    <input  class="form-control col-md-7 col-xs-12"  name="annual_monk"  id="annual_monk" value="<?php echo isset($forms2->annual_monk) ? $forms2->annual_monk : ''; ?>" placeholder="<?php echo $this->lang->line('text240a'); ?>"  type="number" autocomplete="off" onblur="reAvgSum();">
                                                                    <div class="help-block"><?php echo form_error('7iidate'); ?></div>
                                                                </td>
                                                                <td>
                                                                    <input  class="form-control col-md-7 col-xs-12"  name="annual_lay"  id="annual_lay" value="<?php echo isset($forms2->annual_lay) ? $forms2->annual_lay : ''; ?>" placeholder="<?php echo $this->lang->line('text240b'); ?>"  type="number" autocomplete="off" onblur="reAvgSum();">                                                                           
                                                                    <div class="help-block"><?php echo form_error('7iidate'); ?></div>
                                                                </td>
                                                                <td>
                                                                    <input readonly class="form-control col-md-7 col-xs-12"  name="annual_total"  id="annual_total" value="<?php echo isset($forms2->annual_total) ? $forms2->annual_total : ''; ?>" placeholder="<?php echo $this->lang->line('text240c'); ?>"  type="number" autocomplete="off">                                                                          
                                                                    <div class="help-block"><?php echo form_error('7iidate'); ?></div>
                                                                </td>
                                                    ...
                                                    <table id="datatable-responsive" class="table table-striped table-bordered dt-responsive nowrap" cellspacing="0" width="100%">
                                                        ...
                                                        <thead>
                                                            <tr>
                                                                ...
                                                                <th style="vertical-align: super;"><?php echo $this->lang->line('text242'); ?></th>
                                                                <td>
                                                                    <input  class="form-control col-md-7 col-xs-12" type="radio" name="vacancy_extra"  id="vc_A" value="vacancy" <?php if(isset($forms2) && $forms2->vacancy_extra == 'vacancy'){ echo 'checked="checked"'; } ?>placeholder=""   autocomplete="off">
                                                                    <div class="help-block"><?php echo form_error('vacancy'); ?></div>
                                                                </td>
                                                                <th style="vertical-align: super;"><?php echo $this->lang->line('text243'); ?></th>
                                                                <td>
                                                                    <input  class="form-control col-md-7 col-xs-12" type="radio" name="vacancy_extra"  id="vc_B" value="extra"
																	<?php if(isset($forms2) && $forms2->vacancy_extra == 'extra'){ echo 'checked="checked"'; } ?>placeholder=""   autocomplete="off">
                                                                    <div class="help-block"><?php echo form_error('extra'); ?></div>
                                                                </td>
                                                            </tr>
                                                        </thead>
                                                    ...
                                                    <table id="datatable-responsive" class="table table-striped table-bordered dt-responsive nowrap" cellspacing="0" width="100%">
                                                        ...
                                                        <thead>
                                                            <tr>
                                                                ...
                                                                <th style="vertical-align: super;"><?php echo $this->lang->line('tea_year'); ?></th>
                                                                <td>
                                                                    <input  class="form-control col-md-7 col-xs-12"  name="vacancy_year"  id="vacancy_year" value="<?php echo isset($forms2->vacancy_year) ? $forms2->vacancy_year : ''; ?>" placeholder=""  type="number" autocomplete="off">
                                                                    <div class="help-block"><?php echo form_error('7iidate'); ?></div>
                                                                </td>
                                                                <th style="vertical-align: super;"><?php echo $this->lang->line('month'); ?></th>
                                                                <td>
                                                                    <input  class="form-control col-md-7 col-xs-12"  name="vacancy_month"  id="vacancy_month" value="<?php echo isset($forms2->vacancy_month) ? $forms2->vacancy_month : ''; ?>" placeholder=""  type="number" autocomplete="off">
                                                                    <div class="help-block"><?php echo form_error('7iidate'); ?></div>
                                                                </td>
                                                                <th style="vertical-align: super;"><?php echo $this->lang->line('date'); ?></th>
                                                                <td>
                                                                    <input  class="form-control col-md-7 col-xs-12"  name="vacancy_date"  id="vacancy_date" value="<?php echo isset($forms2->vacancy_date) ? $forms2->vacancy_date : ''; ?>" placeholder=""  type="number" autocomplete="off">
                                                                    <div class="help-block"><?php echo form_error('7iidate'); ?></div>
                                                                </td>
                                                            </tr>
                                                        </thead>
                                                ...
                                                <div class="item form-group dataTables_wrapper">
                                                    ...
                                                    <table id="datatable-responsive" class="table table-striped table-bordered dt-responsive nowrap" cellspacing="0" width="100%">
                                                        ...
                                                        <tr>
                                                            <td>01</td>
                                                            <td>
                                                                <input class="form-control col-md-7 col-xs-12" name="time1_from" id="edit_time1_from" value="<?php echo isset($forms2->time1_from) ? $forms2->time1_from : ''; ?>" placeholder="" type="text" autocomplete="off">
                                                                <div class="help-block"><?php echo form_error('18i'); ?></div>
                                                            </td>
															 <td>
                                                                <input class="form-control col-md-7 col-xs-12" name="time1_to" id="edit_time1_to" value="<?php echo isset($forms2->time1_to) ? $forms2->time1_to : ''; ?>" placeholder="" type="text" autocomplete="off">
                                                                <div class="help-block"><?php echo form_error('18i'); ?></div>
                                                            </td>
                                                            <td>
                                                                <input class="form-control col-md-7 col-xs-12" name="mon1" id="mon1" value="<?php echo isset($forms2->mon1) ? $forms2->mon1 : ''; ?>" placeholder="" type="text" autocomplete="off">
                                                                <div class="help-block"><?php echo form_error('18i'); ?></div>
                                                            </td>
                                                            <td>
                                                                <input class="form-control col-md-7 col-xs-12" name="tues1" id="tues1" value="<?php echo isset($forms2->tues1) ? $forms2->tues1 : ''; ?>" placeholder="" type="text" autocomplete="off">
                                                                <div class="help-block"><?php echo form_error('18i'); ?></div>
                                                            </td>

                                                            <td>
                                                                <input class="form-control col-md-7 col-xs-12" name="wend1" id="wend1" value="<?php echo isset($forms2->wend1) ? $forms2->wend1 : ''; ?>" placeholder="" type="text" autocomplete="off">
                                                                <div class="help-block"><?php echo form_error('18ii'); ?></div>
                                                            </td>
                                                            <td>
                                                                <input class="form-control col-md-7 col-xs-12" name="thur1" id="thur1" value="<?php echo isset($forms2->thur1) ? $forms2->thur1 : ''; ?>" placeholder="" type="text" autocomplete="off">
                                                                <div class="help-block"><?php echo form_error('18ii'); ?></div>
                                                            </td>
                                                            <td>
                                                                <input class="form-control col-md-7 col-xs-12" name="fri1" id="fri1" value="<?php echo isset($forms2->fri1) ? $forms2->fri1 : ''; ?>" placeholder="" type="text" autocomplete="off">
                                                                <div class="help-block"><?php echo form_error('18ii'); ?></div>
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                            <td>02</td>
                                                            <td>
                                                                <input class="form-control col-md-7 col-xs-12" name="time2_from" id="edit_time2_from" value="<?php echo isset($forms2->time2_from)  ? $forms2->time2_from : ''; ?>" placeholder="" type="text" autocomplete="off">
                                                                <div class="help-block"><?php echo form_error('18i'); ?></div>
                                                            </td>
															<td>
                                                                <input class="form-control col-md-7 col-xs-12" name="time2_to" id="edit_time2_to" value="<?php echo isset($forms2->time2_to) ? $forms2->time2_to : ''; ?>" placeholder="" type="text" autocomplete="off">
                                                                <div class="help-block"><?php echo form_error('18i'); ?></div>
                                                            </td>
                                                            <td>
                                                                <input class="form-control col-md-7 col-xs-12" name="mon2" id="mon2" value="<?php echo isset($forms2->mon2) ? $forms2->mon2 : ''; ?>" placeholder="" type="text" autocomplete="off">
                                                                <div class="help-block"><?php echo form_error('18i'); ?></div>
                                                            </td>
                                                            <td>
                                                                <input class="form-control col-md-7 col-xs-12" name="tues2" id="tues2" value="<?php echo isset($forms2->tues2) ? $forms2->tues2 : ''; ?>" placeholder="" type="text" autocomplete="off">
                                                                <div class="help-block"><?php echo form_error('18i'); ?></div>
                                                            </td>

                                                            <td>
                                                                <input class="form-control col-md-7 col-xs-12" name="wend2" id="wend2" value="<?php echo isset($forms2->wend2)  ? $forms2->wend2 : ''; ?>" placeholder="" type="text" autocomplete="off">
                                                                <div class="help-block"><?php echo form_error('18ii'); ?></div>
                                                            </td>
                                                            <td>
                                                                <input class="form-control col-md-7 col-xs-12" name="thur2" id="thur2" value="<?php echo isset($forms2->thur2) ? $forms2->thur2 : ''; ?>" placeholder="" type="text" autocomplete="off">
                                                                <div class="help-block"><?php echo form_error('18ii'); ?></div>
                                                            </td>
                                                            <td>
                                                                <input class="form-control col-md-7 col-xs-12" name="fri2" id="fri2" value="<?php echo isset($forms2->fri2) ? $forms2->fri2 : ''; ?>" placeholder="" type="text" autocomplete="off">
                                                                <div class="help-block"><?php echo form_error('18ii'); ?></div>
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <input class="form-control col-md-7 col-xs-12" name="time3_from" id="edit_time3_from" value="<?php echo isset($forms2->time3_from) ? $forms2->time3_from : ''; ?>" placeholder="" type="text" autocomplete="off">
                                                                <div class="help-block"><?php echo form_error('18i'); ?></div>
                                                            </td>
															<td>
                                                                <input class="form-control col-md-7 col-xs-12" name="time3_to" id="edit_time3_to" value="<?php echo isset($forms2->time3_to) ? $forms2->time3_to : ''; ?>" placeholder="" type="text" autocomplete="off">
                                                                <div class="help-block"><?php echo form_error('18i'); ?></div>
                                                            </td>
                                                            <td>
                                                                <input class="form-control col-md-7 col-xs-12" name="mon3" id="mon3" value="<?php echo isset($forms2->mon3) ? $forms2->mon3 : ''; ?>" placeholder="" type="text" autocomplete="off">
                                                                <div class="help-block"><?php echo form_error('18i'); ?></div>
                                                            </td>
                                                            <td>
                                                                <input class="form-control col-md-7 col-xs-12" name="tues3" id="tues3" value="<?php echo isset($forms2->tues3) ? $forms2->tues3 : ''; ?>" placeholder="" type="text" autocomplete="off">
                                                                <div class="help-block"><?php echo form_error('18i'); ?></div>
                                                            </td>

                                                            <td>
                                                                <input class="form-control col-md-7 col-xs-12" name="wend3" id="wend3" value="<?php echo isset($forms2->wend3) ? $forms2->wend3 : ''; ?>" placeholder="" type="text" autocomplete="off">
                                                                <div class="help-block"><?php echo form_error('18ii'); ?></div>
                                                            </td>
                                                            <td>
                                                                <input class="form-control col-md-7 col-xs-12" name="thur3" id="thur3" value="<?php echo isset($forms2->thur3) ? $forms2->thur3 : ''; ?>" placeholder="" type="text" autocomplete="off">
                                                                <div class="help-block"><?php echo form_error('18ii'); ?></div>
                                                            </td>
                                                            <td>
                                                                <input class="form-control col-md-7 col-xs-12" name="fri3" id="fri3" value="<?php echo isset($forms2->fri3) ? $forms2->fri3 : ''; ?>" placeholder="" type="text" autocomplete="off">
                                                                <div class="help-block"><?php echo form_error('18ii'); ?></div>
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <input class="form-control col-md-7 col-xs-12" name="time4_from" id="edit_time4_from" value="<?php echo isset($forms2->time4_from) ? $forms2->time4_from : ''; ?>" placeholder="" type="text" autocomplete="off">
                                                                <div class="help-block"><?php echo form_error('18i'); ?></div>
                                                            </td>
															<td>
                                                                <input class="form-control col-md-7 col-xs-12" name="time4_to" id="edit_time4_to" value="<?php echo isset($forms2->time4_to) ? $forms2->time4_to : ''; ?>" placeholder="" type="text" autocomplete="off">
                                                                <div class="help-block"><?php echo form_error('18i'); ?></div>
                                                            </td>
                                                            <td>
                                                                <input class="form-control col-md-7 col-xs-12" name="mon4" id="mon4" value="<?php echo isset($forms2->mon4) ? $forms2->mon4 : ''; ?>" placeholder="" type="text" autocomplete="off">
                                                                <div class="help-block"><?php echo form_error('18i'); ?></div>
                                                            </td>
                                                            <td>
                                                                <input class="form-control col-md-7 col-xs-12" name="tues4" id="tues4" value="<?php echo isset($forms2->tues4) ? $forms2->tues4 : ''; ?>" placeholder="" type="text" autocomplete="off">
                                                                <div class="help-block"><?php echo form_error('18i'); ?></div>
                                                            </td>

                                                            <td>
                                                                <input class="form-control col-md-7 col-xs-12" name="wend4" id="wend4" value="<?php echo isset($forms2->wend4) ? $forms2->wend4 : ''; ?>" placeholder="" type="text" autocomplete="off">
                                                                <div class="help-block"><?php echo form_error('18ii'); ?></div>
                                                            </td>
                                                            <td>
                                                                <input class="form-control col-md-7 col-xs-12" name="thur4" id="thur4" value="<?php echo isset($forms2->thur4) ? $forms2->thur4 : ''; ?>" placeholder="" type="text" autocomplete="off">
                                                                <div class="help-block"><?php echo form_error('18ii'); ?></div>
                                                            </td>
                                                            <td>
                                                                <input class="form-control col-md-7 col-xs-12" name="fri4" id="fri4" value="<?php echo isset($forms2->fri4) ? $forms2->fri4 : ''; ?>" placeholder="" type="text" autocomplete="off">
                                                                <div class="help-block"><?php echo form_error('18ii'); ?></div>
                                                            </td>
                                                        </tr>
                                                        ...
                                                        <tr>
                                                            <td>05</td>
                                                            <td>
                                                                <input class="form-control col-md-7 col-xs-12" name="time5_from" id="edit_time5_from" value="<?php echo isset($forms2->time5_from) ? $forms2->time5_from : ''; ?>" placeholder="" type="text" autocomplete="off">
                                                                <div class="help-block"><?php echo form_error('18i'); ?></div>
                                                            </td>
															<td>
                                                                <input class="form-control col-md-7 col-xs-12" name="time5_to" id="edit_time5_to" value="<?php echo isset($forms2->time5_to) ? $forms2->time5_to : ''; ?>" placeholder="" type="text" autocomplete="off">
                                                                <div class="help-block"><?php echo form_error('18i'); ?></div>
                                                            </td>
                                                            <td>
                                                                <input class="form-control col-md-7 col-xs-12" name="mon5" id="mon5" value="<?php echo isset($forms2->mon5) ? $forms2->mon5 : ''; ?>" placeholder="" type="text" autocomplete="off">
                                                                <div class="help-block"><?php echo form_error('18i'); ?></div>
                                                            </td>
                                                            <td>
                                                                <input class="form-control col-md-7 col-xs-12" name="tues5" id="tues5" value="<?php echo isset($forms2->tues5) ? $forms2->tues5 : ''; ?>" placeholder="" type="text" autocomplete="off">
                                                                <div class="help-block"><?php echo form_error('18i'); ?></div>
                                                            </td>

                                                            <td>
                                                                <input class="form-control col-md-7 col-xs-12" name="wend5" id="wend5" value="<?php echo isset($forms2->wend5) ? $forms2->wend5 : ''; ?>" placeholder="" type="text" autocomplete="off">
                                                                <div class="help-block"><?php echo form_error('18ii'); ?></div>
                                                            </td>
                                                            <td>
                                                                <input class="form-control col-md-7 col-xs-12" name="thur5" id="thur5" value="<?php echo isset($forms2->thur5) ? $forms2->thur5 : ''; ?>" placeholder="" type="text" autocomplete="off">
                                                                <div class="help-block"><?php echo form_error('18ii'); ?></div>
                                                            </td>
                                                            <td>
                                                                <input class="form-control col-md-7 col-xs-12" name="fri5" id="fri5" value="<?php echo isset($forms2->fri5) ? $forms2->fri5 : ''; ?>" placeholder="" type="text" autocomplete="off">
                                                                <div class="help-block"><?php echo form_error('18ii'); ?></div>
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                            <td>06</td>
                                                             <td>
                                                                <input class="form-control col-md-7 col-xs-12" name="time6_from" id="edit_time6_from" value="<?php echo isset($forms2->time6_from) ? $forms2->time6_from : ''; ?>" placeholder="" type="text" autocomplete="off">
                                                                <div class="help-block"><?php echo form_error('18i'); ?></div>
                                                            </td>
															<td>
                                                                <input class="form-control col-md-7 col-xs-12" name="time6_to" id="edit_time6_to" value="<?php echo isset($forms2->time6_to) ? $forms2->time6_to : ''; ?>" placeholder="" type="text" autocomplete="off">
                                                                <div class="help-block"><?php echo form_error('18i'); ?></div>
                                                            </td>
                                                            <td>
                                                                <input class="form-control col-md-7 col-xs-12" name="mon6" id="mon6" value="<?php echo isset($forms2->mon6) ? $forms2->mon6 : ''; ?>" placeholder="" type="text" autocomplete="off">
                                                                <div class="help-block"><?php echo form_error('18i'); ?></div>
                                                            </td>
                                                            <td>
                                                                <input class="form-control col-md-7 col-xs-12" name="tues6" id="tues6" value="<?php echo isset($forms2->tues6) ? $forms2->tues6 : ''; ?>" placeholder="" type="text" autocomplete="off">
                                                                <div class="help-block"><?php echo form_error('18i'); ?></div>
                                                            </td>

                                                            <td>
                                                                <input class="form-control col-md-7 col-xs-12" name="wend6" id="wend6" value="<?php echo isset($forms2->wend6) ? $forms2->wend6 : ''; ?>" placeholder="" type="text" autocomplete="off">
                                                                <div class="help-block"><?php echo form_error('18ii'); ?></div>
                                                            </td>
                                                            <td>
                                                                <input class="form-control col-md-7 col-xs-12" name="thur6" id="thur6" value="<?php echo isset($forms2->thur6) ? $forms2->thur3 : ''; ?>" placeholder="" type="text" autocomplete="off">
                                                                <div class="help-block"><?php echo form_error('18ii'); ?></div>
                                                            </td>
                                                            <td>
                                                                <input class="form-control col-md-7 col-xs-12" name="fri6" id="fri6" value="<?php echo isset($forms2->fri6) ? $forms2->fri6 : ''; ?>" placeholder="" type="text" autocomplete="off">
                                                                <div class="help-block"><?php echo form_error('18ii'); ?></div>
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                            <td>07</td>
                                                             <td>
                                                                <input class="form-control col-md-7 col-xs-12" name="time7_from" id="edit_time7_from" value="<?php echo isset($forms2->time7_from) ? $forms2->time7_from : ''; ?>" placeholder="" type="text" autocomplete="off">
                                                                <div class="help-block"><?php echo form_error('18i'); ?></div>
                                                            </td>
															<td>
                                                                <input class="form-control col-md-7 col-xs-12" name="time7_to" id="edit_time7_to" value="<?php echo isset($forms2->time7_to) ? $forms2->time7_to : ''; ?>" placeholder="" type="text" autocomplete="off">
                                                                <div class="help-block"><?php echo form_error('18i'); ?></div>
                                                            </td>
                                                            <td>
                                                                <input class="form-control col-md-7 col-xs-12" name="mon7" id="mon7" value="<?php echo isset($forms2->mon7) ? $forms2->mon7 : ''; ?>" placeholder="" type="text" autocomplete="off">
                                                                <div class="help-block"><?php echo form_error('18i'); ?></div>
                                                            </td>
                                                            <td>
                                                                <input class="form-control col-md-7 col-xs-12" name="tues7" id="tues7" value="<?php echo isset($forms2->tues7) ? $forms2->tues7 : ''; ?>" placeholder="" type="text" autocomplete="off">
                                                                <div class="help-block"><?php echo form_error('18i'); ?></div>
                                                            </td>

                                                            <td>
                                                                <input class="form-control col-md-7 col-xs-12" name="wend7" id="wend7" value="<?php echo isset($forms2->wend7) ? $forms2->wend7 : ''; ?>" placeholder="" type="text" autocomplete="off">
                                                                <div class="help-block"><?php echo form_error('18ii'); ?></div>
                                                            </td>
                                                            <td>
                                                                <input class="form-control col-md-7 col-xs-12" name="thur7" id="thur7" value="<?php echo isset($forms2->thur7) ? $forms2->thur7 : ''; ?>" placeholder="" type="text" autocomplete="off">
                                                                <div class="help-block"><?php echo form_error('18ii'); ?></div>
                                                            </td>
                                                            <td>
                                                                <input class="form-control col-md-7 col-xs-12" name="fri7" id="fri7" value="<?php echo isset($forms2->fri7) ? $forms2->fri7 : ''; ?>" placeholder="" type="text" autocomplete="off">
                                                                <div class="help-block"><?php echo form_error('18ii'); ?></div>
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                            <td>08</td>
                                                             <td>
                                                                <input class="form-control col-md-7 col-xs-12" name="time8_from" id="edit_time8_from" value="<?php echo isset($forms2->time8_from) ? $forms2->time8_from : ''; ?>" placeholder="" type="text" autocomplete="off">
                                                                <div class="help-block"><?php echo form_error('18i'); ?></div>
                                                            </td>
															<td>
                                                                <input class="form-control col-md-7 col-xs-12" name="time8_to" id="edit_time8_to" value="<?php echo isset($forms2->time8_to) ? $forms2->time8_to : ''; ?>" placeholder="" type="text" autocomplete="off">
                                                                <div class="help-block"><?php echo form_error('18i'); ?></div>
                                                            </td>
                                                            <td>
                                                                <input class="form-control col-md-7 col-xs-12" name="mon8" id="mon8" value="<?php echo isset($forms2->mon8) ? $forms2->mon8 : ''; ?>" placeholder="" type="text" autocomplete="off">
                                                                <div class="help-block"><?php echo form_error('18i'); ?></div>
                                                            </td>
                                                            <td>
                                                                <input class="form-control col-md-7 col-xs-12" name="tues8" id="tues8" value="<?php echo isset($forms2->tues8) ? $forms2->tues8 : ''; ?>" placeholder="" type="text" autocomplete="off">
                                                                <div class="help-block"><?php echo form_error('18i'); ?></div>
                                                            </td>

                                                            <td>
                                                                <input class="form-control col-md-7 col-xs-12" name="wend8" id="wend8" value="<?php echo isset($forms2->wend8) ? $forms2->wend8 : ''; ?>" placeholder="" type="text" autocomplete="off">
                                                                <div class="help-block"><?php echo form_error('18ii'); ?></div>
                                                            </td>
                                                            <td>
                                                                <input class="form-control col-md-7 col-xs-12" name="thur8" id="thur8" value="<?php echo isset($forms2->thur8) ? $forms2->thur8 : ''; ?>" placeholder="" type="text" autocomplete="off">
                                                                <div class="help-block"><?php echo form_error('18ii'); ?></div>
                                                            </td>
                                                            <td>
                                                                <input class="form-control col-md-7 col-xs-12" name="fri8" id="fri8" value="<?php echo isset($forms2->fri8) ? $forms2->fri8 : ''; ?>" placeholder="" type="text" autocomplete="off">
                                                                <div class="help-block"><?php echo form_error('18ii'); ?></div>
                                                            </td>
                                                        </tr>
                                                    </table>
                                    ...
                                    <div class="item form-group">
                                       ...
                                       <!--NOT WORKING-->
                                        <div class="row" style="font-size: 16px;">
                                            ...
                                            <div class="col-md-7 col-sm-2 col-xs-12">
                                                <div class="item form-group">
													...
													<textarea  class="form-control col-md-7 col-xs-12 textarea-4column"  name="additional_appointment"  id="additional_appointment" placeholder="<?php echo $this->lang->line('text251'); ?>" type="text" autocomplete="off"><?php echo isset($forms2->additional_appointment) ? $forms2->additional_appointment : ''; ?> </textarea>
                                                    <div class="help-block"><?php echo form_error('additional_appointment'); ?></div>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="row" style="font-size: 16px;">
                                            ...
                                            <div class="col-md-5 col-sm-2 col-xs-12">
                                                <div class="item form-group">
                                                    <input  class="form-control col-md-7 col-xs-12"  name="piriven_teacher_name"  id="piriven_teacher_name" value="<?php echo isset($forms2->piriven_teacher_name) ? $forms2->piriven_teacher_name : ''; ?>" placeholder="" type="text" autocomplete="off">
                                                    <div class="help-block"><?php echo form_error('applicant_s_name'); ?></div>
                                                </div>
                                            </div>
                                        ...
                                        <div class="row" style="font-size: 16px;">
                                            ...
                                            <div class="col-md-5 col-sm-2 col-xs-12">
                                                <div class="item form-group">
                                                    <textarea  class="form-control col-md-7 col-xs-12 textarea-4column" name="jobtitle_subject"  id="jobtitle_subject" placeholder="<?php echo $this->lang->line('text253'); ?>" type="text" autocomplete="off"><?php echo isset($forms2->jobtitle_subject) ? $forms2->jobtitle_subject : ''; ?> </textarea>
                                                    <div class="help-block"><?php echo form_error('jobtitle_subject'); ?></div>
                                                </div>
                                            </div>
                                        ...
                                        <div class="row" style="font-size: 16px;">
                                            ...
                                            <div class="col-md-7 col-sm-2 col-xs-12">
                                                <div class="item form-group">
                                                    <textarea  class="form-control col-md-7 col-xs-12 textarea-4column" name="highedu_subjects"  id="highedu_subjects" placeholder="<?php echo $this->lang->line('text254'); ?>" type="text" autocomplete="off"><?php echo isset($forms2->highedu_subjects) ? $forms2->highedu_subjects : ''; ?> </textarea>
                                                    <div class="help-block"><?php echo form_error('highedu_subjects'); ?></div>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="row" style="font-size: 16px;">
                                            ...
                                            <div class="col-md-5 col-sm-2 col-xs-12">
                                                <div class="item form-group">
                                                    <input  class="form-control col-md-7 col-xs-12"  name="teacher_rej_no"  id="teacher_rej_no" value="<?php echo isset($forms2->teacher_rej_no) ? $forms2->teacher_rej_no : ''; ?>" placeholder="" type="text" autocomplete="off">
                                                    <div class="help-block"><?php echo form_error('applicant_s_name'); ?></div>
                                                </div>
                                            </div>
                                        ...
                                        <div class="row" style="font-size: 16px;">
                                            ...
                                            <div class="col-md-5 col-sm-2 col-xs-12">
                                                <div class="item form-group">
                                                    <input  class="form-control col-md-7 col-xs-12"   type="text" id="edit_datevi" name="datevi" 
														   value="<?php
												 if($forms2->datevi !='1970-01-01'){
													  echo date('d-m-Y', strtotime($forms2->datevi));
												 }
												 else echo ''; ?>"
														   type="text" autocomplete="off">
                                                    <div class="help-block"><?php echo $this->lang->line('datevi'); ?></div>
                                                    ...
                                                    <table id="datatable-responsive" class="table table-striped table-bordered dt-responsive nowrap " cellspacing="0" width="100%" data-toggle="buttons" style="background-color:transparent;border: none ">
                                                        ...
                                                        <tr style="background-color:transparent;border: none ">
                                                            ...
                                                            <td style="background-color:transparent;border: none ">
															 ...
															 <input  class="form-control col-md-7 col-xs-12"  name="termination_service"  id="ts_A" value="Resign voluntarily" <?php if(isset($forms2) && $forms2->termination_service == 'Resign voluntarily'){ echo 'checked="checked"'; } ?>placeholder=""  type="radio" autocomplete="off"></td>
                                     
                                                        </tr>
                                                        <tr style="background-color:transparent;border: none ">
                                                            <td style="background-color:transparent;border: none ">(b)&nbsp;<?php echo $this->lang->line('text259'); ?></td>
                                                            <td style="background-color:transparent;border: none ">
																<input class="form-control col-md-7 col-xs-12" name="termination_service" id="ts_B" value="Retirement" <?php if(isset($forms2) && $forms2->termination_service == 'Retirement'){ echo 'checked="checked"'; } ?>placeholder="" type="radio" autocomplete="off"></td>
                                                        </tr>
                                                        <tr style="background-color:transparent;border: none ">
                                                            <td style="background-color:transparent;border: none ">(c)&nbsp;<?php echo $this->lang->line('text261'); ?></td>
                                                            <td style="background-color:transparent;border: none ">
																<input class="form-control col-md-7 col-xs-12" name="termination_service" id="ts_C" value="Receiving transfer" <?php if(isset($forms2) && $forms2->termination_service == 'Receiving transfer'){ echo 'checked="checked"'; } ?> placeholder="" type="radio" autocomplete="off"></td>
                                                        </tr>
                                                        <tr style="background-color:transparent;border: none ">
                                                            <td style="background-color:transparent;border: none ">(d)&nbsp;<?php echo $this->lang->line('text262'); ?></td>
                                                            <td style="background-color:transparent;border: none ">
																<input class="form-control col-md-7 col-xs-12" name="termination_service" id="ts_D" value="Interdiction" <?php if(isset($forms2) && $forms2->termination_service == 'Interdiction'){ echo 'checked="checked"'; } ?> placeholder="" type="radio" autocomplete="off"></td>
                                                        </tr>
                                                        <tr style="background-color:transparent;border: none ">
                                                            <td style="background-color:transparent;border: none ">(e)&nbsp;<?php echo $this->lang->line('text263'); ?></td>
                                                            <td style="background-color:transparent;border: none ">
																<input class="form-control col-md-7 col-xs-12" name="termination_service" id="ts_E" value="Death" <?php if(isset($forms2) && $forms2->termination_service == 'Death'){ echo 'checked="checked"'; } ?> placeholder="" type="radio" autocomplete="off"></td>
                                                        </tr>
                                                        <tr style="background-color:transparent;border: none ">
                                                            <td style="background-color:transparent;border: none ">(f)&nbsp;<?php echo $this->lang->line('text264'); ?></td>
                                                            <td style="background-color:transparent;border: none ">
																<input class="form-control col-md-7 col-xs-12" name="termination_service" id="ts_F" value="Disrobe"  <?php if(isset($forms2) && $forms2->termination_service == 'Disrobe'){ echo 'checked="checked"'; } ?>placeholder="" type="radio" autocomplete="off"></td>
                                                        </tr>
                                        ...
                                        <div class="row" style="font-size: 16px;">
                                            ...
                                            <div class="col-md-3 col-sm-2 col-xs-12">
                                                <div class="item form-group">
                                                    <input  class="form-control col-md-7 col-xs-12"   type="text" id="edit_datevii" name="datevii" 
														    value="<?php
												 if($forms2->datevii !='1970-01-01'){
													  echo date('d-m-Y', strtotime($forms2->datevii));
												 }
												 else echo ''; ?>"placeholder=" <?php echo $this->lang->line('date'); ?>" type="text" autocomplete="off">
                                                    <div class="help-block"><?php echo $this->lang->line('datevii'); ?></div>
                                                </div>
                                            </div>
                                        ...
                                        <div class="row" style="font-size: 16px;">
                                            <div class="col-md-6 col-sm-6 col-xs-12">
                                                <div class="item form-group">
                                                    <label for="date_submit"> <?php echo $this->lang->line('date'); ?></label>
                                                    <input  class="form-control col-md-7 col-xs-12"   type="text" id="edit_dateviii" name="dateviii" 
														    value="<?php
												 if($forms2->dateviii !='1970-01-01'){
													  echo date('d-m-Y', strtotime($forms2->dateviii));
												 }
												 else echo ''; ?>"
														   placeholder=" <?php echo $this->lang->line('date'); ?>" type="text" required="required" autocomplete="off">
                                                    <div class="help-block"><?php echo $this->lang->line('dateviii'); ?></div>
                                                </div>
                                            </div>
                                        ...
                                        <div class="col-md-3 col-sm-3 col-xs-12">
                                            <div class="item form-group">
                                                <input type="hidden" name="prev_t2_kruthy_sig1" id="prev_t2_kruthy_sig1" value="<?php echo $forms2->t2_kruthy_sig1; ?>" />
                                                <?php if ($forms2->t2_kruthy_sig1) { ?>
                                                    <img src="<?php echo UPLOAD_PATH; ?>/form/<?php echo $forms2->t2_kruthy_sig1; ?>" alt="" width="70" /><br/><br/>
                                                <?php } ?>
                                            </div>
                                        </div>
                                                    <div class="help-block"><?php echo form_error('k_approval1'); ?></div>
                                    ...
                                    <div class="tab-pane fade in" id="edit_tab_sec">
                                        ...
                                        <div class="row" style="font-size: 16px;">
                                            ...
                                            <div class="col-md-3 col-sm-2 col-xs-12" style="margin-left: 0px; margin-right: 0px;">
                                                <div class="item form-group">
                                                    <input  class="form-control col-md-7 col-xs-12" name="kcount"  id="kcount" value="<?php echo isset($forms3->kcount) ? $forms3->kcount : ''; ?>" placeholder="<?php echo $this->lang->line('count1'); ?>"  type="number" autocomplete="off">
                                                    <div class="help-block"><?php echo form_error('piriven_name1'); ?></div>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="row" style="font-size: 16px;">
                                            <div class="col-md-6 col-sm-6 col-xs-12">
                                                <div class="item form-group">
                                                    <label for="date_submit"> <?php echo $this->lang->line('date'); ?></label>
                                                    <input  class="form-control col-md-7 col-xs-12"   type="text" id="edit_dateix" name="dateix" 
														    value="<?php
												 if($forms3->dateix !='1970-01-01') {
													 echo date('d-m-Y', strtotime($forms3->dateix));
												 } 
												 else echo ''; ?>" 
                                                    <div class="help-block"><?php echo $this->lang->line('dateix'); ?></div>
                                                </div>
                                        ...
                                        <div class="col-md-3 col-sm-3 col-xs-12">
                                            <div class="item form-group">
                                                <input type="hidden" name="prev_officer_sig1" id="prev_officer_sig1" value="<?php echo $forms3->officer_sig1; ?>" />
                                                <?php if ($forms3->officer_sig1) { ?>
                                                    <img src="<?php echo UPLOAD_PATH; ?>/form/<?php echo $forms3->officer_sig1; ?>" alt="" width="70" /><br/><br/>
                                                <?php } ?>
                                            </div>
                                        </div>
                                            ...
                                            <div class="col-md-6 col-sm-6 col-xs-12">
                                                <div class="item form-group">
                                                    ...
                                                    <div class="btn btn-default btn-file">
                                                        <i class="fa fa-paperclip"></i> <?php echo $this->lang->line('upload'); ?>
                                                        <input  class="form-control col-md-7 col-xs-12"  name="zonal_sig1"  id="zonal_sig1"  type="file">
														<input type="hidden" name="prev_zonal_sig1" id="prev_zonal_sig1" value="<?php echo $forms3->zonal_sig1; ?>" />
                                                <?php if ($forms3->zonal_sig1) { ?>
                                                    <img src="<?php echo UPLOAD_PATH; ?>/form/<?php echo $forms3->zonal_sig1; ?>" alt="" width="70" /><br/><br/>
                                                <?php } ?>
                                                    ...
                                                    <div class="btn btn-default btn-file">
                                                        <i class="fa fa-paperclip"></i> <?php echo $this->lang->line('rubber_stamp'); ?>
                                                        <input  class="form-control col-md-7 col-xs-12"  name="zonalstamp_sig2"  id="zonalstamp_sig2"  type="file">
														<input type="hidden" name="prev_zonalstamp_sig2" id="prev_zonalstamp_sig2" value="<?php echo $forms3->zonalstamp_sig2; ?>" />
                                                <?php if ($forms3->zonalstamp_sig2) { ?>
                                                    <img src="<?php echo UPLOAD_PATH; ?>/form/<?php echo $forms3->zonalstamp_sig2; ?>" alt="" width="70" /><br/><br/>
                                                <?php } ?>
                                        ...
                                        <div class="row" style="font-size: 16px;">
                                            ...
                                            <div class="col-md-3 col-sm-2 col-xs-12" style="margin-left: 0px; margin-right: 0px;">
                                                <div class="item form-group">
                                                    <input  class="form-control col-md-7 col-xs-12" name="datex"  id="edit_datex" 
														   value="<?php
												 if($forms3->datex !='1970-01-01') {
													 echo date('d-m-Y', strtotime($forms3->datex));
												 } 
												 else echo ''; ?>" 
														   type="text" autocomplete="off">
                                                    <div class="help-block"><?php echo form_error('datex'); ?></div>
                                        ...
                                        <div class="row" style="font-size: 16px;">
                                            ...
                                            <div class="col-md-3 col-sm-2 col-xs-12" style="margin-left: 0px; margin-right: 0px;">
                                                <div class="item form-group">
                                                    <input  class="form-control col-md-7 col-xs-12" name="zonal_office"  id="zonal_office" value="<?php echo isset($forms3->zonal_office) ? $forms3->zonal_office : ''; ?>" placeholder=""  type="text" autocomplete="off">
                                                    <div class="help-block"><?php echo form_error('zonal_office'); ?></div>
                                                </div>
                                            </div>
                                        ...
                                        <div class="row" style="font-size: 16px;">
                                               ...
                                               <div class="col-md-2 col-sm-2 col-xs-12" style="margin-left: 0px; margin-right: 0px;">
                                                <div class="item form-group">
                                                    <select  class="form-control col-md-7 col-xs-12" name="asst_province_type" id="asst_province_type">
														...
														<?php $asst_province_types = get_en_type(); ?>
                                                    <?php foreach ($asst_province_types as $key => $value) { ?>
                                                        <option value="<?php echo $key; ?>" <?php
                                                        if ($forms3->asst_province_type == $key) {
                                                            echo 'selected="selected"';
                                                        }
                                                        ?>><?php echo $value; ?></option>
                                                            <?php } ?>
                                            ...
                                            <div class="col-md-5 col-sm-2 col-xs-12" style="margin-left: 0px; margin-right: 0px;">
                                                <div class="item form-group">
                                                    <input  class="form-control col-md-7 col-xs-12" name="asst_province_name"  id="asst_province_name" value="<?php echo isset($forms3->asst_province_name) ? $forms3->asst_province_name : ''; ?>" placeholder=""  type="text" autocomplete="off">
                                                    <div class="help-block"><?php echo form_error('asst_province_name'); ?></div>
                                                </div>
                                            </div>
                                        ...
                                        <div class="row" style="font-size: 16px;">
                                            <div class="col-md-6 col-sm-6 col-xs-12">
                                                <div class="item form-group">
                                                    <label for="date_submit"> <?php echo $this->lang->line('date'); ?></label>
                                                    <input  class="form-control col-md-7 col-xs-12"   type="text" id="edit_datexi" name="datexi"
														    value="<?php
												 if($forms3->datexi !='1970-01-01') {
													 echo date('d-m-Y', strtotime($forms3->datexi));
												 } 
												 else echo ''; ?>" 
														   placeholder=" <?php echo $this->lang->line('date'); ?>" type="text" autocomplete="off">
                                                    <div class="help-block"><?php echo $this->lang->line('datexi'); ?></div>
                                            ...
                                            <div class="col-md-6 col-sm-6 col-xs-12">
                                                <div class="item form-group">
                                                    ...
                                                    <div class="btn btn-default btn-file">
                                                        <i class="fa fa-paperclip"></i> <?php echo $this->lang->line('upload'); ?>
                                                        <input  class="form-control col-md-7 col-xs-12"  name="asst_province_sig1"  id="asst_province_sig1"  type="file">
														<input type="hidden" name="prev_asst_province_sig1" id="prev_asst_province_sig1" value="<?php echo $forms3->asst_province_sig1; ?>" />
                                                <?php if ($forms3->asst_province_sig1) { ?>
                                                    <img src="<?php echo UPLOAD_PATH; ?>/form/<?php echo $forms3->asst_province_sig1; ?>" alt="" width="70" /><br/><br/>
                                                <?php } ?>
                                                    </div>
                                                    ...
                                                    <div class="btn btn-default btn-file">
														...
														<input type="hidden" name="prev_asst_provincestamp_sig2" id="prev_asst_provincestamp_sig2" value="<?php echo $forms3->asst_provincestamp_sig2; ?>" />
                                                <?php if ($forms3->asst_provincestamp_sig2) { ?>
                                                    <img src="<?php echo UPLOAD_PATH; ?>/form/<?php echo $forms3->asst_provincestamp_sig2; ?>" alt="" width="70" /><br/><br/>
                                                <?php } ?>
                                                    </div>
                                                    <div class="text-info" style="font-size: 14px;"><?php echo $this->lang->line('valid_file_format_img'); ?></div>
                                                    <div class="help-block"><?php echo form_error('text284'); ?></div>
                                    ...
                                    <div class="tab-pane fade in" id="edit_tab_third">
                                        ...
                                        <div class="row" style="font-size: 16px;">
                                            ...
                                            <div class="col-md-6 col-sm-6 col-xs-12">
                                                <div class="item form-group">
                                                    <label for="date_submit"> <?php echo $this->lang->line('date'); ?></label>
                                                    <input  class="form-control col-md-7 col-xs-12"   type="text" id="edit_datexii" name="datexii" 
														    value="<?php
												 if($forms3->datexii !='1970-01-01') {
													 echo date('d-m-Y', strtotime($forms3->datexii));
												 } 
												 else echo ''; ?>" 
														   type="text" autocomplete="off">
                                                    <div class="help-block"><?php echo $this->lang->line('datexii'); ?></div>
                                            ...
                                            <div class="col-md-6 col-sm-6 col-xs-12">
                                                <div class="item form-group">
													...
													<input type="hidden" name="prev_edu_clerk_sig1" id="prev_edu_clerk_sig1" value="<?php echo $forms3->edu_clerk_sig1; ?>" />
                                                <?php if ($forms3->edu_clerk_sig1) { ?>
                                                    <img src="<?php echo UPLOAD_PATH; ?>/form/<?php echo $forms3->edu_clerk_sig1; ?>" alt="" width="70" /><br/><br/>
                                                <?php } ?>
                                      ...
                                      <div class="ln_solid"></div>
                                        ...
                                        <div class="row" style="font-size: 16px;">
                                            ...
                                            <div class="col-md-6 col-sm-6 col-xs-12">
                                                <div class="item form-group">
                                                    <label for="date_submit"> <?php echo $this->lang->line('date'); ?></label>
                                                    <input  class="form-control col-md-7 col-xs-12"   type="text" id="edit_datexiii" name="datexiii" 
														    value="<?php
												 if($forms3->datexiii !='1970-01-01') {
													 echo date('d-m-Y', strtotime($forms3->datexiii));
												 } 
												 else echo ''; ?>" 
														   placeholder=" <?php echo $this->lang->line('date'); ?>" type="text" autocomplete="off">
                                                    <div class="help-block"><?php echo $this->lang->line('datexiii'); ?></div>
                                            ...
                                            <div class="col-md-6 col-sm-6 col-xs-12">
                                                <div class="item form-group">
													...
													<input type="hidden" name="prev_asdic_sig" id="prev_asdic_sig" value="<?php echo $forms3->asdic_sig; ?>" />
                                                <?php if ($forms3->asdic_sig) { ?>
                                                    <img src="<?php echo UPLOAD_PATH; ?>/form/<?php echo $forms3->asdic_sig; ?>" alt="" width="70" /><br/><br/>
                                                <?php } ?>
                                        ...
                                        <div class="row" style="font-size: 16px;">
                                            ...
                                            <div class="col-md-6 col-sm-6 col-xs-12">
                                                <div class="item form-group">
                                                    <label for="date_submit"> <?php echo $this->lang->line('date'); ?></label>
                                                    <input  class="form-control col-md-7 col-xs-12"   type="text" id="edit_datexiv" name="datexiv" 
														    value="<?php
												 if($forms3->datexiv !='1970-01-01') {
													 echo date('d-m-Y', strtotime($forms3->datexiv));
												 } 
												 else echo ''; ?>" 
														   placeholder=" <?php echo $this->lang->line('date'); ?>" type="text" autocomplete="off">
                                                    <div class="help-block"><?php echo $this->lang->line('datexiv'); ?></div>
                                            ...
                                            <div class="col-md-6 col-sm-6 col-xs-12">
                                                <div class="item form-group">
													...
													<input type="hidden" name="prev_commitee_mem_sig" id="prev_commitee_mem_sig" value="<?php echo $forms3->commitee_mem_sig; ?>" />
                                                <?php if ($forms3->commitee_mem_sig) { ?>
                                                    <img src="<?php echo UPLOAD_PATH; ?>/form/<?php echo $forms3->commitee_mem_sig; ?>" alt="" width="70" /><br/><br/>
                                                <?php } ?>
                                        ...
                                        <div class="row" style="font-size: 16px;">
                                            ...
                                            <div class="col-md-8 col-sm-2 col-xs-12">
                                                <div class="item form-group">
                                                    <textarea  class="form-control col-md-7 col-xs-12 textarea-4column"  name="min_note"  id="min_note" placeholder="<?php echo $this->lang->line('text294'); ?>" type="text" autocomplete="off"><?php echo isset($forms3->min_note) ? $forms3->min_note : ''; ?> </textarea>
                                                    <div class="help-block"><?php echo form_error('min_note'); ?></div>
                                                </div>
                                            </div>
                                        </div>
                                         ...
                                         <div class="row" style="font-size: 16px;">
                                            ...
                                            <div class="col-md-6 col-sm-6 col-xs-12">
                                                <div class="item form-group">
                                                    <label for="date_submit"> <?php echo $this->lang->line('date'); ?></label>
                                                    <input  class="form-control col-md-7 col-xs-12"   type="text" id="edit_datexv" name="datexv" 
														   value="<?php
												 if($forms3->datexv !='1970-01-01') {
													 echo date('d-m-Y', strtotime($forms3->datexv));
												 } 
												 else echo ''; ?>" 
														   placeholder=" <?php echo $this->lang->line('date'); ?>" type="text" autocomplete="off">
                                                    <div class="help-block"><?php echo $this->lang->line('datexv'); ?></div>
                                            ...
                                            <div class="col-md-6 col-sm-6 col-xs-12">
                                                <div class="item form-group">
													...
													<input type="hidden" name="prev_min_director_sig" id="prev_min_director_sig" value="<?php echo $forms3->min_director_sig; ?>" />
                                                <?php if ($forms3->min_director_sig) { ?>
                                                    <img src="<?php echo UPLOAD_PATH; ?>/form/<?php echo $forms3->min_director_sig; ?>" alt="" width="70" /><br/><br/>
                                                <?php } ?>
                                                </div>
                                            </div>
                                        </div>
                                            ...
                                            <div class="row" style="font-size: 16px; margin: 0px 2px">
                                                ...
                                                <div class="col-md-6 col-sm-6 col-xs-12">
                                                    <div class="item form-group">
                                                        ...
                                                        <div class="col-md-6 col-sm-2 col-xs-12" style="margin-left: 0px; margin-right: 0px;">
                                                            <div class="item form-group">
                                                                <input  class="form-control col-md-7 col-xs-12"   type="text" id="edit_received_datexvi" name="received_datexvi" 
																	    value="<?php
												 if($forms3->received_datexvi !='1970-01-01') {
													 echo date('d-m-Y', strtotime($forms3->received_datexvi));
												 } 
												 else echo ''; ?>"   
																	   type="text" autocomplete="off">
                                                                <div class="help-block"><?php echo $this->lang->line('received_datexv'); ?></div>
                                                ...
                                                <div class="col-md-6 col-sm-6 col-xs-12">
                                                    <div class="item form-group">
                                                        ...
                                                        <div class="col-md-8 col-sm-2 col-xs-12" style="margin-left: 0px; margin-right: 0px;">
                                                            <div class="item form-group">
                                                                <input  class="form-control col-md-7 col-xs-12" name="sub_no"  id="sub_no" value="<?php echo isset($forms3->sub_no) ? $forms3->sub_no : ''; ?>" placeholder=""  type="text" autocomplete="off">
                                                                <div class="help-block"><?php echo form_error('sub_no'); ?></div>
                                                            </div>
                                                        </div>
                                                    </div>
                                            ...
                                            <div class="row" style="font-size: 16px; margin: 0px 2px">
                                                    ...
                                                    <div class="item form-group">
                                                        ...
                                                        <div class="col-md-6 col-sm-2 col-xs-12" style="margin-left: 0px; margin-right: 0px;">
                                                            <div class="item form-group">
																...
																<input type="hidden" name="prev_accepted_sig1" id="prev_accepted_sig1" value="<?php echo $forms3->accepted_sig1; ?>" />
                                                <?php if ($forms3->accepted_sig1) { ?>
                                                    <img src="<?php echo UPLOAD_PATH; ?>/form/<?php echo $forms3->accepted_sig1; ?>" alt="" width="70" /><br/><br/>
                                                <?php } ?>
                                                ...
                                                <div class="col-md-6 col-sm-6 col-xs-12">
                                                    <div class="item form-group">
                                                        ...
                                                        <div class="col-md-8 col-sm-2 col-xs-12" style="margin-left: 0px; margin-right: 0px;">
                                                            <div class="item form-group">
                                                                <textarea  class="form-control col-md-7 col-xs-12 textarea-5column"  name="reply"  id="reply" placeholder="<?php echo $this->lang->line('text300'); ?>" type="text" autocomplete="off"><?php echo isset($forms3->reply) ? $forms3->reply : ''; ?> </textarea>
                                                                <div class="help-block"><?php echo form_error('reply'); ?></div>
                                                            </div>
                                                        </div>
                                                    </div>
...
<script type="text/javascript">
    ...
    $('#edit_datex').datepicker({startView: 2});
    $('#edit_datexi').datepicker({startView: 2});
    $('#edit_datexii').datepicker({startView: 2});
    $('#edit_datexiii').datepicker({startView: 2});
    $('#edit_datexiv').datepicker({startView: 2});
    $('#edit_datexv').datepicker({startView: 2});
    $('#edit_received_datexvi').datepicker({startView: 2});
	
	$('#edit_datehi').datepicker({startView: 2});
    $('#edit_datehii').datepicker({startView: 2});
	...
	$('#edit_time1_from').timepicker();
    $('#edit_time1_to').timepicker();
    $('#edit_time2_from').timepicker();
    $('#edit_time2_to').timepicker();
    $('#edit_time3_from').timepicker();
    $('#edit_time3_to').timepicker();
    $('#edit_time4_from').timepicker();
    $('#edit_time4_to').timepicker();
    $('#edit_time5_from').timepicker();
    $('#edit_time5_to').timepicker();
    $('#edit_time6_from').timepicker();
    $('#edit_time6_to').timepicker();
    $('#edit_time7_from').timepicker();
    $('#edit_time7_to').timepicker();
    $('#edit_time8_from').timepicker();
    $('#edit_time8_to').timepicker();
...
<script type="text/javascript">
    function edit_more(fn_stop_container) {
        var data = '<tr>'
                + '<td>'
               /* + '<input  class="form-control col-md-12 col-xs-12" type="text" name="working_place[]" class="answer" placeholder="<?php echo $this->lang->line('text225'); ?>" />'*/
		        + '<input  class="form-control col-md-12 col-xs-12"  data-row-id="' + row_id + '" style="width:auto;" type="text" name="working_place[]" id="edit_working_place' + row_id + '" value="" placeholder="<?php echo $this->lang->line('text225'); ?>"/>'
                + '</td>'
                + '<td>'
                + '<input  class="form-control col-md-12 col-xs-12" type="text" name="working_designation[]" value="" placeholder="<?php echo $this->lang->line('text228'); ?>"/>'
                + '</td>'
...
$(document).ready(function(){
    $('#yes_no').on('change', function(){
    	var demovalue = $(this).val(); 
        $("div.edityesOnly").hide();
        $("#editshowyes"+demovalue).show();
    });
});
	</script>
