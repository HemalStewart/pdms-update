                         ...
                         <div class="tab-pane fade in active"id="tab_setting">
                            ...
                            <div class="x_content"> 
                                            ...
                                            <select  class="form-control col-md-7 col-xs-12"  name="language" id="language" required="required">
                                                ...
                                                <option value="" >--<?php echo $this->lang->line('select'); ?>--</option>
                                                 ...
                                                 <?php foreach($fields as $field){ ?>
                                                    ...
                                                    <?php  if($field == 'id' || $field == 'label'|| $field == 'tamil'|| $field == 'mylang'){ continue; } ?>
                               ...
                               <!-- <div class="row">
                                ...
                                <div class="row">
    <div class="col-md-12 col-sm-12 col-xs-12">
        <h5 class="column-title"><strong>Bank Details:</strong></h5>
    </div>
</div>
<div class="row">
    <div class="col-md-12 col-sm-12 col-xs-12">
        <h6 class="column-title"><strong>Piriven development fund:</strong></h6>
    </div>
</div>
<div class="row">
    <div class="col-md-3 col-sm-3 col-xs-12">
...
<div class="row">
    <div class="col-md-12 col-sm-12 col-xs-12">
        <h6 class="column-title"><strong>Kruthydhikari Account:</strong></h6>
    </div>
</div>
<div class="row">
    <div class="col-md-3 col-sm-3 col-xs-12">
