                ...
                <div class="" data-example-id="togglable-tabs">
                    ...
                    <div class="tab-content">
                        ...
                        ?>" id="tab_teacherapplication_list" >
                           ...
                           <?php echo form_open(site_url('formskruthy/formsapply/teacherapplicationformadd'), array('name' => 'add', 'id' => 'add', 'class' => 'form-horizontal form-label-left', 'enctype' => 'multipart/form-data'), ''); ?>
                                    ...
                                    <div class="tab-pane fade in active" id="tab_zero">
                                            ...
                                            <div class="col-md-2 col-sm-2 col-xs-12" style="margin-left: 0px; margin-right: 0px;">
                                                <div class="item form-group">
                                                    <select  class="form-control col-md-7 col-xs-12" name="type" id="type" required="required">
                                                        ...
                                                        <option value="පූජ්‍ය." <?php
                                                        if (isset($post['type']) && $post['type'] == 'reverend') {
                                                            echo 'selected="selected"';
                                                        }
                                                        ?>><?php echo $this->lang->line('reverend1'); ?></option>
                                                        <option value="මයා." <?php
                                                        if (isset($post['type']) && $post['type'] == 'mr') {
                                                            echo 'selected="selected"';
                                                        }
                                                        ?>><?php echo $this->lang->line('mr1'); ?></option> 
                                                    </select>
                                                    </select>
									   ...
									   <div class="row" style="font-size: 16px;">
                                        ...
                                        <div class="row" style="font-size: 16px;">
                                            ...
                                            <div class="col-md-5 col-sm-2 col-xs-12">
                                                <div class="item form-group">
                                                    <input  class="form-control col-md-7 col-xs-12"  name="e-mail"  id="e-mail" value="<?php echo isset($post['e-mail']) ? $post['e-mail'] : ''; ?>" placeholder="" type="text" autocomplete="off">
                                ...
                                <div class="form-group">
                                    <div class="col-md-6 col-md-offset-3">
                                        ...
                                        <a  href="<?php echo site_url('formskruthy/formsapply/teacherapplicationform'); ?>"  class="btn btn-primary"><?php echo $this->lang->line('cancel'); ?></a>
...
<?php echo form_close(); ?>
                            ...
                            <?php echo form_open_multipart(site_url('formskruthy/formsapply/teacherapplicationformedit/' . $forms->id), array('name' => 'edit', 'id' => 'edit', 'class' => 'form-horizontal form-label-left'), ''); ?>
