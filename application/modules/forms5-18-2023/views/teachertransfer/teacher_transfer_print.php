...
<head>      
        ...
        <title><?php echo $this->lang->line('teacher_transfer_form'); ?></title>
                        ...
                        <div class="certificate-top">
                           ...
                           <div class="row">
									<div class="col-12" style="text-align:center;">
										<strong><h4 style="font-size:17px;font-weight: 800; text-decoration: underline"><?php echo $this->lang->line('text100'); ?></h4></strong>
								    </div>
                           </div>                            
                        </div>
