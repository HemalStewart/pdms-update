                                            ...
                                            foreach ($teacherapplicationformval as $obj) {
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        ...
                                                        <?php if (has_permission(EDIT, 'forms', 'teacherapplication') && $obj->confirmstatus != 2) { ?>
                                                            <a href="<?php echo site_url('forms/Formsapply/confirm/' . $obj->id); ?>" class="btn btn-warning btn-xs"><i class="fa fa-check-square-o"></i> <?php echo $this->lang->line('confirm'); ?> </a>
                                                        <?php } ?>
