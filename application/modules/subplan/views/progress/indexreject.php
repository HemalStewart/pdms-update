                    ...
                    <div class="tab-content">
                        ...
                        <?php if (isset($edit)) { ?>
                            <div class="tab-pane fade in active" id="tab_edit_route">
                                <div class="x_content"> 
                                    <?php echo form_open(site_url('prozo/progress/confirm/' . $route->id), array('name' => 'edit', 'id' => 'edit', 'class' => 'form-horizontal form-label-left'), ''); ?>
...
<!--                                            <div class="help-block">
                                    ...
                                    <div class="form-group">
                                        <div class="col-md-6 col-md-offset-3">
                                            ...
                                            <a  href="<?php echo site_url('prozo/progress/index'); ?>"  class="btn btn-primary"><?php echo $this->lang->line('cancel'); ?></a>
            ...
            success: function (response) {
                ...
                $.ajax({
                    ...
                    success: function (responsetype) {
                        var data = '<tr>'
                                + '<td style="width:50%;">'
                                + '<input  class="form-control col-md-12 col-xs-12" style="width:auto;" type="date" name="proposed_date[]" id="addproposed_date" class="answer" placeholder="<?php echo $this->lang->line('proposed_date'); ?>" />'
                                + '</td>'
                                + '<td>'
