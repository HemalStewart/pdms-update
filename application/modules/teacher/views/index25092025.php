                                    ...
                                    <div class="row">
                                            ...
                                            <div class="col-md-6 col-sm-6 col-xs-12">
                                                <div class="item form-group">
                                                    ...
                                                    <input
                                                        ...
                                                        autocomplete="off"
                                                        value="<?php echo isset($teacher->cencus_no) ? $teacher->cencus_no : ''; ?>"
                                                    />
                                            ...
                                            <div class="col-md-6 col-sm-6 col-xs-12">
                                                <div class="item form-group">
                                                    ...
                                                    <input
                                                        ...
                                                        autocomplete="off"
                                                        value="<?php echo isset($teacher->school_name) ? $teacher->school_name : ''; ?>"
                                                    />
                                        ...
                                        <div class="row" id="foreign_leave_period" style="display: <?php echo (isset($teacher->termination_reason) && $teacher->termination_reason == 'Foreign leave') ? 'block' : 'none'; ?>;">
                                            <div class="col-md-12 col-sm-12 col-xs-12">
                                                <div class="item form-group">
                                                    ...
                                                    <div class="row">
                                                        <div class="col-md-6">
                                                            <input type="text" class="form-control col-md-7 col-xs-12 datepicker" name="leave_start_date" id="leave_start_date" placeholder="Start Date" value="<?php echo isset($teacher->leave_start_date) ? date('d-m-Y', strtotime($teacher->leave_start_date)) : ''; ?>">
                                                        </div>
                                                        <div class="col-md-6">
                                                            <input type="text" class="form-control col-md-7 col-xs-12 datepicker" name="leave_end_date" id="leave_end_date" placeholder="End Date" value="<?php echo isset($teacher->leave_end_date) ? date('d-m-Y', strtotime($teacher->leave_end_date)) : ''; ?>">
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                        ...
                                        <script>
                                            document.addEventListener('DOMContentLoaded', function() {
                                                ...
                                                const cencusNumberInput = document.getElementById('cencus_number');
                                                const pirivenaNameInput = document.getElementById('pirivena_name');
                                                ...
                                                function toggleBlocks() {
                                                    ...
                                                    cencusNumberInput.value = '';
                                                    pirivenaNameInput.value = '';
