                            ...
                            <div class="tab-pane fade in active" id="tab_edit_teacher">
                                <div class="x_content">
                                    ...
                                    <div class="row">
                                        ...
                                        <!-- TEACHER TRANSFER PART DONE BY HEMAL -->
                                    <?php if (isset($edit) && $this->session->userdata('role_id') == SUPER_ADMIN) { ?>
                                    <div class="row">
                                        <div class="col-md-12 col-sm-12 col-xs-12">
                                            <h5 class="column-title"><strong>Reason for the termination of the service:</strong></h5>
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="col-md-12 col-sm-12 col-xs-12">
                                            <div class="item form-group">
                                                ...
                                                <div class="radio-list">
                                                    <table style="width: 100%; border-collapse: collapse;">
                                                        <tr>
                                                            <td style="width: 25%;">
                                                                <label class="radio-inline">
                                                                    <input type="radio" name="termination_reason" class="termination-radio" id="receiving_transfer_radio" value="Receiving transfer" <?php if(isset($teacher->termination_reason) && $teacher->termination_reason == 'Receiving transfer') echo 'checked'; ?>>
                                                                    Receiving transfer
                                                                </label>
                                                            </td>
                                                            <td style="width: 25%;">
                                                                <label class="radio-inline">
                                                                    <input type="radio" name="termination_reason" class="termination-radio" value="Resign voluntarily" <?php if(isset($teacher->termination_reason) && $teacher->termination_reason == 'Resign voluntarily') echo 'checked'; ?>>
                                                                    Resign voluntarily
                                                                </label>
                                                            </td>
                                                            <td style="width: 25%;">
                                                                <label class="radio-inline">
                                                                    <input type="radio" name="termination_reason" class="termination-radio" value="Retirement" <?php if(isset($teacher->termination_reason) && $teacher->termination_reason == 'Retirement') echo 'checked'; ?>>
                                                                    Retirement
                                                                </label>
                                                            </td>
                                                            <td style="width: 25%;">
                                                                <label class="radio-inline">
                                                                    <input type="radio" name="termination_reason" class="termination-radio" value="Interdiction" <?php if(isset($teacher->termination_reason) && $teacher->termination_reason == 'Interdiction') echo 'checked'; ?>>
                                                                    Interdiction
                                                                </label>
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                            <td style="width: 25%;">
                                                                <label class="radio-inline">
                                                                    <input type="radio" name="termination_reason" class="termination-radio" value="Death" <?php if(isset($teacher->termination_reason) && $teacher->termination_reason == 'Death') echo 'checked'; ?>>
                                                                    Death
                                                                </label>
                                                            </td>
                                                            <td style="width: 25%;">
                                                                <label class="radio-inline">
                                                                    <input type="radio" name="termination_reason" class="termination-radio" value="Disrobe" <?php if(isset($teacher->termination_reason) && $teacher->termination_reason == 'Disrobe') echo 'checked'; ?>>
                                                                    Disrobe
                                                                </label>
                                                            </td>
                                                            <td style="width: 25%;">
                                                                <label class="radio-inline">
                                                                    <input type="radio" name="termination_reason" id="foreign_leave_radio" class="termination-radio" value="Foreign leave" <?php if(isset($teacher->termination_reason) && $teacher->termination_reason == 'Foreign leave') echo 'checked'; ?>>
                                                                    Foreign leave
                                                                </label>
                                                            </td>
                                                            <td style="width: 25%;">
                                                ...
                                                <div class="help-block"><?php echo form_error('termination_reason'); ?></div>
                                            </div>
                                        </div>
                                    </div>
                                    
                                    <div class="row" id="transfer_search_block" style="display: <?php echo (isset($teacher->termination_reason) && $teacher->termination_reason == 'Receiving transfer') ? 'block' : 'none'; ?>;">
                                        <div class="col-md-12 col-sm-12 col-xs-12">
                                            <h5 class="column-title"><strong>Search for Transfer Pirivena:</strong></h5>
                                        </div>
                                        <div class="col-md-6 col-sm-6 col-xs-12">
                                            <div class="item form-group">
                                                <label for="transfer_cencus_number">Census Number</label>
                                                <input
                                                    type="text"
                                                    id="transfer_cencus_number"
                                                    name="cencus_no"
                                        ...
                                        <div class="col-md-6 col-sm-6 col-xs-12">
                                            <div class="item form-group">
                                                <label for="transfer_pirivena_name">Pirivena Name</label>
                                                <input
                                                    type="text"
                                                    id="transfer_pirivena_name"
                                                    name="school_name"
                                                    class="form-control col-md-7 col-xs-12"
                                        ...
                                        <input type="hidden" id="transfer_school_id" name="transfer_school_id" value="" />

                                        <div class="col-md-6 col-sm-6 col-xs-12">
                                            <div class="item form-group">
                                                <label for="transfer_effective_date">Transfer Effective Date <span class="required">*</span></label>
                                                <!-- <input type="text" class="form-control col-md-7 col-xs-12 datepicker" name="transfer_effective_date" id="transfer_effective_date" placeholder="Effective Date" required="required" autocomplete="off"> -->
                                                <input type="text" class="form-control col-md-7 col-xs-12 datepicker" name="transfer_effective_date" id="transfer_effective_date" placeholder="Effective Date" autocomplete="off">
                                                <div class="help-block"><?php echo form_error('transfer_effective_date'); ?></div>
                                            </div>
                                        </div>
                                    </div>

                                    <div class="row" id="foreign_leave_period" style="display: <?php echo (isset($teacher->termination_reason) && $teacher->termination_reason == 'Foreign leave') ? 'block' : 'none'; ?>;">
                                        <div class="col-md-12 col-sm-12 col-xs-12">
                                            <div class="item form-group">
                                                <label for="leave_start_date">Foreign Leave Period</label>
                                                <div class="row">
                                                    <div class="col-md-6">
                                                        <input type="text" class="form-control col-md-7 col-xs-12 datepicker" name="foreign_leave_start_date" id="leave_start_date" placeholder="Start Date" value="<?php echo isset($teacher->foreign_leave_start_date) ? date('d-m-Y', strtotime($teacher->foreign_leave_start_date)) : ''; ?>">
                                                        <?php
    echo (isset($teacher->foreign_leave_start_date) ? "Start Date : " . $teacher->foreign_leave_start_date . "<br>" : '');
?>
                                                    </div>
                                                    <div class="col-md-6">
                                                        <input type="text" class="form-control col-md-7 col-xs-12 datepicker" name="foreign_leave_end_date" id="leave_end_date" placeholder="End Date" value="<?php echo isset($teacher->foreign_leave_end_date) ? date('d-m-Y', strtotime($teacher->foreign_leave_end_date)) : ''; ?>">
                                                        <?php
    echo (isset($teacher->foreign_leave_end_date) ? "End Date : " . $teacher->foreign_leave_end_date . "<br>" : '');
?>
                                                    </div>
                                                </div>
                                            </div>
                                    ...
                                    <div class="row">
                                        <div class="col-md-12 col-sm-12 col-xs-12">
                                            <div class="item form-group">
                                                ...
                                                <textarea class="form-control col-md-7 col-xs-12" name="reason_note" id="reason_note" placeholder="Enter reason note"><?php echo isset($teacher->reason_note) ? $teacher->reason_note : ''; ?></textarea>
                                                <div class="help-block"><?php echo form_error('reason_note'); ?></div>
                                            </div>
                                        </div>
                                    </div>
                                <?php } ?>
                                ...
                                <script>
                                    document.addEventListener('DOMContentLoaded', function() {
                                        const radios = document.querySelectorAll('input[name="termination_reason"]');
                                        const foreignLeavePeriodDiv = document.getElementById('foreign_leave_period');
                                        const transferSearchBlock = document.getElementById('transfer_search_block');
                                        
                                        const leaveStartDate = document.getElementById('leave_start_date');
                                        const leaveEndDate = document.getElementById('leave_end_date');
                                        const transferCencusNumberInput = document.getElementById('transfer_cencus_number');
                                        const transferPirivenaNameInput = document.getElementById('transfer_pirivena_name');
                                        const transferSchoolIdInput = document.getElementById('transfer_school_id');
                                        const transferEffectiveDateInput = document.getElementById('transfer_effective_date');

                                        function toggleBlocks() {
                                            const selectedRadio = document.querySelector('input[name="termination_reason"]:checked');
                                            const selectedReason = selectedRadio ? selectedRadio.value : '';

                                            // Hide all conditional blocks and clear their values
                                            foreignLeavePeriodDiv.style.display = 'none';
                                            leaveStartDate.value = '';
                                            leaveEndDate.value = '';

                                            transferSearchBlock.style.display = 'none';
                                            transferCencusNumberInput.value = '';
                                            transferPirivenaNameInput.value = '';
                                            transferSchoolIdInput.value = '';
                                            transferEffectiveDateInput.value = '';
                                            
                                            // Show the relevant block based on the selected reason
                                            if (selectedReason === 'Foreign leave') {
                                                foreignLeavePeriodDiv.style.display = 'block';
                                            } else if (selectedReason === 'Receiving transfer') {
                                                transferSearchBlock.style.display = 'block';
                                            }
                                        }
                                        ...
                                        $(function() {
                                            $('#leave_start_date, #leave_end_date, #transfer_effective_date').datepicker({
                                                format: 'dd-mm-yyyy',
                                                startView: 0, 
                                                autoclose: true,
                                                todayHighlight: true
                                    ...
                                    // New logic for the transfer search
                                    let typingTimer;
                                    const doneTypingInterval = 4000; // milliseconds

                                    function fetchPirivenaData(value) {
                                        if (!value || value.length < 2) {
                                            // Clear all fields if input is too short or cleared
                                            $('#transfer_pirivena_name').val('');
                                            $('#transfer_cencus_number').val('');
                                            $('#transfer_school_id').val('');
                                            return;
                                        }

                                        $.ajax({
                                            url: '<?= site_url("teacher/fetch_pirivena_data") ?>',
                                            type: 'POST',
                                            data: { value: value },
                                            dataType: 'json',
                                            success: function(res) {
                                                if (res) {
                                                    $('#transfer_cencus_number').val(res.cencus_number);
                                                    $('#transfer_pirivena_name').val(res.school_name);
                                                    $('#transfer_school_id').val(res.id);
                                                } else {
                                                    // Clear if no match
                                                    $('#transfer_school_id').val('');
                                                }
                                    ...
                                    $('#transfer_cencus_number').on('keyup', function() {
                                        startTypingTimer(this);
                                    });

                                    $('#transfer_pirivena_name').on('keyup', function() {
                                        startTypingTimer(this);
                                    });
                                </script>    
