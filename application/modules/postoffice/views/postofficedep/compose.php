                    ...
                    <div class="row">
                        ...
                        <div class="col-md-9">
                            ...
                            <div class="box box-primary">
                                <?php echo form_open_multipart(site_url('postoffice/postofficedep/compose'), array('name' => 'compose', 'id' => 'compose', 'class'=>'form-horizontal form-label-left'), ''); ?>
                                <div class="box-body">
                                ...
                                <div class="item form-group display">
                                 ...
                                 <!--   <div class="item form-group">
                                        <div class="btn btn-default btn-file">
                                             ...
                                             </i> <?php echo $this->lang->line('uploadattachment'); ?> *
                                ...
                                <div class="box-footer">
                                    ...
                                    <a href="<?php echo site_url('postoffice/postofficedep/compose'); ?>" ><button type="reset" class="btn btn-default"><i class="fa fa-times"></i> <?php echo $this->lang->line('discard'); ?></button></a>
                                </div>
                                  <?php echo form_close(); ?>
                            </div>
                            <!-- /. box -->
