<a href="<?php echo site_url('postoffice/postofficedep/compose'); ?>" class="btn btn-default btn-block margin-bottom text-left compose-msg">
    ...
    <div class="box-body no-padding">
        <ul class="nav nav-pills nav-stacked">
            <li class="<?php if(isset($inbox)){ echo 'nav-active';} ?>">
                <a href="<?php echo site_url('postoffice/postofficedep/inbox'); ?>"><i class="fa fa-inbox"></i> <?php echo $this->lang->line('new'); ?>
            ...
            <li class="<?php if(isset($sent)){ echo 'nav-active';} ?>">
                <a href="<?php echo site_url('postoffice/postofficedep/sent'); ?>"><i class="fa fa-envelope-o"></i> <?php echo $this->lang->line('post'); ?>
                    <span class="label label-default pull-right"><?php echo count($sents); ?></span>
                </a>
            </li>

            <li class="<?php if(isset($draft)){ echo 'nav-active';} ?>">
                <a href="<?php echo site_url('postoffice/postofficedep/draft'); ?>"><i class="fa fa-file-text-o"></i> <?php echo $this->lang->line('draft'); ?>
                    <span class="label label-info pull-right"><?php echo count($drafts); ?></span>
                </a>
            </li>
            <li class="<?php if(isset($trash)){ echo 'nav-active';} ?>">
                <a href="<?php echo site_url('postoffice/postofficedep/trash'); ?>"><i class="fa fa-trash-o"></i> <?php echo $this->lang->line('trash'); ?>
      ...
      $(function () {
       ...
       $(".mailbox-star").click(function (e) {
            ...
            if (fa) {
              ...
              $.ajax({
                    type   : "POST",
                    url    : "<?php echo site_url('postoffice/postofficedep/set_fvourite_status'); ?>",
      ...
      //Enable check and uncheck all functionality
        ...
        $('#fn_trash').click(function() {
             ...
             if (message_ids.lenth != 0 ) {
                $.ajax({
                   type   : "POST",
                   url    : "<?php echo site_url('postoffice/postofficedep/set_trash_status'); ?>",
        ...
        $('#fn_delete').click(function() {
             ...
             if (message_ids.lenth != 0 ) {
                $.ajax({
                   type   : "POST",
                   url    : "<?php echo site_url('postoffice/postofficedep/set_delete_status'); ?>",
                   data   : { message_ids : message_ids},
                   async  : false,
                   success: function(response) {
                       if(response)
