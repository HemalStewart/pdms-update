                    ...
                    <div class="row">
                        ...
                        <div class="col-md-9">
                           ...
                           <div class="box box-primary">
                            <?php echo form_open_multipart(site_url('postoffice/postofficedep/reply/'.$message->message_id), array('name' => 'compose', 'id' => 'compose', 'class'=>'form-horizontal form-label-left'), ''); ?>
...
<?php } ?>
                                    ...
                                    <div class="form-group" style="display: none;" id="body2">
                                        ...
                                        <table id="datatable-responsive" class=" table dt-responsive nowrap fn_add_stop_container" cellspacing="0" width="100%" style="border: 1px solid #e1e3e1; border-radius: 25px;">
                                            <tr>
                                               ...
                                               <a href="<?php echo site_url('postoffice/postofficedep/view/'.$message->message_id); ?>"><button type="button" id="myButton" class="close"><i class="fa fa-times fa-2xs" style="color: #494949; font-size: medium"></i>
                                ...
                                <div class="box-footer no-print">
                                  <div class="pull-right">
                                    ...
                                    <a href="<?php echo site_url('postoffice/postofficedep/delete/'.$message->message_id); ?>" onclick="javascript: return confirm('<?php echo $this->lang->line('confirm_alert'); ?>');"><button type="button" class="btn btn-default"><i class="fa fa-trash-o"></i> <?php echo $this->lang->line('delete'); ?></button></a>
