                    ...
                    <div class="row">
                        ...
                        <div class="col-md-9">
                                <div class="box-header">
                                    <h3 class="box-title"><?php echo $this->lang->line('process'); ?></h3>
                                </div>
                                        ...
                                        <table id="datatable-responsive" class="table table-striped  dt-responsive nowrap jambo_table bulk_action" cellspacing="0" width="100%">
                                            <thead>
                                                <tr>
                                                    ...
                                                    <?php } ?>
                                                    <th><?php echo $this->lang->line('department_status'); ?></th>
                                            ...
                                            <tbody>
                                                <?php if(isset($inboxs) && !empty($inboxs)){ ?>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <?php } ?>
                                                        <td class="mailbox-star"> <?php if ($obj->department || $obj->rolename || $obj->dirname) { ?>
                                                          <span class="label label-danger"><?php echo $obj->department; ?> - <br></span>
                                                          <span class="label label-danger"><?php echo $obj->rolename; ?> - <br></span>
                                                          <span class="label label-success"><?php echo $obj->dirname; ?>
                                                         <?php } else { ?>
                                                             <p> - </p>
                                                         <?php } ?></td>
                                                        <td class="mailbox-name">
                                                            <a href="<?php echo site_url('postoffice/postofficedep/view/'.$obj->message_id); ?>"><?php $user = get_user_by_id($obj->sender_id); echo $user->name; ?></a>
                                                        </td>
                                                        <td class="mailbox-subject">
                                                            <b><a href="<?php echo site_url('postoffice/postofficedep/view/'.$obj->message_id); ?>"><?php echo $obj->subject; ?></a></b>
                                                        </td>
                                                        <td>
                                                         <?php if($obj->attachment){ ?>
                                                        <a href="<?php echo UPLOAD_PATH; ?>/post-office/<?php echo $obj->attachment; ?>"  target="_blank" class="btn btn-success btn-xs"><i class="fa fa-download"></i> <?php echo $this->lang->line('download'); ?></a> <br/>
                                                    <?php } ?>
                                                        </td>
