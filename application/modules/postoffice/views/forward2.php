                                 ...
                                 <i class="fa fa-share fa-fw" style="color:#9F9F9F">&nbsp</i><?php echo $this->lang->line('work_to'); ?> :<br/>
                                    ...
                                    <div class="col-md-3 col-sm-3 col-xs-12">
                                        <div class="item form-group">
                                            ...
                                            <select  class="form-control col-md-7 col-xs-12 quick-field" name="role_id" id="role_id" required="required" onchange="get_user_name(this.value, '');">
...
<script type="text/javascript">
  ...
  <?php if(isset($message)){ ?>
   ...
   //      alert("S");
       ...
       function get_user_name(user_id, role_id) {
   //      alert("S");


           $.ajax({
               type: "POST",
               url: "<?php echo site_url('ajax/get_user_name'); ?>",
