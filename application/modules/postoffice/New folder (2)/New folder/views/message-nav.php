    ...
    <div class="box-body no-padding">
        <ul class="nav nav-pills nav-stacked">
            <li class="<?php if(isset($inbox)){ echo 'nav-active';} ?>">
                <a href="<?php echo site_url('postoffice/inbox'); ?>"><i class="fa fa-inbox"></i> <?php echo $this->lang->line('inbox'); ?>
                    <span class="label label-primary pull-right"><?php echo count($inboxs); ?>/<?php echo count($new); ?></span>
                </a>
            </li>
			 <li class="<?php if(isset($process)){ echo 'nav-active';} ?>">
                <a href="<?php echo site_url('postoffice/sent'); ?>"><i class="fa fa-exchange"></i> <?php echo $this->lang->line('process'); ?>
                    <span class="label label-default pull-right"><?php echo count($processs); ?></span>
                </a>
            </li>
            <li class="<?php if(isset($sent)){ echo 'nav-active';} ?>">
                <a href="<?php echo site_url('postoffice/sent'); ?>"><i class="fa fa-envelope-o"></i> <?php echo $this->lang->line('sentp'); ?>
                    <span class="label label-default pull-right"><?php echo count($sents); ?></span>
                </a>
            </li>
            
            <li class="<?php if(isset($draft)){ echo 'nav-active';} ?>">
                <a href="<?php echo site_url('postoffice/draft'); ?>"><i class="fa fa-file-text-o"></i> <?php echo $this->lang->line('draft'); ?>
                    <span class="label label-info pull-right"><?php echo count($drafts); ?></span>
                </a>
            </li>           
            <li class="<?php if(isset($trash)){ echo 'nav-active';} ?>">
                <a href="<?php echo site_url('postoffice/trash'); ?>"><i class="fa fa-trash-o"></i> <?php echo $this->lang->line('trash'); ?>
