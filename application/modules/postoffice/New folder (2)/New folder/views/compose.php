                            ...
                            <div class="box box-primary">
                                    ...
                                    <div class="item form-group">                                    
                                        <select  class="form-control col-md-7 col-xs-12 fn_school_id" name="school_id" id="school_id" required="required">
                                            ...
                                            <?php foreach($schools as $obj){ ?>
                                                <option value="<?php echo $obj->id; ?>" <?php if(isset($school_id) && $school_id == $obj->id){echo 'selected="selected"';} ?>><?php echo $obj->school_name; ?> - ( <?php echo $obj->cencus_number; ?> )</option>
                                            <?php } ?>
                                        </select>
                                        ...
                                        <?php if(isset($roles) && !empty($roles)){ ?>
                                            <?php foreach($roles as $obj ){ ?>
                                                ...
                                                <?php if($this->session->userdata('role_id') == SUPER_ADMIN){ ?>
                                                     ...
                                                     <option value="<?php echo $obj->id; ?>" <?php if(isset($postoffice) && $postoffice->role_id == $obj->id ){ echo 'selected="selected"';} ?> ><?php echo $obj->name; ?></option>
                                ...
                                <div class="item form-group display">                                 
                                    ...
                                    <div class="form-group">                                     
                                        <input  class="form-control col-md-7 col-xs-12"  name="subject"  id="subject" value="<?php if(isset($postoffice)){ echo $postoffice->subject;} ?>" placeholder="<?php echo $this->lang->line('subject'); ?> *" required="required" type="text" autocomplete="off">
                                        <div class="help-block"><?php echo form_error('subject'); ?></div>
                                    </div>
                                    <div class="form-group">
                                        <textarea  class="form-control" name="body" id="body" required="required" placeholder="<?php echo $this->lang->line('message'); ?> *"><?php if(isset($postoffice)){ echo $postoffice->body;} ?></textarea>
                                ...
                                <div class="box-footer">
                                    <div class="pull-right">
                                        <?php if(isset($postoffice)){  ?>
                                            <input type="hidden" name="postoffice_id" id="postoffice_id" value="<?php echo $postoffice->message_id; ?>" />
                                        <?php } ?>
                                            
                                        <button type="submit" name="draft" class="btn btn-default"><i class="fa fa-pencil-square-o"></i> <?php echo $this->lang->line('draft'); ?></button>
                                        <button type="submit" name="send" class="btn btn-primary"><i class="fa fa-envelope-o"></i> <?php echo $this->lang->line('sentp'); ?></button>
                                    </div>
                                    <a href="<?php echo site_url('postoffice/compose'); ?>" ><button type="reset" class="btn btn-default"><i class="fa fa-times"></i> <?php echo $this->lang->line('discard'); ?></button></a>
                                </div>
                                  <?php echo form_close(); ?>
                            </div>
                            <!-- /. box -->
...
<script type="text/javascript">
  ...
  <?php if(isset($postoffice)){ ?>
        get_user_by_role('<?php echo $postoffice->role_id; ?>', '<?php echo $postoffice->receiver_id; ?>');
