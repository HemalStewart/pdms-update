                            ...
                            <div class="box box-primary">
                                ...
                                <div class="col-md-3 col-sm-3 col-xs-12">
                                    <div class="item form-group">
                                        ...
                                        <select class="form-control col-md-7 col-xs-12" name="department_id" id="department_id" required="required" onchange="get_user_by_role(this.value);">
  ...
  <?php if(isset($message)){ ?>
   ...
   //      alert("S");
           ...
           $.ajax({
              ...
              function get_subdep1(department_id, role_id) {
          //      alert("S");


                  $.ajax({
                      type: "POST",
                      url: "<?php echo site_url('ajax/get_subdep1'); ?>",
                      data: {department_id: department_id, role_id: role_id},
                      async: false,
                      success: function (response) {
