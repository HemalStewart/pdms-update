    ...
    <div class="box-body no-padding">
        <ul class="nav nav-pills nav-stacked">
            <li class="<?php if(isset($inbox)){ echo 'nav-active';} ?>">
                <a href="<?php echo site_url('postoffice/inbox'); ?>"><i class="fa fa-inbox"></i> <?php echo $this->lang->line('new'); ?>
            ...
            <li class="<?php if(isset($sent)){ echo 'nav-active';} ?>">
                <a href="<?php echo site_url('postoffice/sent'); ?>"><i class="fa fa-envelope-o"></i> <?php echo $this->lang->line('post'); ?>
