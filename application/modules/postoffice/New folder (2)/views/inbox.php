                                                ...
                                                <?php if(isset($inboxs) && !empty($inboxs)){ ?>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td class="mailbox-name">
                                                            <a href="<?php echo site_url('postoffice/view/'.$obj->message_id); ?>"><?php $user = get_user_by_id($obj->sender_id); echo $user->name; ?></a>
                                                        </td>
                                                        <td class="mailbox-subject">
                                                            <b><a href="<?php echo site_url('postoffice/view/'.$obj->message_id); ?>"><?php echo $obj->subject; ?></a></b>
                                                        </td>
                                                        <td>
