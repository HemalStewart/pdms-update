                ...
                <section class="content">
                    <div class="row">
                        ...
                        <div class="col-md-9">
                          ...
                          <?php  // Determine the action URL based on the $message_type
                                        ...
                                        <table id="datatable-responsive" class=" table dt-responsive nowrap fn_add_stop_container" cellspacing="0" width="100%" style="border: 1px solid #e1e3e1; border-radius: 25px;">
                                          ...
                                          <tr>
                                            <td colspan="3" style="padding: 10px 5px;">
                                              ...
                                              <!-- <div class="pull-left">
                                           <?php if(!$message->is_trash || !$message->is_draft){ ?>
                                        <button type="submit" class="btn btn-info" > <?php echo $this->lang->line('send'); ?></button>
                                    <?php } ?>
                                                </div> -->
                                ...
                                <div class="box-footer no-print">
                                  <div class="pull-right">
                                    ...
                                    <?php } ?>
                                      ...
                                      <?php if(!$message->is_trash || !$message->is_draft){ ?>
                                        <button type="submit" name="forward" class="btn btn-default" onclick="myFunction2()"><i class="fa fa-share"></i> <?php echo $this->lang->line('forward'); ?></button>
                                        <!--<button type="button" class="btn btn-default"><i class="fa fa-share"></i> Forward</button>-->
                                    <?php } ?>
                                  </div>
