                                                        ...
                                                        <thead>
                                                            <tr>
                                                                ...
                                                                <td>
																	...
																	<input class="form-control col-md-7 col-xs-12" name="vacancy_extra" id="ve_A" value="Vacancy" placeholder="" type="radio" autocomplete="off">
                                                                ...
                                                                <td>
																	...
																	<input class="form-control col-md-7 col-xs-12" name="vacancy_extra" id="ve_B" value="Extra" placeholder="" type="radio" autocomplete="off">
                                                    ...
                                                    <table id="datatable-responsive" class="table table-striped table-bordered dt-responsive nowrap" cellspacing="0" width="100%">
                                                        ...
                                                        <tbody>
                                                            <tr>
                                                                ...
                                                                <td>
                                                                    <input  class="form-control col-md-7 col-xs-12"  name="proposed_total"  id="proposed_total" value="<?php echo isset($post['proposed_total']) ? $post['proposed_total'] : ''; ?>" placeholder="<?php echo $this->lang->line('text240b'); ?>"  type="number" autocomplete="off">                                                                                       
                                        ...
                                        <div class="row" style="font-size: 16px;">
                                            ...
                                            <div class="col-md-2 col-sm-2 col-xs-12" style="margin-left: 0px; margin-right: 0px;">
                                                <div class="item form-group">
                                                    ...
                                                    <option value="">--<?php echo $this->lang->line('select'); ?>--</option>                                                                                    
                                                       <?php $kpiriven_types = get_piriven_type(); ?>
                                                <?php foreach ($kpiriven_types as $key => $value) { ?>
                                                    <option value="<?php echo $key; ?>" <?php
                                                    if (isset($post['kpiriven_type']) && $post['kpiriven_type'] == $key) {
                                                        echo 'selected="selected"';
                                                    }
                                                    ?>><?php echo $value; ?></option>
                                                        <?php } ?>
										...
										<div class="row" style="font-size: 16px;">
                                            ...
                                            <div class="col-md-2 col-sm-2 col-xs-12" style="margin-left: 0px; margin-right: 0px;">
                                                <div class="item form-group">
                                                    ...
                                                    <div class="help-block"><?php echo form_error('recommentaion'); ?></div>
                                                </div>
                                            </div>		
...
<!--========================================EDIT==========================================================================================-->
                        ...
                        <div class="tab-pane fade in active" id="tab_edit_teacherapplication">
                            <div class="x_content"> 
                                ...
                                <ul  class="nav nav-tabs bordered">
                                    <li  class="active" ><a href="#tab_zero1"   role="tab" data-toggle="tab" aria-expanded="true"><i class="fa fa-list-ol"></i> <?php echo $this->lang->line('pirven_fir'); ?></a> </li>

                                    <li><a href="#tab_first2"   role="tab" data-toggle="tab" aria-expanded="false"><i class="fa fa-plus-square-o"></i> <?php echo $this->lang->line('pirven_sec'); ?></a> </li>                          

                                    <li><a href="#tab_sec3"  role="tab"  data-toggle="tab" aria-expanded="false"><i class="fa fa-plus-square-o"></i> <?php echo $this->lang->line('pirven_third'); ?></a> </li>                          

                                    <li ><a href="#tab_third4"  role="tab"  data-toggle="tab" aria-expanded="false"><i class="fa fa-plus-square-o"></i> <?php echo $this->lang->line('pirven_forth'); ?></a> </li>
                                ...
                                <br>
								  ...
								  <div class="tab-content">
                                    ...
                                    <div class="tab-pane fade in active" id="tab_zero1">
                                                  ...
                                                  <table id="datatable-responsive" class="table table-striped table-bordered dt-responsive nowrap fn_add_stop_2container" cellspacing="0" width="100%">
                                                        <tr>
                                                            ...
                                                            <th colspan="6">
                                                                ...
                                                                <div class="col-md-8 col-sm-2 col-xs-12">
                                                                    <div class="item form-group">
                                                                        <input  class="form-control col-md-7 col-xs-12"  name="exam_name"  id="exam_name" value="<?php echo isset($forms1->exam_name) ? $forms1->exam_name : ''; ?>" placeholder="" type="text" autocomplete="off">
                                                                        <div class="help-block"><?php echo form_error('exam_name'); ?></div>
                                                                    </div>
                                                                </div>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <th colspan="3">
                                                                ...
                                                                <div class="col-md-8 col-sm-2 col-xs-12">
                                                                    <div class="item form-group">
                                                                        <input  class="form-control col-md-7 col-xs-12"  name="year_h1"  id="year_h1" value="<?php echo isset($forms1->year_h1) ? $forms1->year_h1 : ''; ?>" placeholder="" type="text" autocomplete="off">
                                                                        <div class="help-block"><?php echo form_error('year_h1'); ?></div>
                                                                    </div>
                                                                </div>
                                                            ...
                                                            <th colspan="3">
                                                                ...
                                                                <div class="col-md-8 col-sm-2 col-xs-12">
                                                                    <div class="item form-group">
                                                                        <input  class="form-control col-md-7 col-xs-12"  name="year_h2"  id="year_h2" value="<?php echo isset($forms1->year_h2) ? $forms1->year_h2 : ''; ?>" placeholder="" type="text" autocomplete="off">
                                                                        <div class="help-block"><?php echo form_error('year_h2'); ?></div>
                                                                    </div>
                                                                </div>
                                                            </th>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <th colspan="3">
                                                                ...
                                                                <div class="col-md-8 col-sm-2 col-xs-12">
                                                                    <div class="item form-group">
                                                                        <input  class="form-control col-md-7 col-xs-12"  name="datehi"  id="edit_datehi" value="<?php echo isset($forms1->datehi) ? $forms1->datehi : ''; ?>" placeholder="<?php echo $this->lang->line('datehi'); ?>" type="text" autocomplete="off">
                                                                        <div class="help-block"><?php echo $this->lang->line('datehi'); ?></div>
                                                                    </div>
                                                                </div>
                                                            </th>
                                                            <th colspan="3">
                                                                ...
                                                                <div class="col-md-8 col-sm-2 col-xs-12">
                                                                    <div class="item form-group">
                                                                        <input  class="form-control col-md-7 col-xs-12"  name="datehii"  id="add_datehii" value="<?php echo isset($forms1->datehii) ? $forms1->datehii : ''; ?>" placeholder="<?php echo $this->lang->line('datehii'); ?>" type="text" autocomplete="off">
                                                                        <div class="help-block"><?php echo $this->lang->line('datehii'); ?></div>
                                                                    </div>
                                                                </div>
                                                            </th>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <input  class="form-control col-md-7 col-xs-12"  name="hex1_sub10_grade"  id="hex1_sub10_grade" value="<?php echo isset($forms1->hex1_sub10_grade) ? $forms1->hex1_sub10_grade : ''; ?>" placeholder="" type="text" autocomplete="off">
                                                                <div class="help-block"><?php echo form_error('hex1_sub10_grade'); ?></div>
                                                            </td>
									 ...
									 <div class="col-md-8 col-sm-2 col-xs-12">
										 <div class="item form-group">
											  <textarea  class="form-control col-md-7 col-xs-12 textarea-4column"  name="other_qualifications"  id="other_qualifications"  placeholder="<?php echo $this->lang->line('other_qualifications'); ?>"><?php echo isset($forms1->other_qualifications) ? $forms1->other_qualifications : ''; ?></textarea>
                                                    <div class="help-block"><?php echo form_error('other_qualifications'); ?></div>
										 </div>
									</div>
								</div>
                                      ...
                                      <div class="row" style="font-size: 16px;">
                                          ...
                                          <div class="help-block"></div>
                                                    <table id="datatable-responsive" class="table table-striped table-bordered dt-responsive nowrap fn_edit_stop_3container" cellspacing="0" width="100%">
												...
												<tr>               
                                                    ...
                                                    <th style="text-align: center"><?php echo $this->lang->line('work_to'); ?></th>
														...
														<?php
                                                    $couter = 1;
                                                    foreach ($new_teacher_app_01_working as $obj) {
                                                        ?> 
                                                <tr>               
                                                    <td>
														<input type="hidden" name="stop_id[]" value="<?php echo $obj->id; ?>" />
                                                      <!--  <input  class="form-control col-md-12 col-xs-12" type="text" name="working_place[]" placeholder="<?php echo $this->lang->line('text225'); ?>" />-->
														<input  class="form-control col-md-12 col-xs-12 datepicker" style="width:auto;" type="text" name="working_place[]" id="editworking_place_<?php echo $couter; ?>" value="<?php echo $obj->working_place; ?>" placeholder="<?php echo $this->lang->line('text225'); ?>" />
                                                    </td>
                                                    <td>
													...
													<div class="help-block">
                                                        <?php echo form_error('answer'); ?>
                                                         <a href="javascript:void(0);" class="btn btn-success btn-xs" onclick="edit_more('fn_edit_stop_3container');"><?php echo $this->lang->line('add_more'); ?></a>
                                                    </div>
										...
										<div class="row" style="font-size: 16px;">
									       ...
									       <div class="col-md-8 col-sm-2 col-xs-12">
										       <div class="item form-group">
												   ...
												   <textarea  class="form-control col-md-7 col-xs-12 textarea-4column"  name="leave_reson"  id="leave_reson" placeholder="<?php echo $this->lang->line('leave_reson'); ?>"><?php echo isset($forms1->leave_reson) ? $forms1->leave_reson : ''; ?></textarea>
                                                    <div class="help-block"><?php echo form_error('leave_reson'); ?></div>
										       </div>
									      </div>
								      </div>
								      ...
								      <div class="row" style="font-size: 16px;">
										   ...
										   <div class="row" style="font-size: 16px;">
                                            ...
                                            <div class="col-md-5 col-sm-2 col-xs-12" style="margin-left: 0px; margin-right: 0px;">
                                                <div class="item form-group">
                                             		<input  class="form-control col-md-7 col-xs-12"  name="piriven_name1"  id="piriven_name1" value="<?php echo isset($forms1->piriven_name1) ?  $forms1->piriven_name1 : ''; ?>" placeholder="<?php echo $this->lang->line('piriven_name1'); ?>" type="text" autocomplete="off">
                                                    <div class="help-block"><?php echo form_error('piriven_name1'); ?></div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-md-2 col-sm-2 col-xs-12" style="margin-left: 0px; margin-right: 0px;">
                                                <div class="item form-group">
                                                    <select  class="form-control col-md-7 col-xs-12" name="piriven_type" id="piriven_type">    
													       <?php $piriven_type = get_piriven_type(); ?>
                                                    <?php foreach ($piriven_type as $key => $value) { ?>
                                                        <option value="<?php echo $key; ?>" <?php
                                                        if ($forms1->piriven_type == $key) {
                                                            echo 'selected="selected"';
                                                        }
                                                        ?>><?php echo $value; ?></option>
                                                            <?php } ?>
										 ...
										 <div class="row" style="font-size: 16px;">
                                            ...
                                            <div class="col-md-2 col-sm-2 col-xs-12" style="margin-left: 0px; margin-right: 0px;">
                                                <div class="item form-group">
                                                     <input  class="form-control col-md-7 col-xs-12"  name="datei"  id="edit_dateiv" value="<?php echo isset($forms1->dateiv) ?  date('d-m-Y', strtotime($forms1->dateiv)) : ''; ?>" placeholder="<?php echo $this->lang->line('dateiv'); ?>" type="text" autocomplete="off">
										 ...
										 <div class="row" style="font-size: 16px;">
                                            <div class="col-md-6 col-sm-6 col-xs-12">
                                                <div class="item form-group">
                                                    <label for="date_submit"> <?php echo $this->lang->line('date'); ?></label>
                                                     <input  class="form-control col-md-7 col-xs-12"  name="datev"  id="edit_datev"
													value="<?php
                                    ...
                                    <div class="col-md-3 col-sm-3 col-xs-12">
                                         <div class="item form-group">
                                             <input type="hidden" name="prev_father_photo" id="prev_applicant_sig1" value="<?php echo $forms1->applicant_sig1; ?>" />
                                            <?php if($forms1->applicant_sig1){ ?>
                                            <img src="<?php echo UPLOAD_PATH; ?>/form/<?php echo $forms1->applicant_sig1; ?>" alt="" width="70" /><br/><br/>
                                            <?php } ?>
                                         </div>
                                     </div> 
								 ...
								 <div class="form-group">
                                                ...
                                                <div class="item form-group">
                                                    <table id="datatable-responsive" class="table table-striped table-bordered dt-responsive nowrap" cellspacing="0" width="100%">
                                                        ...
                                                        <tbody>
                                                            <tr>
                                                                <td>								
																	<input  class="form-control col-md-7 col-xs-12"  name="annual_year1"  id="annual_year1" value="<?php echo isset($forms2->annual_year1) ? $forms2->annual_year1 : ''; ?>" placeholder="<?php echo $this->lang->line('annual_year1'); ?>"  type="text" autocomplete="off">
                                                                    <div class="help-block"><?php echo form_error('7iidate'); ?></div>
                                                                </td>
                                                                <td>
                                                ...
                                                <div class="item form-group">
                                                    <table id="datatable-responsive" class="table table-striped table-bordered dt-responsive nowrap" cellspacing="0" width="100%">
                                                        ...
                                                        <tbody>
                                                            <tr>
                                                                <td>
                                                                    <input  class="form-control col-md-7 col-xs-12"  name="annual_monk"  id="annual_monk" value="<?php echo isset($forms2->annual_monk) ? $forms2->annual_monk : ''; ?>" placeholder="<?php echo $this->lang->line('text240a'); ?>"  type="number" autocomplete="off">
                                                                    <div class="help-block"><?php echo form_error('7iidate'); ?></div>
                                                                </td>
                                                                <td>
                                                                    <input  class="form-control col-md-7 col-xs-12"  name="annual_lay"  id="annual_lay" value="<?php echo isset($forms2->annual_lay) ? $forms2->annual_lay : ''; ?>" placeholder="<?php echo $this->lang->line('text240b'); ?>"  type="number" autocomplete="off">                                                                           
                                                                    <div class="help-block"><?php echo form_error('7iidate'); ?></div>
                                                                </td>
                                                                <td>
                                                                    <input  class="form-control col-md-7 col-xs-12"  name="annual_total"  id="annual_total" value="<?php echo isset($forms2->annual_total) ? $forms2->annual_total : ''; ?>" placeholder="<?php echo $this->lang->line('text240c'); ?>"  type="number" autocomplete="off">                                                                          
                                                                    <div class="help-block"><?php echo form_error('7iidate'); ?></div>
                                                                </td>
                                                ...
                                                <div class="item form-group dataTables_wrapper">
                                                    ...
                                                    <table id="datatable-responsive" class="table table-striped table-bordered dt-responsive nowrap" cellspacing="0" width="100%">
                                                        ...
                                                        <tr>
                                                            <td>01</td>
                                                            <td>
                                                                <input class="form-control col-md-7 col-xs-12" name="time1" id="edit_time1" value="<?php echo isset($forms2->time1) ? $forms2->time1 : ''; ?>" placeholder="" type="text" autocomplete="off">
                                                                <div class="help-block"><?php echo form_error('18i'); ?></div>
                                                            </td>
                                                            <td>
                                                        ...
                                                        <tr>
                                                            <td>02</td>
                                                            <td>
                                                                <input class="form-control col-md-7 col-xs-12" name="time2" id="edit_time2" value="<?php echo isset($forms2->time2) ? $forms2->time2 : ''; ?>" placeholder="" type="text" autocomplete="off">
                                                                <div class="help-block"><?php echo form_error('18i'); ?></div>
                                                            </td>
                                                            <td>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <input class="form-control col-md-7 col-xs-12" name="time3" id="edit_time3" value="<?php echo isset($forms2->time3) ? $forms2->time3 : ''; ?>" placeholder="" type="text" autocomplete="off">
                                                                <div class="help-block"><?php echo form_error('18i'); ?></div>
                                                            </td>
                                                            <td>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <input class="form-control col-md-7 col-xs-12" name="time4" id="edit_time4" value="<?php echo isset($forms2->time4) ? $forms2->time4 : ''; ?>" placeholder="" type="text" autocomplete="off">
                                                                <div class="help-block"><?php echo form_error('18i'); ?></div>
                                                            </td>
                                                            <td>
                                                        ...
                                                        <tr>
                                                            <td>05</td>
                                                            <td>
                                                                <input class="form-control col-md-7 col-xs-12" name="time5" id="edit_time5" value="<?php echo isset($forms2->time5) ? $forms2->time5 : ''; ?>" placeholder="" type="text" autocomplete="off">
                                                                <div class="help-block"><?php echo form_error('18i'); ?></div>
                                                            </td>
                                                            <td>
                                                        ...
                                                        <tr>
                                                            <td>06</td>
                                                            <td>
                                                                <input class="form-control col-md-7 col-xs-12" name="time6" id="edit_time6" value="<?php echo isset($forms2->time6) ? $forms2->time6 : ''; ?>" placeholder="" type="text" autocomplete="off">
                                                                <div class="help-block"><?php echo form_error('18i'); ?></div>
                                                            </td>
                                                            <td>
                                                            ...
                                                            <td>
                                                                <input class="form-control col-md-7 col-xs-12" name="thur6" id="thur6" value="<?php echo isset($forms2->thur6) ? $forms2->thur6 : ''; ?>" placeholder="" type="text" autocomplete="off">
                                                                <div class="help-block"><?php echo form_error('18ii'); ?></div>
                                                            </td>
                                                            <td>
                                                        ...
                                                        <tr>
                                                            <td>07</td>
                                                            <td>
                                                                <input class="form-control col-md-7 col-xs-12" name="time7" id="edit_time7" value="<?php echo isset($forms->time7) ? $forms->time7 : ''; ?>" placeholder="" type="text" autocomplete="off">
                                                                <div class="help-block"><?php echo form_error('18i'); ?></div>
                                                            </td>
                                                            <td>
                                                            ...
                                                            <td>
                                                                <input class="form-control col-md-7 col-xs-12" name="tues7" id="tues7" value="<?php echo isset($forms->tues7) ? $forms->tues7 : ''; ?>" placeholder="" type="text" autocomplete="off">
                                                                <div class="help-block"><?php echo form_error('18i'); ?></div>
                                                            </td>

                                                            <td>
                                                                <input class="form-control col-md-7 col-xs-12" name="wend7" id="wend7" value="<?php echo isset($forms->wend1) ? $forms->wend7 : ''; ?>" placeholder="" type="text" autocomplete="off">
                                                                <div class="help-block"><?php echo form_error('18ii'); ?></div>
                                                            </td>
                                                            <td>
                                                                <input class="form-control col-md-7 col-xs-12" name="thur7" id="thur7" value="<?php echo isset($forms->thur7) ? $forms->thur7 : ''; ?>" placeholder="" type="text" autocomplete="off">
                                                                <div class="help-block"><?php echo form_error('18ii'); ?></div>
                                                            </td>
                                                            <td>
                                                        ...
                                                        <tr>
                                                            <td>08</td>
                                                            <td>
                                                                <input class="form-control col-md-7 col-xs-12" name="time8" id="edit_time8" value="<?php echo isset($forms2->time8) ? $forms2->time8 : ''; ?>" placeholder="" type="text" autocomplete="off">
                                                                <div class="help-block"><?php echo form_error('18i'); ?></div>
                                                            </td>
                                                            <td>
                                    ...
                                    <div class="item form-group">
                                        ...
                                        <div class="col-md-6 col-sm-6 col-xs-12">
                                                ...
                                                <tr>               
													...
													<tr>
                                                            <th colspan="3"><?php echo $this->lang->line('text240c'); ?></th>
                                                            <td> 
                                                                <input  class="form-control col-md-7 col-xs-12"  name="hours_total"  id="hours_total" value="<?php echo isset($forms2->hours_total) ? $forms2->hours_total : ''; ?>" placeholder="" type="number" autocomplete="off">
                                                                <div class="help-block"><?php echo form_error('hours_total'); ?></div>
                                                            </td>
														
                                                            <td> 
                                                                <input  class="form-control col-md-7 col-xs-12"  name="minuts_total"  id="minuts_total" value="<?php echo isset($forms2->minuts_total) ? $forms2->minuts_total : ''; ?>" placeholder="" type="number" autocomplete="off">
                                                                <div class="help-block"><?php echo form_error('minuts_total'); ?></div>
                                                            </td>
                                                        </tr>
                                                ...
                                                <div class="item form-group">
                                                    <table id="datatable-responsive" class="table table-striped table-bordered dt-responsive nowrap" cellspacing="0" width="100%">
                                                        ...
                                                        <tbody>
                                                            <tr>
                                                                <td>
                                                                    <input  class="form-control col-md-7 col-xs-12"  name="proposed_monk"  id="proposed_monk" value="<?php echo isset($forms2->proposed_monk) ? $forms2->proposed_monk : ''; ?>" placeholder="<?php echo $this->lang->line('text240a'); ?>"  type="number" autocomplete="off">
                                                                    <div class="help-block"><?php echo form_error('text240a'); ?></div>
                                                                </td>
                                                                <td>
                                                                    <input  class="form-control col-md-7 col-xs-12"  name="proposed_lay"  id="proposed_lay" value="<?php echo isset($forms2->proposed_lay) ? $forms2->proposed_lay : ''; ?>" placeholder="<?php echo $this->lang->line('text240b'); ?>"  type="number" autocomplete="off">                                                                           
                                                                    <div class="help-block"><?php echo form_error('text240b'); ?></div>
                                                                </td>
                                                                <td>
                                                                    <input  class="form-control col-md-7 col-xs-12"  name="proposed_total"  id="proposed_total" value="<?php echo isset($forms2->proposed_total) ? $forms2->proposed_total : ''; ?>" placeholder="<?php echo $this->lang->line('text240c'); ?>"  type="number" autocomplete="off">                                                                          
                                                                    <div class="help-block"><?php echo form_error('text240c'); ?></div>
                                                                </td>
                                        ...
                                        <div class="row" style="font-size: 16px;">
                                            ...
                                            <div class="col-md-7 col-sm-2 col-xs-12">
                                                <div class="item form-group">
													 <textarea  class="form-control col-md-7 col-xs-12 textarea-4column"  name="additional_appointment"  id="additional_appointment" placeholder="<?php echo $this->lang->line('text206'); ?>"><?php echo isset($forms2->additional_appointment) ? $forms2->additional_appointment : ''; ?></textarea>
                                                    <div class="help-block"><?php echo form_error('additional_appointment'); ?></div>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="row" style="font-size: 16px;">
                                            ...
                                            <div class="col-md-5 col-sm-2 col-xs-12">
                                                <div class="item form-group">
                                                    <textarea  class="form-control col-md-7 col-xs-12 textarea-4column"  name="jobtitle_subject"  id="jobtitle_subject" placeholder="<?php echo $this->lang->line('text206'); ?>"><?php echo isset($forms2->jobtitle_subject) ? $forms2->jobtitle_subject : ''; ?></textarea>
                                                    <div class="help-block"><?php echo form_error('jobtitle_subject'); ?></div>
                                                </div>
                                            </div>
                                        ...
                                        <div class="row" style="font-size: 16px;">
                                            ...
                                            <div class="col-md-7 col-sm-2 col-xs-12">
                                                <div class="item form-group">
                                                     <textarea  class="form-control col-md-7 col-xs-12 textarea-4column"  name="highedu_subjects"  id="highedu_subjects" placeholder="<?php echo $this->lang->line('text206'); ?>"><?php echo isset($forms2->highedu_subjects) ? $forms2->highedu_subjects : ''; ?></textarea>
                                                    <div class="help-block"><?php echo form_error('highedu_subjects'); ?></div>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="row" style="font-size: 16px;">
                                            ...
                                            <div class="col-md-5 col-sm-2 col-xs-12">
                                                <div class="item form-group">
													 ...
													 <input  class="form-control col-md-7 col-xs-12"  name="datevi"  id="edit_datevi" value="<?php echo isset($forms2->datevi) ?  date('d-m-Y', strtotime($forms2->datevi)) : ''; ?>" placeholder="<?php echo $this->lang->line('datevi'); ?>" type="text" autocomplete="off">
                                                    <div class="help-block"><?php echo $this->lang->line('datevi'); ?></div>
                                                </div>
                                            </div>
                                        ...
                                        <div class="row" style="font-size: 16px;">
                                            ...
                                            <div class="col-md-3 col-sm-2 col-xs-12">
                                                <div class="item form-group">
                                                     <input  class="form-control col-md-7 col-xs-12"  name="datevii"  id="edit_datevii" value="<?php echo isset($forms2->datevii) ?  date('d-m-Y', strtotime($forms2->datevii)) : ''; ?>" placeholder="<?php echo $this->lang->line('datevii'); ?>" type="text" autocomplete="off">
                                                    <div class="help-block"><?php echo $this->lang->line('datevii'); ?></div>
                                                </div>
                                            </div>
                                        ...
                                        <div class="row" style="font-size: 16px;">
                                            <div class="col-md-6 col-sm-6 col-xs-12">
                                                <div class="item form-group">
                                                    <label for="date_submit"> <?php echo $this->lang->line('date'); ?></label>
                                                     <input  class="form-control col-md-7 col-xs-12"  name="datei"  id="edit_dateviii" value="<?php echo isset($forms2->dateviii) ?  date('d-m-Y', strtotime($forms2->dateviii)) : ''; ?>" placeholder="<?php echo $this->lang->line('datei'); ?>" type="text" autocomplete="off">
                                                    <div class="help-block"><?php echo $this->lang->line('dateviii'); ?></div>
                                                </div>
                                            </div>
                                    ...
                                    <div class="tab-pane fade in" id="tab_sec3">
                                        ...
                                        <div class="row" style="font-size: 16px;">
                                            ...
                                            <div class="col-md-6 col-sm-2 col-xs-12" style="margin-left: 0px; margin-right: 0px;">
                                                <div class="item form-group">
                                                    <input  class="form-control col-md-7 col-xs-12" name="kpiriven_name1"  id="kpiriven_name1" value="<?php echo isset($forms3->kpiriven_name1) ? $forms3->kpiriven_name1 : ''; ?>" placeholder="<?php echo $this->lang->line('school_name'); ?>"  type="text" autocomplete="off">
                                                    <div class="help-block"><?php echo form_error('kpiriven_name1'); ?></div>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="row" style="font-size: 16px;">
                                            ...
                                            <div class="col-md-2 col-sm-2 col-xs-12" style="margin-left: 0px; margin-right: 0px;">
                                                <div class="item form-group">
                                                    <select  class="form-control col-md-7 col-xs-12" name="kpiriven_type" id="kpiriven_type">    
													       <?php $kpiriven_type = get_piriven_type(); ?>
                                                    <?php foreach ($kpiriven_type as $key => $value) { ?>
                                                        <option value="<?php echo $key; ?>" <?php
                                                        if ($forms3->kpiriven_type == $key) {
                                                            echo 'selected="selected"';
                                                        }
                                                        ?>><?php echo $value; ?></option>
                                                            <?php } ?>
                                        ...
                                        <div class="row" style="font-size: 16px;">
                                            <div class="col-md-6 col-sm-6 col-xs-12">
                                                <div class="item form-group">
                                                    <label for="date_submit"> <?php echo $this->lang->line('date'); ?></label>
                                                     <input  class="form-control col-md-7 col-xs-12"  name="dateix"  id="edit_dateix" value="<?php echo isset($forms3->dateix) ?  date('d-m-Y', strtotime($forms3->dateix)) : ''; ?>" placeholder="<?php echo $this->lang->line('datevi'); ?>" type="text" autocomplete="off">
                                                    <div class="help-block"><?php echo $this->lang->line('dateix'); ?></div>
                                                </div>
                                            </div>
                                        ...
                                        <div class="row" style="font-size: 16px;">
                                            ...
                                            <div class="col-md-3 col-sm-2 col-xs-12" style="margin-left: 0px; margin-right: 0px;">
                                                <div class="item form-group">
                                                    <input  class="form-control col-md-7 col-xs-12"  name="datex"  id="edit_datex" value="<?php echo isset($forms3->datex) ?  date('d-m-Y', strtotime($forms3->datex)) : ''; ?>" placeholder="<?php echo $this->lang->line('datex'); ?>" type="text" autocomplete="off">
                                                    <div class="help-block"><?php echo form_error('datex'); ?></div>
                                        ...
                                        <div class="row" style="font-size: 16px;">
                                            ...
                                            <div class="col-md-2 col-sm-2 col-xs-12" style="margin-left: 0px; margin-right: 0px;">
                                                <div class="item form-group">
                                                    <select  class="form-control col-md-7 col-xs-12" name="asst_province_type" id="asst_province_type">
                                                        <option value="">--<?php echo $this->lang->line('select'); ?>--</option>                                                  <?php $asst_province_type = get_en_type(); ?>
                                                    <?php foreach ($asst_province_type as $key => $value) { ?>
                                                        <option value="<?php echo $key; ?>" <?php
                                        ...
                                        <div class="row" style="font-size: 16px;">
                                            ...
                                            <div class="col-md-5 col-sm-2 col-xs-12" style="margin-left: 0px; margin-right: 0px;">
                                                <div class="item form-group">
                                                    <input  class="form-control col-md-7 col-xs-12" name="asst_province_pname"  id="asst_province_pname" value="<?php echo isset($forms3->asst_province_pname) ? $forms3->asst_province_pname : ''; ?>" placeholder="<?php echo $this->lang->line('school_name'); ?>"  type="text" autocomplete="off">
                                                    <div class="help-block"><?php echo form_error('asst_province_pname'); ?></div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-md-2 col-sm-2 col-xs-12" style="margin-left: 0px; margin-right: 0px;">
                                                <div class="item form-group">
                                                    <select  class="form-control col-md-7 col-xs-12" name="asst_province_ptype" id="asst_province_ptype">
                                                        <option value="">--<?php echo $this->lang->line('select'); ?>--</option>                                                                                    
                                                        <?php $asst_province_ptype = get_piriven_type(); ?>
                                                    <?php foreach ($asst_province_ptype as $key => $value) { ?>
                                                        <option value="<?php echo $key; ?>" <?php
                                                        if ($forms3->asst_province_ptype == $key) {
                                                            echo 'selected="selected"';
                                                        }
                                                        ?>><?php echo $value; ?></option>
                                                            <?php } ?>
											...
											<div class="col-md-2 col-sm-2 col-xs-12" style="margin-left: 0px; margin-right: 0px;">
                                                <div class="item form-group">
                                                    <select  class="form-control col-md-7 col-xs-12" name="recommendation" id="recommendation">    
													       <?php $recommendation = get_recommendation(); ?>
                                                    ...
                                                    <div class="help-block"><?php echo form_error('recommendation'); ?></div>
                                                </div>
                                            </div>
                                        ...
                                        <div class="row" style="font-size: 16px;">
                                            <div class="col-md-6 col-sm-6 col-xs-12">
                                                <div class="item form-group">
                                                    <label for="date_submit"> <?php echo $this->lang->line('date'); ?></label>
                                                  <input  class="form-control col-md-7 col-xs-12"  name="datexi"  id="edit_datexi" value="<?php echo isset($forms3->datexi) ?  date('d-m-Y', strtotime($forms3->datexi)) : ''; ?>" placeholder="<?php echo $this->lang->line('datex'); ?>" type="text" autocomplete="off">
                                                    <div class="help-block"><?php echo $this->lang->line('datexi'); ?></div>
                                                </div>
                                            </div>
                                    ...
                                    <div class="tab-pane fade in" id="tab_third4">
                                        ...
                                        <div class="row" style="font-size: 16px;">
                                            ...
                                            <div class="col-md-5 col-sm-2 col-xs-12" style="margin-left: 0px; margin-right: 0px;">
                                                <div class="item form-group">
													 <input  class="form-control col-md-7 col-xs-12" name="min_piriven_name"  id="min_piriven_name" value="<?php echo isset($forms3->min_piriven_name) ? $forms3->min_piriven_name : ''; ?>" placeholder="<?php echo $this->lang->line('school_name'); ?>"  type="text" autocomplete="off">
                                                    <div class="help-block"><?php echo form_error('min_piriven_name'); ?></div>
                                                </div>
                                            </div>
											 ...
											 <div class="col-md-2 col-sm-2 col-xs-12" style="margin-left: 0px; margin-right: 0px;">
                                                <div class="item form-group">
                                                    <select  class="form-control col-md-7 col-xs-12" name="min_piriven_type" id="min_piriven_type">
                                                        <option value="">--<?php echo $this->lang->line('select'); ?>--</option>                                                                                    
                                                        <?php $min_piriven_type = get_piriven_type(); ?>
                                                    <?php foreach ($min_piriven_type as $key => $value) { ?>
                                                        <option value="<?php echo $key; ?>" <?php
                                                        if ($forms3->min_piriven_type == $key) {
                                                            echo 'selected="selected"';
                                                        }
                                                        ?>><?php echo $value; ?></option>
                                                            <?php } ?>
                                        ...
                                        <div class="row" style="font-size: 16px;">
                                            ...
                                            <div class="col-md-3 col-sm-2 col-xs-12" style="margin-left: 0px; margin-right: 0px;">
                                                <div class="item form-group">
													 <select  class="form-control col-md-7 col-xs-12" name="true_not" id="true_not">
                                                        <option value="">--<?php echo $this->lang->line('select'); ?>--</option>                                                                                    
                                                        <?php $true_not = get_ture_not(); ?>
                                                    <?php foreach ($true_not as $key => $value) { ?>
                                                        <option value="<?php echo $key; ?>" <?php
                                        ...
                                        <div class="row" style="font-size: 16px;">
                                            ...
                                            <div class="col-md-6 col-sm-6 col-xs-12">
												  <div class="item form-group">
                                                    <label for="date_submit"> <?php echo $this->lang->line('date'); ?></label>
                                                     <input  class="form-control col-md-7 col-xs-12"  name="datexii"  id="edit_datexii"
													value="<?php
                                        ...
                                        <div class="row" style="font-size: 16px;">
                                            ...
                                            <div class="col-md-2 col-sm-2 col-xs-12" style="margin-left: 0px; margin-right: 0px;">
                                                <div class="item form-group">
													...
													<select  class="form-control col-md-7 col-xs-12" name="approved_not" id="approved_not">
                                                        <option value="">--<?php echo $this->lang->line('select'); ?>--</option>                                                                                    
                                                        <?php $approved_not = get_approval(); ?>
                                                        <?php foreach ($approved_not as $key => $value) { ?>
                                                        <option value="<?php echo $key; ?>" <?php
                                        ...
                                        <div class="row" style="font-size: 16px;">
                                            ...
                                            <div class="col-md-6 col-sm-6 col-xs-12">
												  ...
												  <div class="item form-group">
                                                    <label for="date_submit"> <?php echo $this->lang->line('date'); ?></label>
                                                     <input  class="form-control col-md-7 col-xs-12"  name="datexiii"  id="edit_datexiii"
													value="<?php
												 if($forms1->datexiii !='1970-01-01') {
													 echo date('d-m-Y', strtotime($forms1->datexiii));
												 } 
												 else echo ''; ?>" 
												 placeholder="<?php echo $this->lang->line('date'); ?>" type="text" autocomplete="off">
                                                    <div class="help-block"><?php echo $this->lang->line('datexiii'); ?></div>
                                        ...
                                        <div class="row" style="font-size: 16px;">
                                            ...
                                            <div class="col-md-2 col-sm-2 col-xs-12" style="margin-left: 0px; margin-right: 0px;">
                                                <div class="item form-group">
                                                   <select  class="form-control col-md-7 col-xs-12" name="submition" id="submition">
                                                        <option value="">--<?php echo $this->lang->line('select'); ?>--</option>                                                                                    
                                                        <?php $submition = get_submition(); ?>
                                                        <?php foreach ($submition as $key => $value) { ?>
                                                        <option value="<?php echo $key; ?>" <?php
                                        ...
                                        <div class="row" style="font-size: 16px;">
                                            ...
                                            <div class="col-md-6 col-sm-6 col-xs-12">
                                               <div class="item form-group">
                                                    <label for="date_submit"> <?php echo $this->lang->line('date'); ?></label>
                                                     <input  class="form-control col-md-7 col-xs-12"  name="datexiv"  id="edit_datexiv"
													value="<?php
												 if($forms1->datexiv !='1970-01-01') {
													 echo date('d-m-Y', strtotime($forms1->datexii));
												 } 
												 else echo ''; ?>" 
												 placeholder="<?php echo $this->lang->line('date'); ?>" type="text" autocomplete="off">
                                                    <div class="help-block"><?php echo $this->lang->line('datexiv'); ?></div>
                                        ...
                                        <div class="row" style="font-size: 16px;">
                                            ...
                                            <div class="col-md-2 col-sm-2 col-xs-12" style="margin-left: 0px; margin-right: 0px;">
                                                <div class="item form-group">
                                                    ...
                                                    <select  class="form-control col-md-7 col-xs-12" name="given_not" id="given_not">
                                                        <option value="">--<?php echo $this->lang->line('select'); ?>--</option>                                                                                    
                                                        <?php $given_not = get_given_not(); ?>
                                                        <?php foreach ($given_not as $key => $value) { ?>
                                                        <option value="<?php echo $key; ?>" <?php
                                        ...
                                        <div class="row" style="font-size: 16px;">
                                            ...
                                            <div class="col-md-8 col-sm-2 col-xs-12">
                                                ...
                                                <textarea  class="form-control col-md-7 col-xs-12 textarea-4column"  name="min_note"  id="min_note"  placeholder="<?php echo $this->lang->line(min_note); ?>"><?php echo isset($forms3->min_note) ? $forms3->min_note : ''; ?></textarea>
                                                    <div class="help-block"><?php echo form_error('min_note'); ?></div>
                                                  </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="row" style="font-size: 16px;">
                                            ...
                                            <div class="col-md-6 col-sm-6 col-xs-12">
                                              <div class="item form-group">
                                                    <label for="date_submit"> <?php echo $this->lang->line('date'); ?></label>
                                                     <input  class="form-control col-md-7 col-xs-12"  name="datexv"  id="edit_datexv"
													value="<?php
                                            ...
                                            <div class="row" style="font-size: 16px; margin: 0px 2px">
                                                ...
                                                <div class="col-md-6 col-sm-6 col-xs-12">
                                                    <div class="item form-group">
                                                        ...
                                                        <div class="col-md-6 col-sm-2 col-xs-12" style="margin-left: 0px; margin-right: 0px;">
                                                                 ...
                                                                 <div class="item form-group">
                                                                      <label for="date_submit"> <?php echo $this->lang->line('date'); ?></label>
                                                                      <input  class="form-control col-md-7 col-xs-12"  name="received_datexvi"  id="edit_received_datexvi"
												                     	value="<?php
												                    ...
												                    placeholder="<?php echo $this->lang->line('date'); ?>" type="text" autocomplete="off">
                                                                      <div class="help-block"><?php echo $this->lang->line('received_datexvi'); ?></div>
                                                                 </div>
                                                ...
                                                <div class="col-md-6 col-sm-6 col-xs-12">
                                                    <div class="item form-group">
                                                        ...
                                                        <div class="col-md-8 col-sm-2 col-xs-12" style="margin-left: 0px; margin-right: 0px;">
                                                            <div class="item form-group">
                                                                <input  class="form-control col-md-7 col-xs-12" name="sub_no"  id="sub_no" value="<?php echo isset($forms3->sub_no) ? $forms3->sub_no : ''; ?>" placeholder="<?php echo $this->lang->line('sub_no'); ?>"  type="text" autocomplete="off">
                                                                <div class="help-block"><?php echo form_error('sub_no'); ?></div>
                                                            </div>
                                                        </div>
                                                    </div>
                                            ...
                                            <div class="row" style="font-size: 16px; margin: 0px 2px">
                                                ...
                                                <div class="col-md-6 col-sm-6 col-xs-12">
                                                    <div class="item form-group">
                                                        ...
                                                        <div class="col-md-8 col-sm-2 col-xs-12" style="margin-left: 0px; margin-right: 0px;">
                                                            <div class="item form-group">
                                                                <textarea  class="form-control col-md-7 col-xs-12 textarea-4column"  name="reply"  id="reply"  placeholder="<?php echo $this->lang->line(reply); ?>"><?php echo isset($forms3->reply) ? $forms3->reply : ''; ?></textarea>
                                                                <div class="help-block"><?php echo form_error('reply'); ?></div>
                                                            </div>
                                                        </div>
                                                    </div>
...
<script type="text/javascript">
	...
	$('#edit_time1').timepicker();
    $('#edit_time2').timepicker();
    $('#edit_time3').timepicker();
    $('#edit_time4').timepicker();
    $('#edit_time5').timepicker();
    $('#edit_time6').timepicker();
    $('#edit_time7').timepicker();
    $('#edit_time8').timepicker();
...
<script type="text/javascript">
    ...
    function edit_more(fn_edit_stop_3container) {
        ...
        var data = '<tr id="row_' + row_id + '">'
                + '<td>'
                + '<input  class="form-control col-md-12 col-xs-12"  data-row-id="' + row_id + ' type="text" name="working_place[]" id="editworking_place_' + row_id + '" class="answer" placeholder="<?php echo $this->lang->line('text225'); ?>" />'
                + '</td>'
                + '</td>'
                + '<td>'
                + '<input  class="form-control col-md-12 col-xs-12" type="text" name="working_designation[]" value="" placeholder="<?php echo $this->lang->line('text228'); ?>"/>'
                ...
                + '</td>'
                + '</tr>';
        $('.' + fn_edit_stop_3container).append(data);
    }
    ...
    function remove(obj, stop_id) {
        ...
        if (stop_id)
        {
            if (confirm('<?php echo $this->lang->line('confirm_alert'); ?>')) {
                $.ajax({
                    type: "POST",
                    url: "<?php echo site_url('forms/remove_stop'); ?>",
