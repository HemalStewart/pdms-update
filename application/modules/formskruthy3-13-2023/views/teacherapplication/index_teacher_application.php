                                        ...
                                        if (isset($teacherapplicationformval) && !empty($teacherapplicationformval)) {
                                            ...
                                            foreach ($teacherapplicationformval as $obj) {
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <?php if (has_permission(EDIT, 'forms', 'teacherformappkruthy') && $obj->cur_status == 2) { ?>
                                                            <a href="<?php echo site_url('formskruthy/formsapply/teacherapplicationformedit/' . $obj->id); ?>" class="btn btn-info btn-xs"><i class="fa fa-pencil-square-o"></i> <?php echo $this->lang->line('edit'); ?> </a>
                                                        <?php } ?>
                                                        ...
                                                        <?php if (has_permission(EDIT, 'forms', 'teacherformappkruthy') && $obj->cur_status == 2) { ?>
                                                            <a href="<?php echo site_url('formskruthy/Formsapply/confirm/' . $obj->id); ?>" class="btn btn-warning btn-xs"><i class="fa fa-check-square-o"></i> <?php echo $this->lang->line('confirm'); ?> </a>
                                                        <?php } ?>

                                                        <?php if (has_permission(VIEW, 'forms', 'teacherformappkruthy')) { ?>
                                                            <a href="<?php echo site_url('formskruthy/formsapply/teacher_application_print/' . $obj->id); ?>" class="btn btn-success2 btn-xs" target="_blank"><i class="fa fa-print" style="color: #ffffff;"></i> <?php echo $this->lang->line('print'); ?> </a>
