...
<div class="row">
    <div class="col-md-12 col-sm-12 col-xs-12">
        <div class="x_panel">
            <div class="x_title">
                <h3 class="head-title"><i class="fa fa-file-text-o"></i><small> <?php echo $this->lang->line('forms'); ?></small></h3>
            ...
            <div class="x_content">
                <div class="" data-example-id="togglable-tabs">
                    ...
                    <ul  class="nav nav-tabs bordered">
                        ...
                        ?>"><a href="#tab_teacher_application_list"   role="tab" data-toggle="tab" aria-expanded="true"><i class="fa fa-list-ol"></i> <?php echo $this->lang->line('teacher_application_form'); ?></a> </li>
                        <li class="<?php
                        ?>"><a href="#tab_teacher_transfer_list"   role="tab" data-toggle="tab" aria-expanded="true"><i class="fa fa-list-ol"></i> <?php echo $this->lang->line('teacher_transfer_form'); ?></a> </li>
                        <li class="<?php
                        ?>"><a href="#tab_route_sublist"   role="tab" data-toggle="tab" aria-expanded="true"><i class="fa fa-list-ol"></i> <?php echo $this->lang->line('subprozoprogress'); ?></a> </li>
                    ...
                    <div class="tab-content">
                        ...
                        ?>" id="tab_teacher_application_list" >
                            <div class="x_content">
                                            ...
                                            <?php
                                             foreach ($teacherapplicationformval as $obj) {
                                                ...
                                                <tr>
                                                    ...
                                                    <td><?php echo $obj->person1; ?>&nbsp;<?php echo $obj->initial_name_s; ?></td>
                                                    <td><?php echo $obj->piriven_name; ?></td>
                                                    <td><?php echo $obj->piriven_address; ?></td>

                                                    <td><?php echo $obj->created_at; ?></td>
                                                    <td>
                                                        <?php if (has_permission(EDIT, 'forms', 'teacherformappministry') && $obj->cur_status == 3) { ?>
                                                            <a href="<?php echo site_url('formsministry/formsapply/teacherapplicationformedit/' . $obj->id); ?>" class="btn btn-info btn-xs"><i class="fa fa-pencil-square-o"></i> <?php echo $this->lang->line('edit'); ?> </a>
                                                        <?php } ?>

                                                        <?php if (has_permission(VIEW, 'forms', 'teacherformappministry')) { ?>
                                                        ...
                                                        <?php if (has_permission(EDIT, 'forms', 'teacherformappministry') && $obj->cur_status == 3) { ?>
                                                            <a href="<?php echo site_url('formsministry/formsapply/confirm/' . $obj->id); ?>" class="btn bg-green btn-xs"><i class="fa fa-check-square-o"></i> <?php echo $this->lang->line('confirm1'); ?> </a>
                                                        <?php } ?>
														
														<?php if (has_permission(EDIT, 'forms', 'teacherformappministry') && $obj->cur_status == 3) { ?>
                                                            <a href="<?php echo site_url('formsministry/formsapply/reject/' . $obj->id); ?>" class="btn btn-danger btn-xs"><i class="fa fa-times"></i> <?php echo $this->lang->line('reject'); ?> </a>
                                                        <?php } ?>
														
														  <?php if (has_permission(EDIT, 'forms', 'teacherformappministry') && $obj->cur_status == 4) { ?>
                                                            <a href="<?php echo site_url('formsministry/formsapply/approve/' . $obj->id); ?>" class="btn btn-warning btn-xs"><i class="fa fa-check-square-o"></i> <?php echo $this->lang->line('approve'); ?> </a>
                                                        <?php } ?>
														
														<?php if (has_permission(EDIT, 'forms', 'teacherformappministry') && $obj->cur_status == 4) { ?>
                                                            <a href="<?php echo site_url('formsministry/formsapply/approvereject/' . $obj->id); ?>" class="btn btn-danger btn-xs"><i class="fa fa-times"></i> <?php echo $this->lang->line('reject'); ?> </a>
                                                        <?php } ?>

                                                        <?php if (has_permission(VIEW, 'forms', 'teacherformappministry')) { ?>
                                                            <a href="<?php echo site_url('formsministry/formsapply/teacher_application_print/' . $obj->id); ?>" class="btn btn-success2 btn-xs" target="_blank"><i class="fa fa-print" style="color: #ffffff;"></i> <?php echo $this->lang->line('print'); ?> </a>
                        ...
                        <div  class="tab-pane fade in"  id="tab_teacher_transfer_list" >
                            <div class="x_content">
                                <table id="datatabledepartment-responsive" class="table table-striped table-bordered dt-responsive nowrap" cellspacing="0" width="100%">
                                    <thead>
                                        <tr>
                                            ...
                                            <?php if ($this->session->userdata('role_id') == SUPER_ADMIN) { ?>
                                                ...
                                                <th><?php echo $this->lang->line('subdepartment'); ?></th>
                                            <?php } ?>
                                    ...
                                    <tbody>   
                                        <?php
                                        $count = 1;
                                        if (isset($deproutes) && !empty($deproutes)) {
                                            ?>
                                            <?php
                                            foreach ($deproutes as $obj) {
                                                $CurStatusID = $obj->cur_status;
                                                ...
                                                <tr>
                                                    ...
                                                    <td><?php echo $obj->subdepartment; ?></td>
                                                    ...
                                                    <td>
                                                        ...
                                                        <?php if (has_permission(EDIT, 'prozo', 'adminprozoplan') && $obj->approvel_status == 1) { ?>
                                                            <a href="<?php echo site_url('adminplan/Progressdep/confirm/' . $obj->id); ?>" class="btn btn-info btn-xs"><i class="fa fa-pencil-square-o"></i> <?php echo $this->lang->line('approve'); ?> </a>
                                                        <?php } ?>

                                                        <?php if (has_permission(EDIT, 'prozo', 'adminprozoplan') && $obj->approvel_status == 1) { ?>
                                                            <a href="<?php echo site_url('adminplan/Progressdep/edit/' . $obj->id); ?>" class="btn btn-dark btn-xs"><i class="fa fa-pencil-square-o"></i> <?php echo $this->lang->line('edit'); ?> </a>
                                                        <?php } ?>
                                                        <?php if (has_permission(VIEW, 'prozo', 'adminprozoplan')) { ?>
                                                            <a href="javascript:void(0);" onclick="get_route_depmodal(<?php echo $obj->id; ?>);"  data-toggle="modal" data-target=".bs-route-modal-lg" class="btn btn-success btn-xs"><i class="fa fa-eye"></i> <?php echo $this->lang->line('view'); ?> </a><br/>
                                                        <?php } ?>
                                                        <?php if (has_permission(EDIT, 'prozo', 'adminprozoplan') && $obj->approvel_status == 1) { ?>
                                                            <a href="<?php echo site_url('adminplan/Progressdep/reject/' . $obj->id); ?>" class="btn btn-danger btn-xs"><i class="fa fa-pencil-square-o"></i> <?php echo $this->lang->line('reject'); ?> </a>
                                                        <?php } ?>
                          ...
                          <div  class="tab-pane fade in"  id="tab_route_sublist" >
                            <div class="x_content">
                                <table id="datatablesubject-responsive" class="table table-striped table-bordered dt-responsive nowrap" cellspacing="0" width="100%">
                                    <thead>
                                        <tr>
                                            <th><?php echo $this->lang->line('id'); ?></th>
                                            <th><?php echo $this->lang->line('cur_status'); ?></th>                                           
                                    ...
                                    <tbody>   
                                        <?php
                                        $count = 1;
                                        if (isset($subroutes) && !empty($subroutes)) {
                                            ?>
                                            <?php
                                            foreach ($subroutes as $obj) {
                                                $CurStatusID = $obj->cur_status;
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        ...
                                                        <?php if (has_permission(EDIT, 'prozo', 'adminprozoplan') && $obj->approvel_status == 1) { ?>
                                                            <a href="<?php echo site_url('adminplan/Progresssub/confirm/' . $obj->id); ?>" class="btn btn-info btn-xs"><i class="fa fa-pencil-square-o"></i> <?php echo $this->lang->line('approve'); ?> </a>
                                                        <?php } ?>

                                                        <?php if (has_permission(EDIT, 'prozo', 'adminprozoplan') && $obj->approvel_status == 1) { ?>
                                                            <a href="<?php echo site_url('adminplan/Progresssub/edit/' . $obj->id); ?>" class="btn btn-dark btn-xs"><i class="fa fa-pencil-square-o"></i> <?php echo $this->lang->line('edit'); ?> </a>
                                                        <?php } ?>
                                                        <?php if (has_permission(VIEW, 'prozo', 'adminprozoplan')) { ?>
                                                            <a href="javascript:void(0);" onclick="get_subject_modal(<?php echo $obj->id; ?>);"  data-toggle="modal" data-target=".bs-route-modal-lg" class="btn btn-success btn-xs"><i class="fa fa-eye"></i> <?php echo $this->lang->line('view'); ?> </a><br/>
                                                        <?php } ?>
                                                        <?php if (has_permission(EDIT, 'prozo', 'adminprozoplan') && $obj->approvel_status == 1) { ?>
                                                            <a href="<?php echo site_url('adminplan/Progresssub/reject/' . $obj->id); ?>" class="btn btn-danger btn-xs"><i class="fa fa-pencil-square-o"></i> <?php echo $this->lang->line('reject'); ?> </a>
                                                        <?php } ?>
...
<?php echo form_open(site_url('forms/formsapply/teacherapplicationformadd'), array('name' => 'add', 'id' => 'add', 'class' => 'form-horizontal form-label-left', 'enctype' => 'multipart/form-data'), ''); ?>
                                ...
                                <ul  class="nav nav-tabs bordered">
                                    ...
                                    <li ><a href="#tab_forth"  role="tab"  data-toggle="tab" aria-expanded="false"><i class="fa fa-plus-square-o"></i> <?php echo $this->lang->line('pirven_five'); ?></a> </li>
                                    ...
                                    <div class="tab-pane fade in active" id="tab_zero">
                                        ...
                                        <div class="row" style="font-size: 16px;">
                                            ...
                                            <div class="col-md-7 col-sm-2 col-xs-12">
                                                <div class="item form-group">
                                                    <input  class="form-control col-md-7 col-xs-12"  name="full_name_s"  id="full_name_s" value="<?php echo isset($post['full_name_s']) ? $post['applicant_s_name'] : ''; ?>" placeholder="" type="text" autocomplete="off">
                                        ...
                                        <div class="row" style="font-size: 16px;">
                                            <div class="col-md-4 col-sm-2 col-xs-12" style="margin-left: 0px; margin-right: -5px;">
                                                <div class="item form-group"> 
                                                    <div>04.&nbsp;&nbsp;<?php echo $this->lang->line('text206'); ?> :-</div>
                                        ...
                                        <div class="row" style="font-size: 16px;">
                                            ...
                                            <div class="col-md-3 col-sm-2 col-xs-12" style="margin-left: 0px; margin-right: -40px;">
                                                <div class="item form-group">
                                                    <div>05.&nbsp;&nbsp;<?php echo $this->lang->line('birth_date'); ?> :-</div>
                                        ...
                                        <div class="row" style="font-size: 16px;">
                                            ...
                                            <div class="col-md-3 col-sm-2 col-xs-12" style="margin-left: 0px; margin-right: -40px;">
                                                <div class="item form-group">
                                                    <div>06.&nbsp;<?php echo $this->lang->line('text205'); ?>:-</div>
                                        ...
                                        <div class="row" style="font-size: 16px;">
                                            ...
                                            <div class="col-md-3 col-sm-2 col-xs-12" style="margin-left: 0px; margin-right: -40px;">
                                                <div class="item form-group">
                                                    <div>07.&nbsp;<?php echo $this->lang->line('text206a'); ?>:-</div>
                     ...
                     <div class="help-block"><?php echo form_error('text206'); ?></div>
                                        ...
                                        <div class="row" style="font-size: 16px;">
                                            <div class="col-md-12 col-sm-2 col-xs-12" style="margin-left: 0px; margin-right: -5px;">
                                                <div class="item form-group"> 
                                                    <div>08.&nbsp;&nbsp;<?php echo $this->lang->line('text209'); ?> :-</div>
                                        ...
                                        <div class="row" style="font-size: 16px;">
                                            ...
                                            <div class="col-md-12 col-sm-12 col-xs-12">
                                                <div class="item form-group dataTables_wrapper">
                                                    <label for="national_id">10. <?php echo $this->lang->line('text209a'); ?></label>
                                                    <label for="national_id">10.1 <?php echo $this->lang->line('text210'); ?></label>
                                        ...
                                        <div class="row" style="font-size: 16px;">
                                            ...
                                            <div class="col-md-12 col-sm-12 col-xs-12">
                                                <div class="item form-group dataTables_wrapper">
                                                    <label for="national_id">09.2 <?php echo $this->lang->line('text217'); ?></label>
                                                    <div class="help-block"></div>
                                        ...
                                        <div class="row" style="font-size: 16px;">
                                            <div class="col-md-2 col-sm-2 col-xs-12" style="margin-left: 0px; margin-right: -5px;">
                                                <div class="item form-group"> 
                                                    <div>10.&nbsp;&nbsp;<?php echo $this->lang->line('text222'); ?> :-</div>
                                            ...
                                            <div class="col-md-12 col-sm-12 col-xs-12">
                                                <div class="item form-group"> 
                                                    ...
                                                    <div class="col-md-7 col-sm-2 col-xs-12" style="margin-left: 0px; margin-right: -85px;">
                                                        <div class="item form-group">
                                                            <div>11.1&nbsp;<?php echo $this->lang->line('text223'); ?>:-</div>
...
<?php echo form_error('answer'); ?>
                                                        <a href="javascript:void(0);" class="btn btn-success btn-xs" onclick="add_morework('fn_add_stop_container');"><?php echo $this->lang->line('add_more'); ?></a>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="row" style="font-size: 16px;">
                                            ...
                                            <div class="col-md-3 col-sm-2 col-xs-12" style="margin-left: 0px; margin-right: -5px;">
                                                <div class="item form-group"> 
                                                    <div>11.2.&nbsp;&nbsp;<?php echo $this->lang->line('text228'); ?> :-</div>
                                                    ...
                                                    <table id="datatable-responsive" class="table table-striped table-bordered dt-responsive nowrap" cellspacing="0" width="100%">
                                                        ...
                                                        <thead>
                                                            <tr>
                                                                ...
                                                                <td>
                                                                    <input  class="form-control col-md-7 col-xs-12"  name="vacancy"  id="vacancy" value="<?php echo isset($post['vacancy']) ? $post['vacancy'] : ''; ?>" placeholder=""  type="number" autocomplete="off">
                                                                    <div class="help-block"><?php echo form_error('7iidate'); ?></div>
                                                                </td>
                                                                <th style="vertical-align: super;"><?php echo $this->lang->line('text243'); ?></th>
                                                                <td>
                                                                    <input  class="form-control col-md-7 col-xs-12"  name="extra"  id="extra" value="<?php echo isset($post['extra']) ? $post['extra'] : ''; ?>" placeholder=""  type="number" autocomplete="off">
                                                                    <div class="help-block"><?php echo form_error('7iidate'); ?></div>
                                                                </td>
                                                            </tr>
                                                        </thead>
                                                ...
                                                <div class="item form-group dataTables_wrapper">
                                                    ...
                                                    <table id="datatable-responsive" class="table table-striped table-bordered dt-responsive nowrap" cellspacing="0" width="100%">
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <input class="form-control col-md-7 col-xs-12" name="fir4" id="fir4" value="<?php echo isset($post['fir4']) ? $post['fir4'] : ''; ?>" placeholder="" type="text" autocomplete="off">
                                                                <div class="help-block"><?php echo form_error('18ii'); ?></div>
                                                            </td>
                                                        </tr>
                                            ...
                                            <div class="col-md-12 col-sm-12 col-xs-12">
                                                <div class="item form-group">
                                                    <table id="datatable-responsive" class="table table-striped table-bordered dt-responsive nowrap" cellspacing="0" width="100%">
                                                        ...
                                                        <tr>
                                                            <td>
                                                                <input class="form-control col-md-7 col-xs-12" name="class1" id="class1" value="<?php echo isset($post['class1']) ? $post['class1'] : ''; ?>" placeholder="" type="text" autocomplete="off">
                                                                <div class="help-block"><?php echo form_error('18i'); ?></div></td>
                                                            <td>
                                                                <input class="form-control col-md-7 col-xs-12" name="subject1" id="subject1" value="<?php echo isset($post['subject1']) ? $post['subject1'] : ''; ?>" placeholder="" type="text" autocomplete="off">
                                                                <div class="help-block"><?php echo form_error('18i'); ?></div>
                                                            </td>
                                                            <td>
                                                                <input  class="form-control col-md-7 col-xs-12"  name="periods1"  id="periods1" value="<?php echo isset($post['periods1']) ? $post['periods1'] : ''; ?>" placeholder="" type="number" autocomplete="off">
                                                                <div class="help-block"><?php echo form_error('officeii'); ?></div>
                                                            </td>
                                                            <td>
                                                                <input  class="form-control col-md-7 col-xs-12"  name="hours1"  id="hours1" value="<?php echo isset($post['hours1']) ? $post['hours1'] : ''; ?>" placeholder="" type="number" autocomplete="off">
                                                                <div class="help-block"><?php echo form_error('officeiii'); ?></div></td>
                                                            <td>
                                                                <input  class="form-control col-md-7 col-xs-12"  name="minuts1"  id="minuts1" value="<?php echo isset($post['minuts1']) ? $post['minuts1'] : ''; ?>" placeholder="" type="number" autocomplete="off">
                                                                <div class="help-block"><?php echo form_error('officeiv'); ?></div>
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                            <td>
                                                                <input class="form-control col-md-7 col-xs-12" name="class2" id="class2" value="<?php echo isset($post['class2']) ? $post['class2'] : ''; ?>" placeholder="" type="text" autocomplete="off">
                                                                <div class="help-block"><?php echo form_error('18i'); ?></div></td>
                                                            <td>
                                                                <input class="form-control col-md-7 col-xs-12" name="subject2" id="subject2" value="<?php echo isset($post['subject2']) ? $post['subject2'] : ''; ?>" placeholder="" type="text" autocomplete="off">
                                                                <div class="help-block"><?php echo form_error('18i'); ?></div>
                                                            </td>
                                                            <td>
                                                                <input  class="form-control col-md-7 col-xs-12"  name="periods2"  id="periods2" value="<?php echo isset($post['periods2']) ? $post['periods2'] : ''; ?>" placeholder="" type="number" autocomplete="off">
                                                                <div class="help-block"><?php echo form_error('officeii'); ?></div>
                                                            </td>
                                                            <td>
                                                                <input  class="form-control col-md-7 col-xs-12"  name="hours2"  id="hours2" value="<?php echo isset($post['hours2']) ? $post['hours2'] : ''; ?>" placeholder="" type="number" autocomplete="off">
                                                                <div class="help-block"><?php echo form_error('officeiii'); ?></div></td>
                                                            <td>
                                                                <input  class="form-control col-md-7 col-xs-12"  name="minuts2"  id="minuts2" value="<?php echo isset($post['minuts2']) ? $post['minuts2'] : ''; ?>" placeholder="" type="number" autocomplete="off">
                                                                <div class="help-block"><?php echo form_error('officeiv'); ?></div>
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                            <td>
                                                                <input class="form-control col-md-7 col-xs-12" name="class3" id="class3" value="<?php echo isset($post['class3']) ? $post['class3'] : ''; ?>" placeholder="" type="text" autocomplete="off">
                                                                <div class="help-block"><?php echo form_error('18i'); ?></div></td>
                                                            <td>
                                                                <input class="form-control col-md-7 col-xs-12" name="subject3" id="subject3" value="<?php echo isset($post['subject3']) ? $post['subject3'] : ''; ?>" placeholder="" type="text" autocomplete="off">
                                                                <div class="help-block"><?php echo form_error('18i'); ?></div>
                                                            </td>
                                                            <td>
                                                                <input  class="form-control col-md-7 col-xs-12"  name="periods3"  id="periods3" value="<?php echo isset($post['periods3']) ? $post['periods3'] : ''; ?>" placeholder="" type="number" autocomplete="off">
                                                                <div class="help-block"><?php echo form_error('officeii'); ?></div>
                                                            </td>
                                                            <td>
                                                                <input  class="form-control col-md-7 col-xs-12"  name="hours3"  id="hours3" value="<?php echo isset($post['hours3']) ? $post['hours3'] : ''; ?>" placeholder="" type="number" autocomplete="off">
                                                                <div class="help-block"><?php echo form_error('officeiii'); ?></div></td>
                                                            <td>
                                                                <input  class="form-control col-md-7 col-xs-12"  name="minuts3"  id="minuts3" value="<?php echo isset($post['minuts3']) ? $post['minuts3'] : ''; ?>" placeholder="" type="number" autocomplete="off">
                                                                <div class="help-block"><?php echo form_error('officeiv'); ?></div>
                                                            </td>
                                                        </tr>
                                                        ...
                                                        <tr>
                                                            <td>
                                                                <input class="form-control col-md-7 col-xs-12" name="class4" id="class4" value="<?php echo isset($post['class4']) ? $post['class4'] : ''; ?>" placeholder="" type="text" autocomplete="off">
                                                                <div class="help-block"><?php echo form_error('18i'); ?></div></td>
                                                            <td>
                                                                <input class="form-control col-md-7 col-xs-12" name="subject4" id="subject4" value="<?php echo isset($post['subject4']) ? $post['subject4'] : ''; ?>" placeholder="" type="text" autocomplete="off">
                                                                <div class="help-block"><?php echo form_error('18i'); ?></div>
                                                            </td>
                                                            <td>
                                                                <input  class="form-control col-md-7 col-xs-12"  name="periods4"  id="periods4" value="<?php echo isset($post['periods4']) ? $post['periods4'] : ''; ?>" placeholder="" type="number" autocomplete="off">
                                                                <div class="help-block"><?php echo form_error('officeii'); ?></div>
                                                            </td>
                                                            <td>
                                                                <input  class="form-control col-md-7 col-xs-12"  name="hours4"  id="hours4" value="<?php echo isset($post['hours4']) ? $post['hours4'] : ''; ?>" placeholder="" type="number" autocomplete="off">
                                                                <div class="help-block"><?php echo form_error('officeiii'); ?></div></td>
                                                            <td>
                                                                <input  class="form-control col-md-7 col-xs-12"  name="minuts4"  id="minuts4" value="<?php echo isset($post['minuts4']) ? $post['minuts4'] : ''; ?>" placeholder="" type="number" autocomplete="off">
                                                                <div class="help-block"><?php echo form_error('officeiv'); ?></div>
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                            <td>
                                                                <input class="form-control col-md-7 col-xs-12" name="class5" id="class5" value="<?php echo isset($post['class5']) ? $post['class5'] : ''; ?>" placeholder="" type="text" autocomplete="off">
                                                                <div class="help-block"><?php echo form_error('18i'); ?></div></td>
                                                            <td>
                                                                <input class="form-control col-md-7 col-xs-12" name="subject5" id="subject5" value="<?php echo isset($post['subject5']) ? $post['subject5'] : ''; ?>" placeholder="" type="text" autocomplete="off">
                                                                <div class="help-block"><?php echo form_error('18i'); ?></div>
                                                            </td>
                                                            <td>
                                                                <input  class="form-control col-md-7 col-xs-12"  name="periods5"  id="periods5" value="<?php echo isset($post['periods5']) ? $post['periods5'] : ''; ?>" placeholder="" type="number" autocomplete="off">
                                                                <div class="help-block"><?php echo form_error('officeii'); ?></div>
                                                            </td>
                                                            <td>
                                                                <input  class="form-control col-md-7 col-xs-12"  name="hours5"  id="hours5" value="<?php echo isset($post['hours5']) ? $post['hours5'] : ''; ?>" placeholder="" type="number" autocomplete="off">
                                                                <div class="help-block"><?php echo form_error('officeiii'); ?></div></td>
                                                            <td>
                                                                <input  class="form-control col-md-7 col-xs-12"  name="minuts5"  id="minuts5" value="<?php echo isset($post['minuts5']) ? $post['minuts5'] : ''; ?>" placeholder="" type="number" autocomplete="off">
                                                                <div class="help-block"><?php echo form_error('officeiv'); ?></div>
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                            <td>
                                                                <input class="form-control col-md-7 col-xs-12" name="class6" id="class6" value="<?php echo isset($post['class6']) ? $post['class6'] : ''; ?>" placeholder="" type="text" autocomplete="off">
                                                                <div class="help-block"><?php echo form_error('18i'); ?></div></td>
                                                            <td>
                                                                <input class="form-control col-md-7 col-xs-12" name="subject6" id="subject6" value="<?php echo isset($post['subject6']) ? $post['subject6'] : ''; ?>" placeholder="" type="text" autocomplete="off">
                                                                <div class="help-block"><?php echo form_error('18i'); ?></div>
                                                            </td>
                                                            <td>
                                                                <input  class="form-control col-md-7 col-xs-12"  name="periods6"  id="periods6" value="<?php echo isset($post['periods6']) ? $post['periods6'] : ''; ?>" placeholder="" type="number" autocomplete="off">
                                                                <div class="help-block"><?php echo form_error('officeii'); ?></div>
                                                            </td>
                                                            <td>
                                                                <input  class="form-control col-md-7 col-xs-12"  name="hours6"  id="hours6" value="<?php echo isset($post['hours6']) ? $post['hours6'] : ''; ?>" placeholder="" type="number" autocomplete="off">
                                                                <div class="help-block"><?php echo form_error('officeiii'); ?></div></td>
                                                            <td>
                                                                <input  class="form-control col-md-7 col-xs-12"  name="minuts6"  id="minuts6" value="<?php echo isset($post['minuts6']) ? $post['minuts6'] : ''; ?>" placeholder="" type="number" autocomplete="off">
                                                                <div class="help-block"><?php echo form_error('officeiv'); ?></div>
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                            ...
                                                            <td> 
                                                                <input  class="form-control col-md-7 col-xs-12"  name="hours-total"  id="hours-total" value="<?php echo isset($post['hours-total']) ? $post['hours-total'] : ''; ?>" placeholder="" type="number" autocomplete="off">
                                                                <div class="help-block"><?php echo form_error('officexiii'); ?></div>
                                                            </td>
                                                            <td> 
                                                                <input  class="form-control col-md-7 col-xs-12"  name="minutss_total"  id="minutss_total" value="<?php echo isset($post['minutss_total']) ? $post['minutss_total'] : ''; ?>" placeholder="" type="number" autocomplete="off">
                                                ...
                                                <div class="item form-group">
                                                    <table id="datatable-responsive" class="table table-striped table-bordered dt-responsive nowrap" cellspacing="0" width="100%">
                                                        ...
                                                        <tbody>
                                                            <tr>
                                                                <td>
                                                                    <input  class="form-control col-md-7 col-xs-12"  name="propose_monk"  id="propose_monk" value="<?php echo isset($post['propose_monk']) ? $post['propose_monk'] : ''; ?>" placeholder="<?php echo $this->lang->line('text240a'); ?>"  type="number" autocomplete="off">
                                                                    <div class="help-block"><?php echo form_error('7iidate'); ?></div>
                                                                </td>
                                                                <td>
                                                                    <input  class="form-control col-md-7 col-xs-12"  name="propose_lay"  id="propose_lay" value="<?php echo isset($post['propose_lay']) ? $post['propose_lay'] : ''; ?>" placeholder="<?php echo $this->lang->line('text240b'); ?>"  type="number" autocomplete="off">                                                                           
                                                                    <div class="help-block"><?php echo form_error('7iidate'); ?></div>
                                                                </td>
                                                                <td>
                                                                    <input  class="form-control col-md-7 col-xs-12"  name="propose_total"  id="propose_total" value="<?php echo isset($post['propose_total']) ? $post['propose_total'] : ''; ?>" placeholder="<?php echo $this->lang->line('text240c'); ?>"  type="number" autocomplete="off">                                                                          
                                                                    <div class="help-block"><?php echo form_error('7iidate'); ?></div>
                                                                </td>
                                    ...
                                    <div class="tab-pane fade in" id="tab_sec">
                                        ...
                                        <div class="row" style="font-size: 16px;">
                                            ...
                                            <div class="col-md-6 col-sm-2 col-xs-12" style="margin-left: 0px; margin-right: 0px;">
                                                <div class="item form-group">
                                                    <input  class="form-control col-md-7 col-xs-12" name="kpiriven_name1"  id="kpiriven_name1" value="<?php echo isset($post['piriven_name1']) ? $post['kpiriven_name1'] : ''; ?>" placeholder="<?php echo $this->lang->line('school_name'); ?>"  type="text" autocomplete="off">
                                        ...
                                        <div class="row" style="font-size: 16px;">
                                            ...
                                            <div class="col-md-6 col-sm-6 col-xs-12">
                                                <div class="item form-group">
                                                    ...
                                                    <div class="btn btn-default btn-file">
                                                        <i class="fa fa-paperclip"></i> <?php echo $this->lang->line('upload'); ?>
                                                        <input  class="form-control col-md-7 col-xs-12"  name="officer_sig"  id="officer_sig"  type="file">
                                                    </div>
                                                    <div class="text-info" style="font-size: 14px;"><?php echo $this->lang->line('valid_file_format_img'); ?></div>
                                        ...
                                        <div class="row" style="font-size: 16px;">
                                            ...
                                            <div class="col-md-6 col-sm-6 col-xs-12">
                                                <div class="item form-group">
                                                    ...
                                                    <div class="btn btn-default btn-file">
                                                        <i class="fa fa-paperclip"></i> <?php echo $this->lang->line('upload'); ?>
                                                        <input  class="form-control col-md-7 col-xs-12"  name="zonal_sig"  id="zonal_sig"  type="file">
                                        ...
                                        <div class="row" style="font-size: 16px;">
                                            ...
                                            <div class="col-md-2 col-sm-2 col-xs-12" style="margin-left: 0px; margin-right: 0px;">
                                                <div class="item form-group">
                                                    <select  class="form-control col-md-7 col-xs-12" name="as_piriven_type" id="as_piriven_type">
                                                        <option value="">--<?php echo $this->lang->line('select'); ?>--</option>                                                                                    
                                                        <option value="Reverend" <?php
                                                        if (isset($post['person1']) && $post['person1'] == 'reverend') {
                                                            echo 'selected="selected"';
                                            ...
                                            <div class="col-md-5 col-sm-2 col-xs-12" style="margin-left: 0px; margin-right: 0px;">
                                                <div class="item form-group">
                                                    <input  class="form-control col-md-7 col-xs-12" name="as_name"  id="as_name" value="<?php echo isset($post['as_name']) ? $post['as_name'] : ''; ?>" placeholder=""  type="text" autocomplete="off">
                                                    <div class="help-block"><?php echo form_error('as_name'); ?></div>
                                                </div>
                                            </div>
                                        ...
                                        <div class="row" style="font-size: 16px;">
                                            ...
                                            <div class="col-md-5 col-sm-2 col-xs-12" style="margin-left: 0px; margin-right: 0px;">
                                                <div class="item form-group">
                                                    <input  class="form-control col-md-7 col-xs-12" name="as_piriven_name"  id="as_piriven_name" value="<?php echo isset($post['as_piriven_name']) ? $post['as_piriven_name'] : ''; ?>" placeholder="<?php echo $this->lang->line('school_name'); ?>"  type="text" autocomplete="off">
                                                    <div class="help-block"><?php echo form_error('as_piriven_name'); ?></div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-md-2 col-sm-2 col-xs-12" style="margin-left: 0px; margin-right: 0px;">
                                                <div class="item form-group">
                                                    <select  class="form-control col-md-7 col-xs-12" name="recommentaion" id="recommentaion">
                                                        ...
                                                        if (isset($post['recommended']) && $post['recommended'] == 'recommended') {
                                                            echo 'selected="selected"';
                                                        }
                                                        ?>><?php echo $this->lang->line('recommended'); ?></option>
                                                        <option value="notrecommended" <?php
                                                        if (isset($post['notrecommended']) && $post['notrecommended'] == "notrecommended") {
                                                            echo 'selected="selected"';
                                                        }
                                        ...
                                        <div class="row" style="font-size: 16px;">
                                            ...
                                            <div class="col-md-6 col-sm-6 col-xs-12">
                                                <div class="item form-group">
                                                    ...
                                                    <div class="btn btn-default btn-file">
                                                        <i class="fa fa-paperclip"></i> <?php echo $this->lang->line('upload'); ?>
                                                        <input  class="form-control col-md-7 col-xs-12"  name="as_sig1"  id="as_sig1"  type="file">
                                                    </div>

                                                    <div class="btn btn-default btn-file">
                                                        <i class="fa fa-paperclip"></i> <?php echo $this->lang->line('rubber_stamp'); ?>
                                                        <input  class="form-control col-md-7 col-xs-12"  name="as_rubber_stamp"  id="as_rubber_stamp"  type="file">
                                                    </div>
                                                    <div class="text-info" style="font-size: 14px;"><?php echo $this->lang->line('valid_file_format_img'); ?></div>
                                    ...
                                    <div class="tab-pane fade in" id="tab_third">
                                            ...
                                            <div class="col-md-2 col-sm-2 col-xs-12" style="margin-left: 0px; margin-right: 0px;">
                                                <div class="item form-group">
                                                    <select  class="form-control col-md-7 col-xs-12" name="true_not" id="true_not">
                                                        ...
                                                        if (isset($post['true']) && $post['true'] == 'true') {
                                                            echo 'selected="selected"';
                                                        }
                                                        ?>><?php echo $this->lang->line('true'); ?></option>
                                                        <option value="nottrue" <?php
                                                        if (isset($post['nottrue']) && $post['nottrue'] == "nottrue") {
                                                            echo 'selected="selected"';
                                                        }
                                        ...
                                        <div class="row" style="font-size: 16px;">
                                            ...
                                            <div class="col-md-6 col-sm-6 col-xs-12">
                                                <div class="item form-group">
                                                    ...
                                                    <div class="btn btn-default btn-file">
                                                        <i class="fa fa-paperclip"></i> <?php echo $this->lang->line('upload'); ?>
                                                        <input  class="form-control col-md-7 col-xs-12"  name="edu_clerk"  id="edu_clerk"  type="file">
                                                    </div>
                                                    <div class="text-info" style="font-size: 14px;"><?php echo $this->lang->line('valid_file_format_img'); ?></div>
                                            ...
                                            <div class="col-md-2 col-sm-2 col-xs-12" style="margin-left: 0px; margin-right: 0px;">
                                                <div class="item form-group">
                                                    <select  class="form-control col-md-7 col-xs-12" name="approved_not" id="approved_not">
                                                        ...
                                                        if (isset($post['approved']) && $post['approved'] == 'approved') {
                                                            echo 'selected="selected"';
                                                        }
                                                        ?>><?php echo $this->lang->line('approved'); ?></option>
                                                        <option value="not_approved" <?php
                                                        if (isset($post['not_approved']) && $post['not_approved'] == "not_approved") {
                                                            echo 'selected="selected"';
                                                        }
                                            ...
                                            <div class="col-md-2 col-sm-2 col-xs-12" style="margin-left: 0px; margin-right: 0px;">
                                                <div class="item form-group">
                                                    <select  class="form-control col-md-7 col-xs-12" name="submition" id="submition">
                                                        ...
                                                        if (isset($post['submitted']) && $post['submitted'] == 'submitted') {
                                                            echo 'selected="selected"';
                                                        }
                                                        ?>><?php echo $this->lang->line('submitted'); ?></option>
                                                        <option value="not submitted" <?php
                                                        if (isset($post['not_submitted']) && $post['not_submitted'] == "not_submitted") {
                                                            echo 'selected="selected"';
                                                        }
                                            ...
                                            <div class="col-md-2 col-sm-2 col-xs-12" style="margin-left: 0px; margin-right: 0px;">
                                                <div class="item form-group">
                                                    <select  class="form-control col-md-7 col-xs-12" name="given_not" id="given_not">
                                                        ...
                                                        if (isset($post['given']) && $post['given'] == 'given') {
                                                            echo 'selected="selected"';
                                                        }
                                                        ?>><?php echo $this->lang->line('given'); ?></option>
                                                        <option value="not_given" <?php
                                                        if (isset($post['not_given']) && $post['not_given'] == "not_given") {
                                                            echo 'selected="selected"';
                                                        }
                                        ...
                                        <div class="row" style="font-size: 16px;">
                                            ...
                                            <div class="col-md-8 col-sm-2 col-xs-12">
                                                <div class="item form-group">
                                                    <textarea  class="form-control col-md-7 col-xs-12 textarea-4column"  name="note"  id="note" value="<?php echo isset($post['note']) ? $post['note'] : ''; ?>" placeholder=""></textarea>
                                        ...
                                        <div class="row" style="font-size: 16px;">
                                            ...
                                            <div class="col-md-6 col-sm-6 col-xs-12">
                                                <div class="item form-group">
                                                    ...
                                                    <div class="btn btn-default btn-file">
                                                        <i class="fa fa-paperclip"></i> <?php echo $this->lang->line('upload'); ?>
                                                        <input  class="form-control col-md-7 col-xs-12"  name="director_sig"  id="director_sig"  type="file">
                                                    </div>
                                                    <div class="text-info" style="font-size: 14px;"><?php echo $this->lang->line('valid_file_format_img'); ?></div>
                                    ...
                                    <div class="tab-pane fade in" id="tab_forth">
                                                ...
                                                <div class="item form-group">
                                                    ...
                                                    <select  class="form-control col-md-7 col-xs-12 quick-field" name="role_id" id="role_id" required="required">                                                
                                                        <?php foreach ($roles as $obj) { ?>
                                                            <?php if (in_array($obj->id, array(TEACHER, NEW_TEACHER))) { ?>
                                                                <option value="<?php echo $obj->id; ?>" <?php
...
<?php } ?>
                                            ...
                                            <div class="col-md-3 col-sm-3 col-xs-12">
                                                <div class="item form-group">
                                                    <label for="joining_date"><?php echo $this->lang->line('appointment_date2'); ?></label>
...
<?php echo form_close(); ?>
                        ...
                        <?php if (isset($edit)) { ?>
                                ...
                                <div class="x_content"> 
                                      ...
                                      <?php echo form_open_multipart(site_url('formsministry/formsapply/teacherapplicationformedit/' . $forms->id), array('name' => 'edit', 'id' => 'edit', 'class' => 'form-horizontal form-label-left'), ''); ?>
...
<script type="text/javascript">
    function add_morework(fn_stop_container) {
        var data = '<tr>'
                + '<td>'
