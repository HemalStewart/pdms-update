            ...
            <div class="x_content">
                <div class="" data-example-id="togglable-tabs">
                    ...
                    <ul  class="nav nav-tabs bordered">
                        ...
                        <li class="<?php
                        ?>"><a href="#tab_route_deplist"   role="tab" data-toggle="tab" aria-expanded="true"><i class="fa fa-list-ol"></i> <?php echo $this->lang->line('depprozoprogress'); ?></a> </li>
                        <li class="<?php
                    ...
                    <div class="tab-content">
                                            ...
                                            foreach ($routes as $obj) {
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        ...
                                                        <?php if (has_permission(EDIT, 'prozo', 'adminprozoprogress') && $obj->approvel_status == 1) { ?>
                                                            <a href="<?php echo site_url('adminprozo/progress/confirm/' . $obj->id); ?>" class="btn btn-info btn-xs"><i class="fa fa-pencil-square-o"></i> <?php echo $this->lang->line('approve'); ?> </a>
                                                        <?php } ?>

                                                        <?php if (has_permission(EDIT, 'prozo', 'adminprozoprogress') && $obj->approvel_status == 1) { ?>
                                                            <a href="<?php echo site_url('adminprozo/progress/edit/' . $obj->id); ?>" class="btn btn-dark btn-xs"><i class="fa fa-pencil-square-o"></i> <?php echo $this->lang->line('edit'); ?> </a>
                                                        <?php } ?>
                                                        ...
                                                        <?php } ?>
                                                        <?php if (has_permission(EDIT, 'prozo', 'adminprozoprogress') && $obj->approvel_status == 1) { ?>
                                                            <a href="<?php echo site_url('adminprozo/progress/reject/' . $obj->id); ?>" class="btn btn-danger btn-xs"><i class="fa fa-pencil-square-o"></i> <?php echo $this->lang->line('reject'); ?> </a>
                                                        <?php } ?>
                        ...
                        <div  class="tab-pane fade in"  id="tab_route_deplist" >
                            <div class="x_content">
                                            ...
                                            foreach ($deproutes as $obj) {
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        ...
                                                        <?php if (has_permission(EDIT, 'prozo', 'adminprozoprogress') && $obj->approvel_status == 1) { ?>
                                                            <a href="<?php echo site_url('adminprozo/Progressdep/confirm/' . $obj->id); ?>" class="btn btn-info btn-xs"><i class="fa fa-pencil-square-o"></i> <?php echo $this->lang->line('approve'); ?> </a>
                                                        <?php } ?>

                                                        <?php if (has_permission(EDIT, 'prozo', 'adminprozoprogress') && $obj->approvel_status == 1) { ?>
                                                            <a href="<?php echo site_url('adminprozo/Progressdep/edit/' . $obj->id); ?>" class="btn btn-dark btn-xs"><i class="fa fa-pencil-square-o"></i> <?php echo $this->lang->line('edit'); ?> </a>
                                                        <?php } ?>
                                                        <?php if (has_permission(VIEW, 'prozo', 'adminprozoprogress')) { ?>
                                                            <a href="javascript:void(0);" onclick="get_department_modal(<?php echo $obj->id; ?>);"  data-toggle="modal" data-target=".bs-route-modal-lg" class="btn btn-success btn-xs"><i class="fa fa-eye"></i> <?php echo $this->lang->line('view'); ?> </a><br/>
                                                        <?php } ?>
                                                        <?php if (has_permission(EDIT, 'prozo', 'adminprozoprogress') && $obj->approvel_status == 1) { ?>
                                                            <a href="<?php echo site_url('adminprozo/Progressdep/reject/' . $obj->id); ?>" class="btn btn-danger btn-xs"><i class="fa fa-pencil-square-o"></i> <?php echo $this->lang->line('reject'); ?> </a>
                                                        <?php } ?>
                                            ...
                                            foreach ($subroutes as $obj) {
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        ...
                                                        <?php if (has_permission(EDIT, 'prozo', 'adminprozoprogress') && $obj->approvel_status == 1) { ?>
                                                            <a href="<?php echo site_url('adminprozo/Progresssub/confirm/' . $obj->id); ?>" class="btn btn-info btn-xs"><i class="fa fa-pencil-square-o"></i> <?php echo $this->lang->line('approve'); ?> </a>
                                                        <?php } ?>

                                                        <?php if (has_permission(EDIT, 'prozo', 'adminprozoprogress') && $obj->approvel_status == 1) { ?>
                                                            <a href="<?php echo site_url('adminprozo/Progresssub/edit/' . $obj->id); ?>" class="btn btn-dark btn-xs"><i class="fa fa-pencil-square-o"></i> <?php echo $this->lang->line('edit'); ?> </a>
                                                        <?php } ?>
                                                        <?php if (has_permission(VIEW, 'prozo', 'adminprozoprogress')) { ?>
                                                        ...
                                                        <?php } ?>
                                                        <?php if (has_permission(EDIT, 'prozo', 'adminprozoprogress') && $obj->approvel_status == 1) { ?>
                                                            <a href="<?php echo site_url('adminprozo/Progresssub/reject/' . $obj->id); ?>" class="btn btn-danger btn-xs"><i class="fa fa-pencil-square-o"></i> <?php echo $this->lang->line('reject'); ?> </a>
                                                        <?php } ?>
                                            ...
                                            <table style="width:100%;" class="fn_edit_stop_container responsive"> 
                                                ...
                                                foreach ($route_stops as $obj) {
                                                    ...
                                                    <tr>               
                                                        ...
                                                        <td>
                                                            <select class="form-control col-md-12 col-xs-12"  id="edit_program_type_<?php echo $obj->id; ?>" name="program_type[]" style="width:100%;" required onchange="get_editprogram_type(<?php echo $obj->id; ?>);">
                                                                <option value=""></option>
                                                                <?php foreach ($pr_type as $k => $v): ?>
                                                                    <option value="<?php echo $v['id'] ?>"<?php
                                                                    if (isset($obj) && $obj->program_type == $v["id"]) {
                                                        ...
                                                        <td>
                                                            <select class="form-control col-md-12 col-xs-12"  id="edit_program_<?php echo $obj->id; ?>" name="program[]" style="width:100%;" required>
...
<script type="text/javascript">
    function add_more(fn_stop_container) {
        ...
        $.ajax({
            url: "<?php echo site_url('adminprozo/progress/getTableProductRow'); ?>",
                ...
                $.ajax({
                    ...
                    success: function (responsetype) {
                        ...
                        data += '</select>' +
                                ...
                                + '</td>'
                                + '<td>'
                                + '<input  class="form-control col-md-12 col-xs-12" style="width:auto;" type="text" name="reason[]" id="reason" value="" placeholder="<?php echo $this->lang->line('reason'); ?>"/>'
                                + '</td>'
                                + '<td>'
                                + '<input  class="form-control col-md-12 col-xs-12" style="width:auto;" type="text" name="address[]" id="address" value="" placeholder="<?php echo $this->lang->line('address'); ?>"/>'
                                + '</td>'
                                + '<td>'
...
<script type="text/javascript">
    ...
    function get_route_modal(route_id) {
        ...
        function get_department_modal(route_id) {

        $('.fn_route_data').html('<p style="padding: 20px;"><p style="padding: 20px;text-align:center;"><img src="<?php echo IMG_URL; ?>loading.gif" /></p>');
        $.ajax({
            type: "POST",
            url: "<?php echo site_url('adminprozo/progressdep/get_single_route'); ?>",
            data: {route_id: route_id},
            success: function (response) {
                if (response)
                {
           ...
           function get_subject_modal(route_id) {

        $('.fn_route_data').html('<p style="padding: 20px;"><p style="padding: 20px;text-align:center;"><img src="<?php echo IMG_URL; ?>loading.gif" /></p>');
        $.ajax({
            type: "POST",
            url: "<?php echo site_url('adminprozo/progresssub/get_single_route'); ?>",
            data: {route_id: route_id},
            success: function (response) {
                if (response)
                {
...
<script type="text/javascript">
    ...
    $(document).ready(function () {
        $('#datatabledepartment-responsive').DataTable({
            dom: 'Bfrtip',
            iDisplayLength: 15,
            buttons: [
                'copyHtml5',
    ...
    $(document).ready(function () {
        $('#datatablesubject-responsive').DataTable({
            dom: 'Bfrtip',
            iDisplayLength: 15,
            buttons: [
                'copyHtml5',
