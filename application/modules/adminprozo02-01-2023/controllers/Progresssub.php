...
class Progresssub extends MY_Controller {
    ...
    function __construct() {
        ...
        $this->load->model('Routesub_Model', 'route', true);
        ...
        $this->data['sublist'] = $this->ajax->getsubjectallData();
    }
    ...
    public function edit($id = null) {
        ...
        $this->layout->view('progress/indexsub', $this->data);
    }
    ...
    public function confirm($id = null) {
        ...
        $this->data['edit'] = TRUE;
        $this->layout->title($this->lang->line('edit') . ' | ' . SMS);
        $this->layout->view('progress/indexsubconfirm', $this->data);
    }
  ...
  $this->data['sublist'] = $this->ajax->getsubjectallData();
        ...
        $this->data['edit'] = TRUE;
        $this->layout->title($this->lang->line('edit') . ' | ' . SMS);
        $this->layout->view('progress/indexrejectsub', $this->data);
    }
    ...
    public function get_single_route() {
        ...
        echo $this->load->view('progress/get-single-sub', $this->data);
    }
...
//        $items[] = 'note';
    ...
    public function delete($id = null) {
        ...
        if ($this->route->delete('subprozo_monthlydetails', array('id' => $id))) {
            ...
            // delete route stop
            $this->route->delete('subprom_programme', array('route_id' => $id));
