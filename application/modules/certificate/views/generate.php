                        ...
                        <div class="certificate-top">
                           ...
                           <div class="row">
                                <span class="sub-title-img">
                                  <?php if($school->logo){ ?>
                                    <img src="<?php echo UPLOAD_PATH; ?>/logo/<?php echo $school->logo; ?>" alt="" width="250" height="250"/> 
                                 <?php }else if($school->frontend_logo){ ?>
                                    <img src="<?php echo UPLOAD_PATH; ?>/logo/<?php echo $school->frontend_logo; ?>" alt="" width="250" height="250"/> 
                                 <?php }else{ ?>                                                        
                                    <img src="<?php echo UPLOAD_PATH; ?>/logo/<?php echo $this->global_setting->brand_logo; ?>" alt="" width="250" height="250"  />
                                 <?php } ?>
                                </span> 
                           </div>                            
                        </div>
