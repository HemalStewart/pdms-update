...
<!--========================================EDIT==========================================================================================-->
                        ...
                        <div class="tab-pane fade in active" id="tab_edit_teacherapplication">
                            <div class="x_content"> 
								  ...
								  <?php echo form_open_multipart(site_url('forms/formsapply/teacherapplicationformedit/' . $forms->id), array('name' => 'edit', 'id' => 'edit', 'class' => 'form-horizontal form-label-left' , 'enctype' => 'multipart/form-data'), ''); ?>
                                          ...
                                          <div class="help-block"></div>
                                                ...
                                                <tr>               
                                                    <td>
                                                      ...
                                                      <!--  <input  class="form-control col-md-12 col-xs-12" type="text" name="working_place[]" placeholder="<?php echo $this->lang->line('text225'); ?>" />-->
														<input  class="form-control col-md-12 col-xs-12 datepicker" style="width:auto;" type="text" name="working_place[]" id="editworking_place_<?php echo $couter; ?>" value="<?php echo $obj->working_place; ?>" placeholder="<?php echo $this->lang->line('working_place'); ?>" />
                                                    </td>
                                                    <td>
													...
													<div class="help-block">
                                                        <?php echo form_error('answer'); ?>
                                                         <a href="javascript:void(0);" class="btn btn-success btn-xs" onclick="edit_more3('fn_edit_stop_3container');"><?php echo $this->lang->line('add_more'); ?></a>
                                                    </div>
    ...
    function add_more(fn_stop_container) {
	  ...
	  function edit_more(fn_edit_stop_3container) {
        var data = '<tr>'
		        ...
		        + '<input  class="form-control col-md-12 col-xs-12 datepicker"  data-row-id="' + row_id + '" style="width:auto;" type="text" name="working_place[]" id="editworking_place_' + row_id + '" class="answer" placeholder="<?php echo $this->lang->line('working_place[]'); ?>" />'
