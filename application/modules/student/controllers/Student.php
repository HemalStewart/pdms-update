...
//        $this->data['filter_school_id'] = $school_id;
        ...
        if ($school_id) {
            //$this->data['students'] = $this->student->get_student_list($class_id, $school_id, $school->academic_year_id, $province_id, $district_id, $zonal_id, $edu_id);
        $this->data['students'] = $this->student->get_student_list($class_id,$school_id, $province_id, $district_id, $zonal_id, $edu_id);
            
        }
//        else if ($province_id) {
//             $this->data['students'] = $this->student->get_student_list($province_id,$class_id, $school_id, $school->academic_year_id);
//        }
        else {
            $this->data['students'] = $this->student->get_studentall($province_id, $district_id, $zonal_id, $edu_id, $school_id);
        }
        ...
        $this->data['types'] = $this->student->get_list('student_types', $conditionstatus, '', '', '', 'id', 'ASC');

        $pirtype = $this->session->userdata('pirtype');
        $listclass = $this->student->getclassData($pirtype);
...
*/
        ...
        if ($this->input->post('id')) {
            ...
            if ($this->input->post('is_guardian') == 'exist_guardian') {
                ...
                $info['username'] = $this->input->post('gud_username');
                  $info['password'] = $this->input->post('gud_password');
    ...
    public function indexprovince($class_id = null) {
        ...
        $this->data['district'] = $this->student->getdistrictData($provincial_id);
        ...
        if ($school_id) {
            $this->data['students'] = $this->student->get_student_provinciallist($provincial_id, $class_id, $school_id, $school->academic_year_id);
        }
        ...
        $provincial = array();
        $provincial['provincial'] = $provincial_id;
        ...
        $providetails = $this->student->get_list('schools', $provincial, '', '', '', 'id', 'ASC');
        $this->data['filterschools'] = $providetails;

        $this->data['schools'] = $this->schools;
        $this->data['list'] = TRUE;
        $this->layout->title($this->lang->line('manage_student') . ' | ' . SMS);
        $this->layout->view('student/province', $this->data);
    }
    ...
    public function indexzonal($class_id = null) {
        ...
        if ($school_id) {
            $this->data['students'] = $this->student->get_student_zonallist($zonal_id, $class_id, $school_id, $school->academic_year_id);
        }
        ...
        $zonaldetails = $this->student->get_filterzonalschool($zonal_id);
        $this->data['filterschools'] = $zonaldetails;

        $this->data['schools'] = $this->schools;
        $this->data['list'] = TRUE;
        $this->layout->title($this->lang->line('manage_student') . ' | ' . SMS);
        $this->layout->view('student/zonal', $this->data);
    }
