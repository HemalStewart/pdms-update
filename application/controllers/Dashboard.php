    ...
    public function index() {
       ...
       // $schooln_id = '';
        if ($_POST) {
            ...
            $zonaln_id = $this->input->post('zonal_id');
...
//            $school_id = $this->input->post('school_id');
        ...
        $this->data['filter_zonal_id'] = $zonaln_id;
...
//        $this->data['filter_school_id'] = $school_id;
     ...
     //   $this->data['notices'] = $this->dashboard->get_list('notices', array('status' => 1, 'school_id'=>$school_id), '', '5', '', 'id', 'DESC');
        ...
        $this->data['notices'] = $this->dashboard->get_noticelist($school_id,$role_id);
        ...
        //Provincial
        $this->data['total_prstudent'] = $this->dashboard->get_total_prstudent($provincial_id);
        $this->data['total_prguardian'] = $this->dashboard->get_total_prguardian($provincial_id);
        $this->data['total_prteacher'] = $this->dashboard->get_total_prteacher($provincial_id);
        $this->data['total_premployee'] = $this->dashboard->get_total_premployee($provincial_id);
//        $this->data['total_prexpenditure'] = $this->dashboard->get_total_prexpenditure($provincial_id);
//        $this->data['total_princome'] = $this->dashboard->get_total_princome($provincial_id);
        
        
          //Zonal
        $this->data['total_zonalstudent'] = $this->dashboard->get_total_zonalstudent($zonal_id);
        $this->data['total_zonalguardian'] = $this->dashboard->get_total_zonalguardian($zonal_id);
        $this->data['total_zonalteacher'] = $this->dashboard->get_total_zonalteacher($zonal_id);
        $this->data['total_zonalemployee'] = $this->dashboard->get_total_zonalemployee($zonal_id);
        
        /*$this->data['total_substudent'] = $this->dashboard->get_total_substudent($zonal_id);
        $this->data['total_subguardian'] = $this->dashboard->get_total_subguardian($zonal_id);
        $this->data['total_subteacher'] = $this->dashboard->get_total_subteacher($zonal_id);
        $this->data['total_subemployee'] = $this->dashboard->get_total_subemployee($zonal_id);*/
       ...
       // $this->data['schools'] = $this->schools;
          $this->data['schools'] = $this->dashboard->get_school_list($edu_id);
        $stats = array();
...
//            $arr[] = $total_expenditure > 0 ? $total_expenditure : 0;
        ...
        $this->data['prschools'] =  $this->dashboard->get_provinceSchool($provincial_id);
        
        $prstats = array();
        
        foreach($this->data['prschools'] as $obj){
        ...
        //    $total_expenditure = $this->dashboard->get_total_expenditure($obj->id);
            ...
            $prarr[] = $total_class > 0 ? $total_class : 0;
            $prarr[] = $total_student > 0 ? $total_student : 0;
            $prarr[] = $total_teacher > 0 ? $total_teacher : 0;
            $prarr[] = $total_employee > 0 ? $total_employee : 0;
//            $arr[] = $total_income > 0 ? $total_income : 0;
//            $arr[] = $total_expenditure > 0 ? $total_expenditure : 0;

            $prstats[$obj->id] = $prarr;
              
        } 
        
        $this->data['prstats'] = $prstats;
        ...
        $this->data['zonalschools'] =  $this->dashboard->get_zonalSchool($zonal_id);
        
        $zonalstats = array();
        
        foreach($this->data['zonalschools'] as $obj){
        ...
        //    $total_expenditure = $this->dashboard->get_total_expenditure($obj->id);
            ...
            $zonalarr[] = $total_class > 0 ? $total_class : 0;
            $zonalarr[] = $total_student > 0 ? $total_student : 0;
            $zonalarr[] = $total_teacher > 0 ? $total_teacher : 0;
            $zonalarr[] = $total_employee > 0 ? $total_employee : 0;
//            $arr[] = $total_income > 0 ? $total_income : 0;
//            $arr[] = $total_expenditure > 0 ? $total_expenditure : 0;

            $zonalstats[$obj->id] = $zonalarr;
              
        } 
        
        $this->data['zonalstats'] = $zonalstats;
